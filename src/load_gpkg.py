...
def load_gpkg(gpkg_path):
    ...
    poli_list = [3, 6, 10, 12, 14, 15, 16, 17, 1010, 1012, 1014, 1015, 1016, 1017, 2003, 2006, 2010, 2012, 2014, 2015, 2016, 2017,
    ...
    for layer in data:
        if layer.GetGeomType() == 0:
            ...
            for feature in layer:
                ...
                elif feature.geometry().GetGeometryType() in poli_list:
