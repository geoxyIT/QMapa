...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{a3401eaf-cffd-4781-89de-9837a804cb9c}">
      <rule filter=" try(  &quot;OT_Budowle_2_zrodlo&quot;  ) is not null" label="OT_Budowle" description="OT_Budowle_0" symbol="0" key="{cdc31a37-1ff0-4fae-ad00-71fca5480f86}"/>
      <rule filter=" try(  &quot;OT_SportIRekreacja_2_zrodlo&quot;  ) is not null" label="OT_SportIRekreacja" description="OT_SportIRekreacja" symbol="1" key="{4a992bc0-53be-4c05-bab5-f7dfbf327142}"/>
      <rule filter="try(  &quot;OT_Wody_2_zrodlo&quot;  ) is not null" label="OT_Wody" description="OT_Wody" symbol="2" key="{66f3531e-360a-49b4-a5e2-a76c4f3b3b51}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{29590024-1805-4aa8-a9e9-52a4e47b515b}">
      <rule filter=" try(  &quot;OT_Budowle_2_zrodlo&quot;  ) is not null" description="OT_Budowle_2" key="{4310f962-f7b7-4f27-a64f-24173b4d906c}">
      ...
      <rule filter=" try(  &quot;OT_SportIRekreacja_2_zrodlo&quot;  ) is not null" description="OT_SportIRekreacja_2" key="{017be739-5f36-4ad8-bb3d-e5f1804e9f12}">
        <settings calloutType="simple">
      ...
      <rule filter=" try(  &quot;OT_Wody_2_zrodlo&quot;  ) is not null and( &quot;OT_Wody_2_rodzajObiektu&quot;   = 'p' or &quot;OT_Wody_2_rodzajObiektu&quot;   = 's')" description="OT_Wody_2_plynaca_stojaca" key="{d78dcce6-8d1d-4715-8d15-837bafb4ef7b}">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="OT_Wody_2_lokalnyId" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_startObiekt" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_startWersjaObiekt" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_zrodlo" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_rodzajObiektu" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_obliczona_geometria_500" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_obliczona_geometria_1000" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_koniecWersjaObiekt" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_koniecObiekt" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_OT_PrezentacjaGraficzna_0_gml_id" type="field" width="-1" hidden="0"/>
      <column name="OT_Wody_2_OT_PrezentacjaGraficzna_0_katObrotu" type="field" width="-1" hidden="0"/>
