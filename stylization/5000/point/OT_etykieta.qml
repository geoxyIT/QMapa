...
<qgis version="3.24.0-Tisler" maxScale="0" simplifyLocal="1" simplifyDrawingHints="0" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="100000000" symbologyReferenceScale="-1" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{a3401eaf-cffd-4781-89de-9837a804cb9c}">
      <rule symbol="0" filter=" try(  &quot;OT_Budowle_2_zrodlo&quot;  ) is not null" label="OT_Budowle" description="OT_Budowle_0" key="{cdc31a37-1ff0-4fae-ad00-71fca5480f86}"/>
      <rule symbol="1" filter=" try(  &quot;OT_SportIRekreacja_2_zrodlo&quot;  ) is not null" label="OT_SportIRekreacja" description="OT_SportIRekreacja" key="{4a992bc0-53be-4c05-bab5-f7dfbf327142}"/>
      <rule symbol="2" filter="try(  &quot;OT_Wody_2_zrodlo&quot;  ) is not null" label="OT_Wody" description="OT_Wody" key="{66f3531e-360a-49b4-a5e2-a76c4f3b3b51}"/>
    </rules>
    <symbols>
