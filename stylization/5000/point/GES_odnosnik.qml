...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="0" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="0">
  ...
  <constraints>
    ...
    <constraint field="x" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="y" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  ...
  <expressionfields>
    <field expression="$x" length="0" subType="0" typeName="" comment="" type="6" name="x" precision="0"/>
    <field expression="$y" length="0" subType="0" typeName="" comment="" type="6" name="y" precision="0"/>
  </expressionfields>
  <attributeactions>
