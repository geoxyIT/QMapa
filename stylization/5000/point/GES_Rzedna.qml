...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{44cde8d3-38b7-479c-905c-372a24750e01}">
      <rule filter=" try(&quot;rzedna&quot;) is not null" key="{bef36002-959d-407f-a47e-6d5e883632db}" description="rzedna">
      ...
      <rule filter=" try(&quot;rzednaGory&quot;) is not null or  try(&quot;rzednaDolu&quot;) is not null" key="{89e1a1a1-b477-4fc9-a684-a94002d2ff6f}" description="rzedna">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortExpression="&quot;rzedna&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="GES_InneUrzadzeniaTowarzyszace_1_rodzajSieci" hidden="0" width="-1" type="field"/>
      ...
      <column name="GES_UrzadzeniaSiecElektroenergetyczna_1_zrodlo" hidden="0" width="-1" type="field"/>
      ...
      <column name="GES_UrzadzeniaSiecKanalizacyjna_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecWodociagowa_0_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecGazowa_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecGazowa_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_PrzewodCieplowniczy_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecCieplownicza_0_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecCieplownicza_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecCieplownicza_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecTelekomunikacyjna_0_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecTelekomunikacyjna_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaSiecTelekomunikacyjna_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_PrzewodSpecjalny_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzeniaTechniczneSieciSpecjalnej_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_PrzewodNiezidentyfikowany_1_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="GES_UrzadzenieNiezidentyfikowane_0_zrodlo" hidden="0" width="-1" type="field"/>
