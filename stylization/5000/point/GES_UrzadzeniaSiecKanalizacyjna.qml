...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{819f80ed-f2f4-4dd7-b0ce-74d7ebebd95f}">
      <rule filter="rodzajUrzadzenia = 'u'" key="{e989fa87-701a-4390-a204-064486750684}" description="kanalizacyjne urządzenie techniczne">
      ...
      <rule filter="rodzajUrzadzenia = 'w'" key="{34dafb13-b4e4-4826-8ee6-5554171f91e9}" description="zasuwa, zawór ">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="0" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="128,51,0,255" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" legendString="Aa" fontSize="1.041666" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 's'" key="{c2e68a2a-fdde-4c9d-b608-89305ab9677d}" description="studnia kanalizacyjna">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="0" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="128,51,0,255" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" legendString="Aa" fontSize="1.041666" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 'm'" key="{7d619956-f145-46b2-8e20-463bca3cf734}" description="osadnik, szambo">
        <settings calloutType="simple">
