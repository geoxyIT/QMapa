...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <labeling type="rule-based">
    <rules key="{819f80ed-f2f4-4dd7-b0ce-74d7ebebd95f}">
      ...
      <rule key="{34dafb13-b4e4-4826-8ee6-5554171f91e9}" filter="rodzajUrzadzenia = 'w'" description="zasuwa, zawór ">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="128,51,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.041666" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="0" fontItalic="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
      ...
      <rule key="{c2e68a2a-fdde-4c9d-b608-89305ab9677d}" filter="rodzajUrzadzenia = 's'" description="studnia kanalizacyjna">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="128,51,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.041666" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="0" fontItalic="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
      ...
      <rule key="{7d619956-f145-46b2-8e20-463bca3cf734}" filter="rodzajUrzadzenia = 'm'" description="osadnik, szambo">
        <settings calloutType="simple">
