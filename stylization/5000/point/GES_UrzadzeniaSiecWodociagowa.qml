...
<qgis simplifyDrawingHints="0" maxScale="0" version="3.24.0-Tisler" simplifyDrawingTol="1" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{3753aa50-9260-4666-8ff7-5310fc7e6fe5}">
      <rule filter="rodzajUrzadzenia = 'h'" symbol="0" label="hydrant" key="{d2434400-6f91-4f6a-bc01-bf84e00d9286}"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="0,-1.94999999999999996" name="offset"/>
            ...
            <Option type="QString" value="8.4" name="size"/>
          ...
          <prop v="0,-1.94999999999999996" k="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{bb93694b-e429-47bd-9c3c-162c2c4b40f5}">
      <rule filter="rodzajUrzadzenia = 'h' and try(&quot;status&quot;) is 'p'" description="hydrofornia" key="{3ca3a59e-49da-487e-93c5-a7e4bb5eb0e9}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="0,0,255,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName=" 'proj.'+'w' " blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="7.8125" textOrientation="horizontal" fontWeight="50">
            <families/>
          ...
          <placement geometryGeneratorEnabled="0" placementFlags="10" centroidInside="1" polygonPlacementFlags="2" yOffset="0" offsetType="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" placement="1" priority="5" quadOffset="4" repeatDistance="0" lineAnchorClipping="0" layerType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" centroidWhole="0" distUnits="MM" maxCurvedCharAngleOut="-25" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" preserveRotation="1" overrunDistanceUnit="MM" lineAnchorType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5"/>
