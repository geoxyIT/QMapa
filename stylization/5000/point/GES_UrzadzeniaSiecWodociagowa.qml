...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="0" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{3753aa50-9260-4666-8ff7-5310fc7e6fe5}">
      <rule symbol="0" key="{d2434400-6f91-4f6a-bc01-bf84e00d9286}" filter="rodzajUrzadzenia = 'h'" label="hydrant"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" type="marker" alpha="1" name="0">
        ...
        <layer pass="0" locked="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option value="0,-1.80000000000000004" type="QString" name="offset"/>
            ...
            <Option value="7.5" type="QString" name="size"/>
          ...
          <prop k="offset" v="0,-1.80000000000000004"/>
    ...
    <rules key="{313266eb-7e14-4bac-b11f-32ea6868572b}">
      <rule description="hydrofornia" key="{63d84f83-0646-4c98-8d5c-21cdc8378a18}" filter="rodzajUrzadzenia = 'h' and try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
          ...
          <placement centroidWhole="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" overrunDistance="0" xOffset="0" placementFlags="10" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" fitInPolygonOnly="0" geometryGenerator="" layerType="PointGeometry" lineAnchorClipping="0" distUnits="MM" offsetUnits="MM" preserveRotation="1" maxCurvedCharAngleOut="-25" lineAnchorType="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" priority="5" repeatDistance="0" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" repeatDistanceUnits="MM" yOffset="0" centroidInside="1" placement="1" geometryGeneratorEnabled="0"/>
  ...
  <aliases>
    ...
    <alias field="GES_PrezentacjaGraficzna_0_fid" index="13" name=""/>
    <alias field="GES_PrezentacjaGraficzna_0_gml_id" index="14" name=""/>
    <alias field="GES_PrezentacjaGraficzna_0_katObrotu" index="15" name=""/>
  </aliases>
  <defaults>
