...
<qgis version="3.24.0-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" symbol="0"/>
    </rules>
    <symbols>
      <symbol name="0" type="marker" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="offset" type="QString" value="0.80000000000000004,-9.19999999999999929"/>
          ...
          <prop k="offset" v="0.80000000000000004,-9.19999999999999929"/>
  ...
  <labeling type="rule-based">
    <rules key="{df01cc42-e5c9-4fe3-bcd6-1694c1864667}">
      <rule filter="rodzajUrzadzenia = 'a' and try(&quot;status&quot;) is 'p' " description="turbina wiatrowa" key="{5eee9257-d7b0-4798-91b0-e19016f6438a}">
        <settings calloutType="simple">
          <text-style namedStyle="Normalny" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontSize="7.8125" textColor="0,0,0,255" fontWordSpacing="0" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" fontWeight="50" textOpacity="1" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'e' END&#xa;" blendMode="0" capitalization="0" fontLetterSpacing="0" fontFamily="Arial" fontStrikeout="0" isExpression="1" fontSizeUnit="MapUnit" fontKerning="1" fontItalic="0" multilineHeight="1">
            <families/>
          ...
          <placement geometryGenerator="" centroidInside="1" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" geometryGeneratorType="PointGeometry" priority="5" rotationUnit="AngleDegrees" maxCurvedCharAngleOut="-25" rotationAngle="0" yOffset="0" repeatDistance="0" repeatDistanceUnits="MM" dist="12" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MapUnit" preserveRotation="1" offsetUnits="MM" overrunDistanceUnit="MM" overrunDistance="0" lineAnchorClipping="0" placement="6" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorEnabled="0" placementFlags="10" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" lineAnchorPercent="0.5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PointGeometry"/>
