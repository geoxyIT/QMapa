...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
      ...
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="0">
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="7.5" type="QString" name="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{fdebeddb-f268-4da7-9333-cdf27941d5b8}">
      <rule description="wieża ciśnień" key="{eb255672-44a8-40d7-9036-a94cfafe775b}" filter="rodzajBudowli = 'c'">
      ...
      <rule description="wieża przeciwpożarowa" key="{83038091-4c25-413d-91ce-e8acbd9cbc21}" filter="rodzajBudowli = 'z'">
        <settings calloutType="simple">
      ...
      <rule description="wieża szybu kopalnianego" key="{98e6e9eb-8f2d-40f1-9012-ba3e83fd1ab9}" filter="rodzajBudowli = 's'">
        <settings calloutType="simple">
      ...
      <rule description="wieża widokowa" key="{5d1040ab-c59c-42f6-97c3-9cf62644d4e0}" filter="rodzajBudowli = 'w'">
        <settings calloutType="simple">
