...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{e5e65104-337a-4815-b02f-0ddfff356ac4}">
      <rule label="wieża ciśnień" symbol="0" key="{7ed59ac0-0595-41f9-83e6-c87f012c11c0}" filter="rodzajBudowli = 'c'"/>
      <rule label="wieża przeciwpożarowa" symbol="1" key="{e8833998-643f-4812-b40d-7dec1a6fb35e}" filter="rodzajBudowli = 'z'"/>
      <rule label="wieża szybu kopalnianego" symbol="2" key="{7533e866-043c-4a66-9867-139e681971d1}" filter="rodzajBudowli = 's'"/>
      <rule label="chłodnia kominowa" symbol="3" key="{17af13fb-7e89-476d-8356-1fbeda69b039}" filter="rodzajBudowli = 'k'"/>
      <rule label="komin przemysłowy" symbol="4" key="{b0d1d141-ae85-419b-98e3-de140a0a2bbd}" filter="rodzajBudowli = 'o'"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="7.5" name="offset"/>
            <Option type="QString" value="3x:3000,0,1,0.03,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MapUnit" name="offset_unit"/>
            <Option type="QString" value="0" name="ring_filter"/>
            <Option type="QString" value="0" name="trim_distance_end"/>
  ...
  <labeling type="rule-based">
    <rules key="{d8380c01-fea0-4140-85ee-c8274eeeffbf}">
      <rule key="{4ad5bc6c-0dca-4096-956b-65b2c5affe7b}" filter="rodzajBudowli = 'c'" description="wieża ciśnień">
      ...
      <rule key="{d6643074-d89c-4432-be62-692a6248cc56}" filter="rodzajBudowli = 'z'" description="wieża przeciwpożarowa">
        <settings calloutType="simple">
      ...
      <rule key="{a5f7b770-544c-4ea1-afa3-d41fa3f40dfd}" filter="rodzajBudowli = 's'" description="wieża szybu kopalnianego">
        <settings calloutType="simple">
      ...
      <rule key="{1fc1b37e-ef38-49c0-8326-bee52ca7c866}" filter="rodzajBudowli = 'w'" description="wieża widokowa">
        <settings calloutType="simple">
