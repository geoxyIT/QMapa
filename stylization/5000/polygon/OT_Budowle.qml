...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" type="fill">
        ...
        <layer pass="0" class="SimpleLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset" value="7.5" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{fdebeddb-f268-4da7-9333-cdf27941d5b8}">
      <rule key="{eb255672-44a8-40d7-9036-a94cfafe775b}" description="wieża ciśnień" filter="rodzajBudowli = 'c'">
      ...
      <rule key="{83038091-4c25-413d-91ce-e8acbd9cbc21}" description="wieża przeciwpożarowa" filter="rodzajBudowli = 'z'">
        <settings calloutType="simple">
      ...
      <rule key="{98e6e9eb-8f2d-40f1-9012-ba3e83fd1ab9}" description="wieża szybu kopalnianego" filter="rodzajBudowli = 's'">
        <settings calloutType="simple">
      ...
      <rule key="{5d1040ab-c59c-42f6-97c3-9cf62644d4e0}" description="wieża widokowa" filter="rodzajBudowli = 'w'">
        <settings calloutType="simple">
