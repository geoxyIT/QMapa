      ...
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="0">
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="1.75" type="QString" name="line_width"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="1">
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="round" type="QString" name="capstyle"/>
            <Option value="7.5;3.75" type="QString" name="customdash"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="customdash_map_unit_scale"/>
            <Option value="MapUnit" type="QString" name="customdash_unit"/>
            <Option value="0" type="QString" name="dash_pattern_offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="dash_pattern_offset_map_unit_scale"/>
  ...
  <labeling type="rule-based">
    <rules key="{e4e0c815-6893-4062-bc7e-942c07b27e8b}">
      ...
      <rule key="{32042e5b-1d6a-4774-b2e7-ffae2df16582}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="0,0,0,255" fontSize="1.7361" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) END" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferJoinStyle="128" bufferDraw="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
            <text-mask maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="" maskType="0"/>
            <background shapeSizeUnit="MM" shapeJoinStyle="64" shapeSizeType="0" shapeRadiiX="0" shapeOffsetX="0" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeOffsetUnit="MM" shapeOpacity="1" shapeSizeX="0" shapeRotation="0" shapeDraw="0" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeBorderWidth="0">
      ...
      <rule key="{ed881181-3efc-493c-8576-c0bfba9ec735}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="0,0,0,255" fontSize="1.7361" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) END" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferJoinStyle="128" bufferDraw="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
            <text-mask maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="" maskType="0"/>
            <background shapeSizeUnit="MM" shapeJoinStyle="64" shapeSizeType="0" shapeRadiiX="0" shapeOffsetX="0" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeOffsetUnit="MM" shapeOpacity="1" shapeSizeX="0" shapeRotation="0" shapeDraw="0" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeBorderWidth="0">
      ...
      <rule key="{ca5655a9-2104-4e5d-beeb-eebc82693772}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="0,0,0,255" fontSize="1.7361" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="string_to_array(string_to_array( &quot;idBudynku&quot; ,'.')[-1],'_')[0]" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferJoinStyle="128" bufferDraw="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
            <text-mask maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="" maskType="0"/>
            <background shapeSizeUnit="MM" shapeJoinStyle="64" shapeSizeType="0" shapeRadiiX="0" shapeOffsetX="0" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeOffsetUnit="MM" shapeOpacity="1" shapeSizeX="0" shapeRotation="0" shapeDraw="0" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeBorderWidth="0">
          ...
          <text-format plussign="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" multilineAlign="3" leftDirectionSymbol="&lt;" wrapChar="" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" decimals="3" formatNumbers="0" addDirectionSymbol="0" placeDirectionSymbol="0"/>
          <placement centroidWhole="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" overrunDistance="0" xOffset="0" placementFlags="10" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" fitInPolygonOnly="0" geometryGenerator="" layerType="PolygonGeometry" lineAnchorClipping="0" distUnits="MM" offsetUnits="MapUnit" preserveRotation="1" maxCurvedCharAngleOut="-25" lineAnchorType="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" priority="5" repeatDistance="0" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" repeatDistanceUnits="MM" yOffset="2" centroidInside="1" placement="1" geometryGeneratorEnabled="0"/>
          <rendering limitNumLabels="0" scaleMax="0" fontLimitPixelSize="0" unplacedVisibility="0" upsidedownLabels="0" obstacleFactor="1" displayAll="1" scaleMin="0" labelPerPart="0" zIndex="0" fontMinPixelSize="3" scaleVisibility="0" obstacleType="1" minFeatureSize="0" fontMaxPixelSize="10000" mergeLines="0" obstacle="1" maxNumLabels="2000" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
