...
<qgis readOnly="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyLocal="1" maxScale="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" version="3.24.0-Tisler">
  <flags>
  ...
  <labeling type="rule-based">
    <rules key="{e4e0c815-6893-4062-bc7e-942c07b27e8b}">
      ...
      <rule key="{32042e5b-1d6a-4774-b2e7-ffae2df16582}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontUnderline="0" isExpression="1" fontSizeUnit="MapUnit" textColor="0,0,0,255" allowHtml="0" capitalization="0" textOpacity="1" blendMode="0" multilineHeight="1" fontWordSpacing="0" legendString="Aa" textOrientation="horizontal" fontSize="1.7361" fontStrikeout="0" fontFamily="Arial" useSubstitutions="0" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) END" previewBkgrdColor="255,255,255,255" fontWeight="50">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="1" bufferJoinStyle="128" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRadiiY="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeOpacity="1" shapeRadiiX="0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeBlendMode="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRotationType="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeSizeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRotation="0">
      ...
      <rule key="{ed881181-3efc-493c-8576-c0bfba9ec735}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontUnderline="0" isExpression="1" fontSizeUnit="MapUnit" textColor="0,0,0,255" allowHtml="0" capitalization="0" textOpacity="1" blendMode="0" multilineHeight="1" fontWordSpacing="0" legendString="Aa" textOrientation="horizontal" fontSize="1.7361" fontStrikeout="0" fontFamily="Arial" useSubstitutions="0" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) END" previewBkgrdColor="255,255,255,255" fontWeight="50">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="1" bufferJoinStyle="128" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRadiiY="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeOpacity="1" shapeRadiiX="0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeBlendMode="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRotationType="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeSizeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRotation="0">
      ...
      <rule key="{ca5655a9-2104-4e5d-beeb-eebc82693772}" filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontUnderline="0" isExpression="1" fontSizeUnit="MapUnit" textColor="0,0,0,255" allowHtml="0" capitalization="0" textOpacity="1" blendMode="0" multilineHeight="1" fontWordSpacing="0" legendString="Aa" textOrientation="horizontal" fontSize="1.7361" fontStrikeout="0" fontFamily="Arial" useSubstitutions="0" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fieldName="string_to_array(string_to_array( &quot;idBudynku&quot; ,'.')[-1],'_')[0]" previewBkgrdColor="255,255,255,255" fontWeight="50">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="1" bufferJoinStyle="128" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRadiiY="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeOpacity="1" shapeRadiiX="0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeBlendMode="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRotationType="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeSizeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRotation="0">
          ...
          <text-format wrapChar="" multilineAlign="3" placeDirectionSymbol="0" addDirectionSymbol="0" decimals="3" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" plussign="0" autoWrapLength="0"/>
          <placement quadOffset="4" offsetUnits="MapUnit" placement="1" layerType="PolygonGeometry" maxCurvedCharAngleIn="25" lineAnchorClipping="0" yOffset="2" repeatDistance="0" overrunDistance="0" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" dist="0" priority="5" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" xOffset="0" rotationUnit="AngleDegrees" preserveRotation="1" fitInPolygonOnly="0" repeatDistanceUnits="MM" overrunDistanceUnit="MM" lineAnchorType="0" distUnits="MM" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" geometryGenerator="" rotationAngle="0" geometryGeneratorEnabled="0" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering maxNumLabels="2000" zIndex="0" obstacle="1" scaleMax="0" obstacleType="1" limitNumLabels="0" scaleVisibility="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" mergeLines="0" upsidedownLabels="0" unplacedVisibility="0" displayAll="1" minFeatureSize="0" scaleMin="0" labelPerPart="0" fontMinPixelSize="3" obstacleFactor="1" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
