...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{d751d49f-7242-405f-901e-2361d17633ad}">
      <rule key="{61bb2742-c09c-4805-9d48-d4d8e835baa2}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{f8226c15-3675-426b-86c7-6d5621fc2bd3}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{b09d8eba-9798-4317-8bbb-86c662c5d445}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{f30fc9ca-b03e-400f-881a-4becd9003374}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{2696dd37-a7a7-44d5-9aec-4c950ad68315}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{576d41e6-3cd3-4bef-9260-9be6b879acd8}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{9995b1af-ccc1-484b-81ea-e80cd61ce401}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{1d2eeb04-6575-4b75-a3a5-7e34f70aef5f}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
