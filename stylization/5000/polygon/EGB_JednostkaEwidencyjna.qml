...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
      ...
      <symbol alpha="1" name="0" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="MarkerLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:60000,0,1,0.03,0,0" name="interval_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="interval_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
            <Option value="15" name="offset_along_line" type="QString"/>
            <Option value="3x:60000,0,1,0.03,0,0" name="offset_along_line_map_unit_scale" type="QString"/>
          ...
          <prop k="interval_map_unit_scale" v="3x:60000,0,1,0.03,0,0"/>
          <prop k="interval_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="15"/>
          <prop k="offset_along_line_map_unit_scale" v="3x:60000,0,1,0.03,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" fontSize="18.229099999999999" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="if(try(to_string(&quot;idJednostkiEwid&quot;)) is null, '', try(to_string(&quot;idJednostkiEwid&quot;)))+' '+if(try(to_string(&quot;nazwaWlasna&quot;)) is null, '', try(to_string(&quot;nazwaWlasna&quot;)))&#xa;" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="0,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
        <families/>
