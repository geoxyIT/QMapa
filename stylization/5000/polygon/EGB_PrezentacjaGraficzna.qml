...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{e772a9e8-c46e-4d81-bc5e-2f52c62a7aa8}">
      <rule key="{d2fcec3a-602f-479b-a0df-aad47e5bd5b8}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{4ffb630b-4cbd-4637-9478-567b2e465699}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{dfaee374-f459-404d-814d-bb61768a01e9}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{fbbec8c5-aeca-4a39-a5c5-96ba195a7c38}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{596e4b3a-78de-4a59-9f70-b027f8e18308}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{cd84a56f-90fc-4130-ae22-676e0034c636}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{77f4a60c-13a7-4041-bf63-b316bb58892c}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{6604fd84-4f2b-46af-8ccc-e7148cab8c34}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
