...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
      ...
      <symbol force_rhr="0" alpha="1" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="11.25;3.75"/>
            <Option name="customdash_map_unit_scale" type="QString" value="3x:25000,0,0,0.03,0,0"/>
          ...
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="11.25;3.75"/>
          <prop k="customdash_map_unit_scale" v="3x:25000,0,0,0.03,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="36,188,36,255" fieldName="if(try(to_string(&quot;OZU&quot;)) is null, '', try(to_string(&quot;OZU&quot;)))+if(try(to_string(&quot;OZK&quot;)) is null, '', try(to_string(&quot;OZK&quot;)))&#xa;" legendString="Aa" fontSize="10.416600000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
        <families/>
      ...
      <placement rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" overrunDistance="0" dist="0" placement="1" preserveRotation="1" geometryGenerator="" repeatDistance="0" lineAnchorPercent="0.5" placementFlags="10" layerType="PolygonGeometry" centroidWhole="0" offsetType="0" fitInPolygonOnly="0" priority="5" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" polygonPlacementFlags="2" lineAnchorType="0" quadOffset="7" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="OZK" editable="1"/>
    <field name="OZU" editable="1"/>
    <field name="fid" editable="1"/>
    <field name="gml_id" editable="1"/>
    <field name="idKonturu" editable="1"/>
    <field name="identifier" editable="1"/>
    <field name="koniecObiekt" editable="1"/>
    <field name="koniecWersjaObiekt" editable="1"/>
    <field name="lokalnyId" editable="1"/>
    <field name="oznaczenieTypuGleby" editable="1"/>
  ...
  <labelOnTop>
    <field labelOnTop="0" name="OZK"/>
    <field labelOnTop="0" name="OZU"/>
    <field labelOnTop="0" name="fid"/>
    <field labelOnTop="0" name="gml_id"/>
    <field labelOnTop="0" name="idKonturu"/>
    <field labelOnTop="0" name="identifier"/>
    <field labelOnTop="0" name="koniecObiekt"/>
    <field labelOnTop="0" name="koniecWersjaObiekt"/>
    <field labelOnTop="0" name="lokalnyId"/>
    <field labelOnTop="0" name="oznaczenieTypuGleby"/>
  ...
  <reuseLastValue>
    <field name="OZK" reuseLastValue="0"/>
    <field name="OZU" reuseLastValue="0"/>
    <field name="fid" reuseLastValue="0"/>
    <field name="gml_id" reuseLastValue="0"/>
    <field name="idKonturu" reuseLastValue="0"/>
