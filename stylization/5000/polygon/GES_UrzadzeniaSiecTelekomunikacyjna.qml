...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{18f234d1-5dec-49a5-980f-1561d9498a3d}">
      <rule symbol="0" key="{c3f9e874-3fc7-411b-8ec0-4f6543face55}" label="wieża telekomunikacyjna" filter="rodzajUrzadzenia = 'w'" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{33ade62b-9d13-4fb6-aff1-78b0084979a3}">
      <rule description="wieża telekomunikacyjna" key="{784e5d48-7c18-4d4c-9cab-6ae1c20793b6}" filter="rodzajUrzadzenia = 'w'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'t' ELSE 'WT' END&#10;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="13.021000000000001" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
