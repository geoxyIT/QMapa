...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule symbol="0" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" filter="rodzajObiektu = 'm'" label="most"/>
      <rule symbol="1" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" filter="rodzajObiektu = 'w'" label="wiadukt"/>
      <rule symbol="2" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" filter="rodzajObiektu = 'e'" label="estakada"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7b038c83-c962-4e8a-9d01-46df61ed3261}">
      <rule key="{d9309545-72c5-4d36-b332-c71782222228}" description="jezdnia" filter="rodzajObiektu = 'j'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'j.' + &quot;rodzajNawierzchni&quot;" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="7.8124500000000001" allowHtml="0" textColor="0,0,0,255">
            <families/>
