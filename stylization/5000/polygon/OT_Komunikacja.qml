...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule label="most" symbol="0" filter="rodzajObiektu = 'm'" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}"/>
      <rule label="wiadukt" symbol="1" filter="rodzajObiektu = 'w'" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}"/>
      <rule label="estakada" symbol="2" filter="rodzajObiektu = 'e'" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_width" type="QString" value="1.25"/>
  ...
  <labeling type="rule-based">
    <rules key="{7b038c83-c962-4e8a-9d01-46df61ed3261}">
      <rule filter="rodzajObiektu = 'j'" key="{d9309545-72c5-4d36-b332-c71782222228}" description="jezdnia">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="'j.' + &quot;rodzajNawierzchni&quot;" legendString="Aa" fontSize="7.8124500000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
