...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule filter="rodzajObiektu = 'm'" label="most" symbol="0" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}"/>
      <rule filter="rodzajObiektu = 'w'" label="wiadukt" symbol="1" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}"/>
      <rule filter="rodzajObiektu = 'e'" label="estakada" symbol="2" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:60000,0,1,0.03,0,0" name="border_width_map_unit_scale" type="QString"/>
          ...
          <prop k="border_width_map_unit_scale" v="3x:60000,0,1,0.03,0,0"/>
