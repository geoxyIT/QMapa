...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{452c0409-5565-45ac-886a-c76e93089323}">
      <rule description="hydrofornia" key="{bf4f07ac-8d6c-46da-94a7-eccd7ddbf454}" filter="rodzajUrzadzenia = 'r'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'w' ELSE 'H'&#10;END" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="7.8125" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,255,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
