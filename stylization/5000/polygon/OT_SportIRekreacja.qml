...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{b588a585-19b5-4b67-bab3-fb15748389ac}">
      <rule description="basen odkryty" key="{cf2af763-1fc1-4ece-91fa-c0924e98ee82}" filter="rodzajObiektu = 'b'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'bas.'" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="7.8125" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
