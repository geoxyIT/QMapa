...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      ...
      <rule symbol="2" key="{26a2adf8-a111-42ba-9162-6ac994510389}" label="wal przeciwpowodziowy" filter="rodzajObiektu = 'w'" />
      <rule symbol="3" key="{bd4b73d1-0e2e-43ee-ab75-7bc8a60c6367}" label="grobla" filter="rodzajObiektu = 'g'" />
      <rule symbol="4" key="{66bb1a4e-5b60-45dd-b8c4-ba6330bd611d}" label="zapora" filter="rodzajObiektu = 'z'" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4deae3c3-47ac-4320-bdfc-71b5338d77f4}">
      <rule description="woda płynąca" key="{849bd244-db63-4621-94d0-7f4980f20f23}" filter="rodzajObiektu = 'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="try(&quot;nazwaWlasna&quot;)" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="13.0207" isExpression="1" fontWeight="50" textOpacity="1" textColor="89,217,255,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
