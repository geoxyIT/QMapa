...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      ...
      <rule symbol="3" key="{26a2adf8-a111-42ba-9162-6ac994510389}" filter="rodzajObiektu = 'w'" scalemaxdenom="1500" label="wal przeciwpowodziowy"/>
      <rule symbol="4" key="{90710b10-e048-4120-b4cd-be4c5d82a485}" filter="rodzajObiektu = 'g'" label="grobla"/>
      <rule symbol="5" key="{bd4b73d1-0e2e-43ee-ab75-7bc8a60c6367}" filter="rodzajObiektu = 'g'" scalemaxdenom="1500" label="grobla"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="3">
        ...
        <layer pass="0" locked="0" class="GeometryGenerator" enabled="1">
          <Option type="Map">
            ...
            <Option value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/40), 50, 90, $area / ($perimeter/20),0.5)" type="QString" name="geometryModifier"/>
            <Option value="MapUnit" type="QString" name="units"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/40), 50, 90, $area / ($perimeter/20),0.5)"/>
        ...
        <layer pass="0" locked="0" class="GeometryGenerator" enabled="1">
          <Option type="Map">
            <Option value="Line" type="QString" name="SymbolType"/>
            <Option value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/40), 50, 90,0,1)" type="QString" name="geometryModifier"/>
            <Option value="MapUnit" type="QString" name="units"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/40), 50, 90,0,1)"/>
          <prop k="units" v="MapUnit"/>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
  ...
  <labeling type="rule-based">
    <rules key="{4ab7d0d8-4b20-44f8-9c12-e641bfe5d4a0}">
      <rule description="woda płynąca" key="{f890cd5b-2bbc-4c5b-94f6-13708a9c49e7}" filter="rodzajObiektu = 'p'">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="89,217,255,255" fontSize="13.0207" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="try(&quot;nazwaWlasna&quot;)" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
      ...
      <rule description="woda stojąca" key="{5643c540-6538-4b88-b000-9346097fe9f7}" filter="rodzajObiektu = 's'">
        <settings calloutType="simple">
