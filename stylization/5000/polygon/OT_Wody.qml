...
<qgis version="3.24.0-Tisler" symbologyReferenceScale="-1" labelsEnabled="1" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{2fcd0526-ec93-451e-9696-e2ca66397037}">
      ...
      <rule key="{3336bc7d-b73d-4b98-b8ca-7e38dab83885}" filter="rodzajObiektu = 's'" description="woda stojąca">
        <settings calloutType="simple">
