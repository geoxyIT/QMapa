...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule label="przepompownia" filter="rodzajUrzadzenia = 'n'" symbol="0" key="{c0c30269-e0fd-438c-8aba-f36964146691}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c43058e5-4ca3-4de1-acb3-3fba658a8f84}">
      <rule description="przepompownia" filter="rodzajUrzadzenia = 'n'" key="{8e7f9b45-4f58-4620-9ed2-40bf7b600985}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="7.8125" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="128,51,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'P' ELSE 'P' &#xa;END&#xa;" blendMode="0" isExpression="1">
            <families/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="idBranzowy" hidden="0" width="-1"/>
      <column type="field" name="GES_PrezentacjaGraficzna_0_fid" hidden="0" width="-1"/>
      <column type="field" name="GES_PrezentacjaGraficzna_0_gml_id" hidden="0" width="-1"/>
      <column type="field" name="GES_PrezentacjaGraficzna_0_katObrotu" hidden="0" width="-1"/>
