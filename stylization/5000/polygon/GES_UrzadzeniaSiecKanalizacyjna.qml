...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule symbol="0" key="{c0c30269-e0fd-438c-8aba-f36964146691}" label="przepompownia" filter="rodzajUrzadzenia = 'n'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c43058e5-4ca3-4de1-acb3-3fba658a8f84}">
      <rule description="przepompownia" key="{8e7f9b45-4f58-4620-9ed2-40bf7b600985}" filter="rodzajUrzadzenia = 'n'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'P' ELSE 'P' &#xa;END&#xa;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="7.8125" isExpression="1" fontWeight="50" textOpacity="1" textColor="128,51,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" name="GES_PrezentacjaGraficzna_0_fid" type="field"/>
