...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{dfc9e7f2-60a5-4dd9-a452-55837a71fa0c}">
      <rule symbol="0" key="{5a057897-2258-418d-9dea-5fb3250538d4}" filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="prezentacja_etykiety" index="12" name=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="wladajacy" hidden="0"/>
      <column width="-1" type="field" name="rodzajUrzadzenia" hidden="0"/>
      <column width="-1" type="field" name="eksploatacja" hidden="0"/>
      <column width="-1" type="field" name="informacjaDodatkowa" hidden="0"/>
      <column width="-1" type="field" name="prezentacja_etykiety" hidden="0"/>
      <column width="-1" type="field" name="GES_PrezentacjaGraficzna_0_fid" hidden="0"/>
      <column width="-1" type="field" name="GES_PrezentacjaGraficzna_0_gml_id" hidden="0"/>
      <column width="-1" type="field" name="GES_PrezentacjaGraficzna_0_katObrotu" hidden="0"/>
