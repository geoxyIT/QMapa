...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{f7bc68f2-f780-4b03-96e7-b17311f00d1f}">
      <rule symbol="0" key="{424a3be5-ab91-48bf-a23b-2bdfbc64c268}" label="wyciąg narciarski" filter="rodzajObiektu = 'w'"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="37.5" name="interval" type="QString"/>
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@0@0" type="marker" alpha="1">
            ...
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              <Option type="Map">
                <Option value="49" name="angle" type="QString"/>
