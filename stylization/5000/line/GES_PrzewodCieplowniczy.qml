...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="0"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="nullSymbol" referencescale="-1" />
  <labeling type="rule-based">
    <rules key="{608b0dce-bd1f-44d6-b174-d4fb07c522ca}">
      <rule description="przewód ciepłowniczy" key="{8231c8e3-f3d4-4de2-87c4-63e1cab59b43}" filter="ELSE">
      ...
      <rule description="przewód ciepłowniczy" key="{1ad4cbad-a12c-4605-85f3-e08f406e7b9f}" filter="try(&quot;srednica&quot;) &gt; 1500">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;zrodlo&quot; != 'O' and &quot;status&quot; = 'p' THEN &#10;'proj.'+'c'&#10;WHEN &quot;zrodlo&quot; = 'O' and &quot;status&quot; = 'p' THEN &#10;'proj.'+'c'&#10;WHEN &quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#10;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#10;WHEN &quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#10;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#10;WHEN &quot;zrodlo&quot; != 'O' THEN &#10;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#10;WHEN &quot;zrodlo&quot; = 'O' THEN &#10;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#10;END&#10;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.0417000000000001" isExpression="1" fontWeight="50" textOpacity="1" textColor="210,0,210,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128" />
