...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{a6d037a2-21fd-429c-9903-d64fc0ecf799}">
      <rule filter="try(&quot;przebieg&quot;) = 'p' or try(&quot;przebieg&quot;) = 'z'" description="przewód telekomunikacyjny podziemny" key="{7a4fade3-4905-4150-a99f-5b7a42476b71}">
      ...
      <rule filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; " description="przewód telekomunikacyjny napowietrzny" key="{52592c63-bd1b-406b-bc5b-339c34759008}">
        <settings calloutType="simple">
