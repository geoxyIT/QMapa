...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{a6d037a2-21fd-429c-9903-d64fc0ecf799}">
      <rule filter="try(&quot;przebieg&quot;) = 'p' or try(&quot;przebieg&quot;) = 'z'" key="{7a4fade3-4905-4150-a99f-5b7a42476b71}" description="przewód telekomunikacyjny podziemny">
      ...
      <rule filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; " key="{52592c63-bd1b-406b-bc5b-339c34759008}" description="przewód telekomunikacyjny napowietrzny">
        <settings calloutType="simple">
