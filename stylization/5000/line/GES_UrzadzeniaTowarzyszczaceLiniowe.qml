...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="0">
  ...
  <labeling type="rule-based">
    <rules key="{c1847437-f8d9-4c54-9e23-5414a54b9542}">
      ...
      <rule description="kanał technologiczny" key="{ad7f0c55-49b0-46f4-97e7-67b0476f13b0}" filter="urządzenie techniczne sieci niezidentyfikowanej">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="0,0,0,255" fontSize="1.0417000000000001" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'KT' ELSE 'KT' END&#xa;" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferJoinStyle="128" bufferDraw="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
  ...
  <aliases>
    ...
    <alias field="informacjaDodatkowa" index="11" name=""/>
    <alias field="rodzajUrzadzenia" index="12" name=""/>
    <alias field="rodzajSieci" index="13" name=""/>
    <alias field="srednica" index="14" name=""/>
  ...
  <defaults>
    ...
    <default field="srednica" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="rodzajSieci" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="srednica" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
