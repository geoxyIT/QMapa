...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="0">
  ...
  <labeling type="rule-based">
    <rules key="{478b3788-4c38-426f-b999-033be6bd3e6c}">
      <rule description="kanalizacyjne urządzenie techniczne" key="{1d30769a-d41d-4013-be27-5fb9fbacb017}" filter="rodzajUrzadzenia = 'u'">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="128,51,0,255" fontSize="1.041666" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
          ...
          <placement centroidWhole="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" overrunDistance="0" xOffset="0" placementFlags="10" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" fitInPolygonOnly="0" geometryGenerator="" layerType="LineGeometry" lineAnchorClipping="0" distUnits="MM" offsetUnits="MM" preserveRotation="1" maxCurvedCharAngleOut="-25" lineAnchorType="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" priority="5" repeatDistance="0" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" repeatDistanceUnits="MM" yOffset="0" centroidInside="0" placement="2" geometryGeneratorEnabled="0"/>
  ...
  <aliases>
    ...
    <alias field="ksztaltUrzadzenia" index="12" name=""/>
    <alias field="prezentacja_etykiety" index="13" name=""/>
    <alias field="informacjaDodatkowa" index="14" name=""/>
    <alias field="GES_PrezentacjaGraficzna_0_fid" index="15" name=""/>
    <alias field="GES_PrezentacjaGraficzna_0_gml_id" index="16" name=""/>
    <alias field="GES_PrezentacjaGraficzna_0_katObrotu" index="17" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="GES_PrezentacjaGraficzna_0_fid" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="rodzajUrzadzenia" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="ksztaltUrzadzenia" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    ...
    <constraint field="GES_PrezentacjaGraficzna_0_fid" unique_strength="1" notnull_strength="1" constraints="3" exp_strength="0"/>
    <constraint field="GES_PrezentacjaGraficzna_0_gml_id" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="GES_PrezentacjaGraficzna_0_katObrotu" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
