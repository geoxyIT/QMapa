...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{dfc9e7f2-60a5-4dd9-a452-55837a71fa0c}">
      ...
      <rule label="elektroenergetyczne urządzenie techniczne" symbol="2" key="{d74e8d45-b21d-4382-8acf-2e9545b6f110}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{68274147-1e70-4f63-8798-9ee84904af22}">
      <rule key="{2fdfecc3-1781-41b6-906f-bbdac69d44cb}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="elektroenergetyczne urządzenie techniczne">
      ...
      <rule key="{9df25502-2a8b-4990-850e-5135467221ab}" filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="szafa elektroenergetyczna, kontener">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="255,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'e'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
      ...
      <rule key="{aa3036e5-65d3-40b4-b7d9-7ad7f03d93c9}" filter="rodzajUrzadzenia = 'a' and try(&quot;status&quot;) is not 'p'" description="turbina wiatrowa">
        <settings calloutType="simple">
      ...
      <rule key="{70f4064c-5a39-421f-8db8-9a2b288d17f7}" filter=" try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
