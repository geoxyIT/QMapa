...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{7678524f-e971-4406-a29c-56ed4c85adaf}">
      <rule symbol="0" label="urządzenie techniczne sieci niezidentyfikowanej" key="{425ee22f-41c4-4a50-b719-938ae57fa067}" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e1870cd9-eafa-4395-8dad-532e1c50d0df}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{2cd01262-21a3-49c6-b7fb-413c6a116636}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{8bffbc40-b670-4177-8f0f-e3a21c90c44f}">
        <settings calloutType="simple">
