...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="fill" alpha="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="3.75" name="interval" type="QString"/>
        ...
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="round" name="capstyle" type="QString"/>
            <Option value="2.25;1.5" name="customdash" type="QString"/>
            <Option value="3x:5000,0,0,0.03,0,0" name="customdash_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="customdash_unit" type="QString"/>
            <Option value="0" name="dash_pattern_offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="if(try(to_string(&quot;idJednostkiEwid&quot;)) is null, '', try(to_string(&quot;idJednostkiEwid&quot;)))+' '+if(try(to_string(&quot;nazwaWlasna&quot;)) is null, '', try(to_string(&quot;nazwaWlasna&quot;)))&#xa;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="3.6457999999999999" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
        <families/>
