...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{a93a813a-3a1b-49cb-b60f-042019b9735c}">
      ...
      <rule filter="ELSE" symbol="1" label="nieoznaczone" key="{427914c2-1048-4e08-b88d-475ca325312a}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a88f0485-928f-4956-b783-7e2026106bcc}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{50e97b13-0269-4660-a120-d3b93a0fcdf5}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{9932ecac-c3c0-4338-b791-97a559905743}">
        <settings calloutType="simple">
