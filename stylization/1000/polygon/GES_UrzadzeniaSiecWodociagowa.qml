...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{4e47ac60-4aac-4464-889f-c5161a0685b9}">
      ...
      <rule label="wodociągowe urządzenie techniczne" symbol="1" key="{ed603c73-88db-4ed1-8250-4f2d679f6851}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6d0cf324-53d3-4115-be5e-47e77dc94073}">
      <rule key="{d3a21302-8fad-4c0b-a352-7781ea48f53a}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="wodociągowe urządzenie techniczne">
      ...
      <rule key="{58006ab1-2d59-4e65-a53f-c375dd03cf72}" filter="rodzajUrzadzenia = 'r' and try(&quot;status&quot;) is not 'p'" description="hydrofornia">
        <settings calloutType="simple">
      ...
      <rule key="{e83a5dc3-e594-477c-a909-4d2b0cd6337a}" filter="try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
