...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{eb895437-9f1b-427d-9c13-242e67b5c443}">
      <rule key="{ce49b176-8b57-4971-9cb5-fa331c4124e8}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{ef2a7527-8f93-496f-940c-6be0b7a1f53e}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{45b11a12-5a15-4f3b-9ae5-5b9c03ecf8d3}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{35a7c339-1aa9-4388-867e-e754e79780be}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{605acfe6-889d-4eb0-8c88-daa18696ed72}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{8708ca2c-32fa-4d37-a6a6-db1c49e5dd46}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{67f280ec-cc82-4456-acca-2adcbe23b325}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{bda0970a-098e-4013-b1c1-d22827657720}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
