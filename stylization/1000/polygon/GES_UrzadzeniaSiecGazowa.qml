...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{e6b13897-607d-44b5-a0e2-1c0fe05e277e}">
      <rule label="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{84557855-a30e-41ae-9dd8-a9ef6726e492}"/>
      <rule label="szafa gazowa, kontener" filter="rodzajUrzadzenia = 's'" symbol="1" key="{929fc2f8-f86f-4aa0-8a3e-960a308f2a8a}"/>
      <rule label="stacja gazowa" filter="rodzajUrzadzenia = 'n'" symbol="2" key="{f5e205a2-dc6e-43fe-bb53-64205cb99d84}"/>
      <rule label="zbiornik gazu" filter="rodzajUrzadzenia = 'v'" symbol="3" key="{9c145466-b881-4bb1-8728-4a6edb5b168f}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{bb625b02-dae6-45aa-ad25-117481f928d7}">
      <rule description="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{d843412c-3787-42c8-8155-954e0d79432a}">
      ...
      <rule description="szafa gazowa, kontener" filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" key="{77d0dfb7-dd16-4418-8ffc-ecc46c24d4cd}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.5625" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="191,191,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="'g'" blendMode="0" isExpression="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128"/>
      ...
      <rule description="stacja gazowa" filter="rodzajUrzadzenia = 'n' and try(&quot;status&quot;) is not 'p'" key="{5390b6c6-f2f3-4234-ad9f-5f0f359b354b}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.5625" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="191,191,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="'G'" blendMode="0" isExpression="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128"/>
      ...
      <rule description="zbiornik gazu" filter="rodzajUrzadzenia = 'v' and try(&quot;status&quot;) is not 'p'" key="{f7238024-1da6-4792-8efa-f3cc84b18bb2}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.5625" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="191,191,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="'zg'" blendMode="0" isExpression="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskSizeUnits="MM" maskType="0" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeOffsetY="0" shapeRotationType="0" shapeJoinStyle="64" shapeBorderWidthUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRotation="0" shapeOpacity="1" shapeDraw="0" shapeFillColor="255,255,255,255" shapeType="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeRadiiY="0" shapeBorderWidth="0" shapeSizeType="0" shapeBlendMode="0" shapeSizeX="0" shapeOffsetX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{96d54f63-6d16-41fa-b5e6-a6612b943fa9}">
        <settings calloutType="simple">
