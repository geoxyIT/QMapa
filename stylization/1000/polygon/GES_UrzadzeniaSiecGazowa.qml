...
<qgis hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" simplifyLocal="1" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{e6b13897-607d-44b5-a0e2-1c0fe05e277e}">
      ...
      <rule filter="rodzajUrzadzenia = 'u'" label="gazowe urządzenie techniczne" key="{1bd77aed-9432-4e03-88dc-1ff95a7e031b}" symbol="3"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{307d05be-1e4e-4ce6-acdd-e0d82cb2afa9}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{8dec419f-b661-4ada-8227-eabe60ebf437}" description="gazowe urządzenie techniczne">
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" key="{b40e8e39-baab-401b-82c9-a5ce37a5ca6e}" description="szafa gazowa, kontener">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'g'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.5625" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule filter="rodzajUrzadzenia = 'n' and try(&quot;status&quot;) is not 'p'" key="{f1d112ca-e9ed-4ce8-8c9a-0a1b84495257}" description="stacja gazowa">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'G'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.5625" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule filter="rodzajUrzadzenia = 'v' and try(&quot;status&quot;) is not 'p'" key="{07118c84-3482-4fbe-982f-9dde610cb771}" description="zbiornik gazu">
        <settings calloutType="simple">
      ...
      <rule filter="try(&quot;status&quot;) is  'p'" key="{aef8a225-c194-41b5-a453-370121c64bc0}" description="projektowane">
        <settings calloutType="simple">
