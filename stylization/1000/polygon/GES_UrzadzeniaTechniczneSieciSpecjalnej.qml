...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{4d221479-5127-410e-be74-346b08fcd8c9}">
      <rule filter="rodzajUrzadzenia = 'u'" symbol="0" label="urządzenie techniczne sieci specjalnej" key="{8eded192-67cd-4d45-8774-ecf2d23a0859}" />
  ...
  <labeling type="rule-based">
    <rules key="{cafd58f8-2af1-4a31-b443-d7fbd1f1c053}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{06027fc7-49fe-4c5d-a0f0-fc62fb5d797a}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{7fcc72d5-adc1-4de1-984c-9da605f99cc0}">
        <settings calloutType="simple">
