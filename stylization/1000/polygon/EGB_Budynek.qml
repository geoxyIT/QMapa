...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{cc1c9b43-b1c0-40fc-9e4f-64036345a28b}">
      <rule filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" symbol="0" label="budynek naziemny" key="{119a77b0-c572-4a1e-8b89-d6a0768c4603}" />
      <rule filter="(try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" symbol="1" label="budynek podziemny" key="{86bf6f44-6aa3-41f8-92dd-c3f8e7c4fcfd}" />
  ...
  <labeling type="rule-based">
    <rules key="{913e24f0-c359-4d5f-ad9e-6abd34b69a19}">
      ...
      <rule filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" key="{c38deade-cf64-4ca1-a9b7-b4cd25d91403}">
        <settings calloutType="simple">
      ...
      <rule filter="try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 " key="{83a330ef-884d-4326-94f8-2999363f3b02}">
        <settings calloutType="simple">
