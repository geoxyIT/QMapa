...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule filter="rodzajObiektu = 't'" label="taras" symbol="0" key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}"/>
      <rule filter="rodzajObiektu = 'w'" label="weranda, ganek" symbol="1" key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}"/>
      <rule filter="rodzajObiektu = 'i'" label="wiatrołap" symbol="2" key="{805755b1-0b08-48ed-8f89-32e251e5e287}"/>
      <rule filter="rodzajObiektu = 's' " label="schody" symbol="3" key="{b646e586-87cb-480c-b2e3-aa07e629729a}"/>
      <rule filter="rodzajObiektu = 'o'" label="podpora związana z budynkiem" symbol="4" key="{9315336e-9352-4f65-a647-a6a44f8b06a3}"/>
      <rule filter="rodzajObiektu = 'r'" label="rampa" symbol="5" key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}"/>
      <rule filter="rodzajObiektu = 'j'" label="wjazd do podziemia" symbol="6" key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}"/>
      <rule filter="rodzajObiektu = 'd'" label="podjazd dla osób niepełnosprawnych" symbol="7" key="{e40132d5-9fba-4968-97b2-e54f213209d9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{bd16b7d3-cac6-43c8-8809-c94250fdede0}">
      <rule filter="rodzajObiektu = 'r'" description="rampa" key="{e83ef7a7-293b-4228-a8a9-fa81d80c26eb}">
      ...
      <rule filter="rodzajObiektu = 'd'" description="podjazd dla osób niepełnosprawnych" key="{14c45127-704d-4514-8e83-4abe326414ef}">
        <settings calloutType="simple">
