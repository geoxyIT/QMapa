...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule label="taras" symbol="0" key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}" filter="rodzajObiektu = 't'"/>
      <rule label="weranda, ganek" symbol="1" key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}" filter="rodzajObiektu = 'w'"/>
      <rule label="wiatrołap" symbol="2" key="{805755b1-0b08-48ed-8f89-32e251e5e287}" filter="rodzajObiektu = 'i'"/>
      <rule label="schody" symbol="3" key="{b646e586-87cb-480c-b2e3-aa07e629729a}" filter="rodzajObiektu = 's' "/>
      <rule label="podpora związana z budynkiem" symbol="4" key="{9315336e-9352-4f65-a647-a6a44f8b06a3}" filter="rodzajObiektu = 'o'"/>
      <rule label="rampa" symbol="5" key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}" filter="rodzajObiektu = 'r'"/>
      <rule label="wjazd do podziemia" symbol="6" key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}" filter="rodzajObiektu = 'j'"/>
      <rule label="podjazd dla osób niepełnosprawnych" symbol="7" key="{e40132d5-9fba-4968-97b2-e54f213209d9}" filter="rodzajObiektu = 'd'"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="round" name="capstyle"/>
            <Option type="QString" value="0.75;0.75" name="customdash"/>
            <Option type="QString" value="3x:3000,0,1,0.03,0,0" name="customdash_map_unit_scale"/>
            <Option type="QString" value="MapUnit" name="customdash_unit"/>
            <Option type="QString" value="0" name="dash_pattern_offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="GeometryGenerator">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@3@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="6" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="PointPatternFill">
          <Option type="Map">
            ...
            <Option type="QString" value="0.75" name="displacement_x"/>
            ...
            <Option type="QString" value="1.5" name="distance_y"/>
            ...
            <Option type="QString" value="506757113" name="seed"/>
          </Option>
          <prop v="0" k="angle"/>
    ...
    <rules key="{bd16b7d3-cac6-43c8-8809-c94250fdede0}">
      <rule key="{e83ef7a7-293b-4228-a8a9-fa81d80c26eb}" filter="rodzajObiektu = 'r'" description="rampa">
        <settings calloutType="simple">
          ...
          <placement polygonPlacementFlags="2" xOffset="0" yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" quadOffset="4" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" centroidWhole="0" centroidInside="0" lineAnchorType="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" offsetUnits="MM" repeatDistance="0" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placement="0" rotationUnit="AngleDegrees" preserveRotation="1" overrunDistance="0" geometryGenerator="" dist="0" overrunDistanceUnit="MM" layerType="PolygonGeometry" distUnits="MM"/>
      ...
      <rule key="{14c45127-704d-4514-8e83-4abe326414ef}" filter="rodzajObiektu = 'd'" description="podjazd dla osób niepełnosprawnych">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'n'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="rodzajObiektuZwiazanegoZBudynkiem" width="-1"/>
      <column type="field" hidden="0" name="obliczona_geometria_1000" width="-1"/>
