...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{18f234d1-5dec-49a5-980f-1561d9498a3d}">
      <rule filter="rodzajUrzadzenia = 's'" label="szafa telekomunikacyjna, kontener" symbol="0" key="{a9cbd86d-1a01-4b70-a0a6-20c0aed3a8f5}"/>
      <rule filter="rodzajUrzadzenia = 'w'" label="wieża telekomunikacyjna" symbol="1" key="{c3f9e874-3fc7-411b-8ec0-4f6543face55}"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="telekomunikacyjne urządzenie techniczne" symbol="2" key="{aee1f957-2462-4e14-9a6b-7658ea09f3f1}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e284be58-d834-4036-83ee-63944dfdfe97}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="telekomunikacyjne urządzenie techniczne" key="{c1fc8acc-aea8-41e9-8da5-9e181c5c0d20}">
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="szafa telekomunikacyjna, kontener" key="{060515f8-91ff-4361-9545-42089430cc6e}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'t'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,145,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
      ...
      <rule filter=" try(&quot;status&quot;) is 'p'" description="projektowane" key="{7c56bbe0-cdbd-4147-a909-39c75c98b13d}">
        <settings calloutType="simple">
