...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule label="jezdnia" symbol="0" key="{676c2901-c1b5-4812-be23-8a349a317223}" filter="rodzajObiektu = 'j'"/>
      <rule label="chodnik" symbol="1" key="{b2abe3b4-6246-4ca6-ba2a-57716e8794eb}" filter="rodzajObiektu = 'c'"/>
      <rule label="droga dla rowerów" symbol="2" key="{bd775299-ca07-41d8-baa9-52d4e93663b3}" filter="rodzajObiektu = 'g'"/>
      <rule label="obszar utwardzony" symbol="3" key="{3621eae1-1c3f-45d0-b9ed-8e24f36d3cf1}" filter="rodzajObiektu = 'u'"/>
      <rule label="rów przydrożny" symbol="4" key="{5321ae88-caf9-4ddc-ad8f-ca585154f399}" filter="rodzajObiektu = 'r'"/>
      <rule label="przepust" symbol="5" key="{9abf2839-2735-41e2-8714-87165299506b}" filter="rodzajObiektu = 'z'"/>
      <rule label="schody w ciągu komunikacyjnym" symbol="6" key="{e25415e8-ca5b-4802-b9e7-c18b74f1aca1}" filter="rodzajObiektu = 's' "/>
      <rule label="most" symbol="7" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" filter="rodzajObiektu = 'm'"/>
      <rule label="wiadukt" symbol="8" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" filter="rodzajObiektu = 'w'"/>
      <rule label="estakada" symbol="9" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" filter="rodzajObiektu = 'e'"/>
      <rule label="peron" symbol="10" key="{09388348-12c0-4f98-b7c4-e3f656ee3dc0}" filter="rodzajObiektu = 'n'"/>
      <rule label="rampa" symbol="11" key="{81a3fe45-9d13-44f0-88b4-5adafcc4788d}" filter="rodzajObiektu = 'a'"/>
      <rule label="inny obiekt komunikacyjny" symbol="12" key="{224e0e5f-d3c3-4033-addd-072e911a0e77}" filter="rodzajObiektu = 'i'"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="7" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option type="QString" value="3x:3000,0,1,0.03,0,0" name="border_width_map_unit_scale"/>
          ...
          <prop v="3x:3000,0,1,0.03,0,0" k="border_width_map_unit_scale"/>
  ...
  <labeling type="rule-based">
    <rules key="{fc6b697c-9fc7-42a8-8430-b1e5735305a0}">
      ...
      <rule key="{1d201fed-f574-43ad-a88c-ab06081fbd8b}" filter="rodzajObiektu = 'c'" description="chodnik">
        <settings calloutType="simple">
      ...
      <rule key="{6e556776-26e5-4108-bdfd-3d44f37b30fb}" filter="rodzajObiektu = 'g'" description="droga dla rowerów">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'r'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{d51dc7d3-766b-4d35-af16-85b062d933db}" filter="rodzajObiektu = 'u'" description="obszar utwardzony">
        <settings calloutType="simple">
      ...
      <rule key="{a06fc206-9b79-450d-819c-4c97c97bc3cf}" filter="rodzajObiektu = 'r'" description="rów przydrożny">
        <settings calloutType="simple">
      ...
      <rule key="{b8e68c48-ddbd-4e1b-acd0-6706a068e143}" filter="rodzajObiektu = 'n'" description="peron">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'per'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{6395825b-f550-45b8-ad8f-fb5dc69d573e}" filter="rodzajObiektu = 'a'" description="rampa">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'rmp'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{9afb51b8-df84-468c-b0c6-fcee0d07fe80}" filter="rodzajObiektu = 'i'" description="inny obiekt komunikacyjny">
        <settings calloutType="simple">
