...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule filter="rodzajObiektu = 's' " symbol="5" key="{e25415e8-ca5b-4802-b9e7-c18b74f1aca1}" label="schody w ciągu komunikacyjnym"/>
      ...
      <symbol name="5" type="fill" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer class="GeometryGenerator" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="geometryModifier" type="QString" value="kreskowanie( geometry(get_feature( 'OT_poliliniaKierunkowa',  'gml_id' ,    &quot;gml_id&quot;   )), $geometry, 1, 100, 90, 0,1)"/>
  ...
  <labeling type="rule-based">
    <rules key="{f5ba4961-e4bb-4644-b3e7-7aa7abea250a}">
      <rule filter="rodzajObiektu = 'j'" key="{9ecb8e09-dcd3-46be-a9ea-0690c720a19d}" description="jezdnia">
      ...
      <rule filter="rodzajObiektu = 'c'" key="{83fe1d9c-0153-46b4-a35e-d84b1235e940}" description="chodnik">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'g'" key="{cecbb12d-e7b6-4a1e-93da-72dbb51893f6}" description="droga dla rowerów">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'u'" key="{eb6deab0-5a25-4d64-8023-945c0a1ffcb1}" description="obszar utwardzony">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'r'" key="{454185a9-c7d2-465b-b0f5-8383e52d01ef}" description="rów przydrożny">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'n'" key="{cebb0c4d-d366-4791-ae29-fd3d7a5d9c3d}" description="peron">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'a'" key="{fabac041-ea4c-4416-b323-929e2b0c02b2}" description="rampa">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'i'" key="{bd5ac776-82a0-4ec3-9cc2-b55369a2774a}" description="inny obiekt komunikacyjny">
        <settings calloutType="simple">
