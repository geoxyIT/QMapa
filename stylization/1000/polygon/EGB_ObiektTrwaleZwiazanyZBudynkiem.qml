...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{4402cd2b-a26f-44a1-a5bc-6664c7967240}">
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 't'" label="taras" symbol="0" key="{fa065e21-bd4d-4b32-95d5-1b14a396186a}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'w'" label="weranda, ganek" symbol="1" key="{b11b6b99-f24c-4dac-b2ad-a96f9f2699b1}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'i'" label="wiatrołap" symbol="2" key="{795ad3ec-f7a8-4344-9278-b74b6547559f}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 's' " label="schody" symbol="3" key="{e6a48dbe-d88a-4145-8f15-f63854030b37}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'o'" label="podpora" symbol="4" key="{0d857496-54b8-4ece-bc37-2c0a3ad07e4f}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'r'" label="rampa" symbol="5" key="{4f92aea1-46ea-40bd-91e8-1f71bc3cabf3}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'j'" label="wjazd do podziemia" symbol="6" key="{7446eccf-4e2d-4a13-8113-61a5ba239d4c}"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'd'" label="podjazd dla osób niepełnosprawnych" symbol="7" key="{89f057ff-ee2b-43fb-b41f-67e5a58b4ef6}"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="6" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="PointPatternFill" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:6000,0,1,0.03,0,0" name="random_deviation_x_map_unit_scale" type="QString"/>
            <Option value="MM" name="random_deviation_x_unit" type="QString"/>
            <Option value="0" name="random_deviation_y" type="QString"/>
            <Option value="3x:6000,0,1,0.03,0,0" name="random_deviation_y_map_unit_scale" type="QString"/>
            <Option value="MM" name="random_deviation_y_unit" type="QString"/>
            <Option value="848809716" name="seed" type="QString"/>
          </Option>
          <prop k="angle" v="0"/>
          <prop k="clip_mode" v="shape"/>
          <prop k="coordinate_reference" v="feature"/>
          <prop k="displacement_x" v="0.75"/>
          <prop k="displacement_x_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="displacement_x_unit" v="MapUnit"/>
          <prop k="displacement_y" v="0"/>
          <prop k="displacement_y_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="displacement_y_unit" v="MapUnit"/>
          <prop k="distance_x" v="1.5"/>
          <prop k="distance_x_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="distance_x_unit" v="MapUnit"/>
          <prop k="distance_y" v="1.5"/>
          <prop k="distance_y_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="distance_y_unit" v="MapUnit"/>
          <prop k="offset_x" v="0"/>
          <prop k="offset_x_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="offset_x_unit" v="MapUnit"/>
          <prop k="offset_y" v="0"/>
          <prop k="offset_y_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="offset_y_unit" v="MapUnit"/>
          <prop k="outline_width_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="random_deviation_x" v="0"/>
          <prop k="random_deviation_x_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
          <prop k="random_deviation_x_unit" v="MM"/>
          <prop k="random_deviation_y" v="0"/>
          <prop k="random_deviation_y_map_unit_scale" v="3x:6000,0,1,0.03,0,0"/>
    ...
    <rules key="{bbc384ee-d83b-42e1-a1e7-e0d5b053ffc0}">
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'r'" key="{d31ad69d-3ab4-4a0e-ae93-09036ab2225d}">
        <settings calloutType="simple">
          ...
          <text-format useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" multilineAlign="3" placeDirectionSymbol="0" formatNumbers="0" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" wrapChar="" rightDirectionSymbol=">" autoWrapLength="0"/>
          <placement placement="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" quadOffset="4" repeatDistance="0" rotationAngle="0" centroidInside="0" dist="0" offsetUnits="MM" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" layerType="PolygonGeometry" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" placementFlags="10" distUnits="MM" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" preserveRotation="1" repeatDistanceUnits="MM" overrunDistance="0" geometryGenerator="" xOffset="0" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="0" fitInPolygonOnly="0" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" centroidWhole="0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry"/>
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 'd'" key="{4a384088-fbbb-4247-84c3-a573f10e2d9e}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'n'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="0,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="0" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="rodzajObiektuZwiazanegoZBudynkiem" type="field" width="-1" hidden="0"/>
      <column name="obliczona_geometria_1000" type="field" width="-1" hidden="0"/>
