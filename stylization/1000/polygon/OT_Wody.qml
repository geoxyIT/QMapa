...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{f57a1ed5-6b47-4e7f-9102-415c1e77bd16}">
      <rule description="woda płynąca" key="{ba54ccc4-5469-45b8-8256-0df47ca46edb}" filter="rodzajObiektu = 'p'">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontStrikeout="0" textColor="89,217,255,255" fontSize="2.6042000000000001" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontKerning="1" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fontSizeUnit="MapUnit" capitalization="0" fontFamily="Arial" fontUnderline="0" allowHtml="0" fontItalic="0" isExpression="1" fieldName="try(&quot;nazwaWlasna&quot;)" namedStyle="Normal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50">
            <families/>
      ...
      <rule description="woda stojąca" key="{c901f04a-79ec-40dc-ba02-4fb875067713}" filter="rodzajObiektu = 's'">
        <settings calloutType="simple">
      ...
      <rule description="rów melioracyjny" key="{52032a2c-a4d8-45f1-9890-d0d5d0f828f4}" filter="rodzajObiektu = 'm'">
        <settings calloutType="simple">
      ...
      <rule description="jaz" key="{a934e3f6-555a-47f0-b0f7-7a93b4f88dca}" filter="rodzajObiektu = 'j'">
        <settings calloutType="simple">
      ...
      <rule description="śluza" key="{7f35ac8a-edcd-457d-b9e1-8151ceb28245}" filter="rodzajObiektu = 'l'">
        <settings calloutType="simple">
      ...
      <rule description="pomost, molo" key="{95c9b19a-49d4-404b-94de-9b4db5606610}" filter="rodzajObiektu = 'o'">
        <settings calloutType="simple">
