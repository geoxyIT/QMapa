...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      ...
      <rule label="wal przeciwpowodziowy" symbol="2" key="{fb573704-17ff-455c-9fb6-6ed825192a7c}" filter="rodzajObiektu = 'w'"/>
      ...
      <rule label="grobla" symbol="6" key="{195b312b-41ca-4f6d-aa3b-07ce92e360f7}" filter="rodzajObiektu = 'g'"/>
  ...
  <labeling type="rule-based">
    <rules key="{b28cae81-604f-4f9c-8ca6-ccacc7463ed7}">
      <rule key="{d3c061d1-143f-414c-bac1-1712f468e2a1}" filter="rodzajObiektu = 'p'" description="woda płynąca">
      ...
      <rule key="{775c95c1-cddc-4e47-8f4d-54e5da431765}" filter="rodzajObiektu = 's'" description="woda stojąca">
        <settings calloutType="simple">
      ...
      <rule key="{e7e5f4b8-a8b1-4857-96ab-1cf535d29a48}" filter="rodzajObiektu = 'm'" description="rów melioracyjny">
        <settings calloutType="simple">
      ...
      <rule key="{40089de4-12bf-4f6a-b872-7e066e0fcbe5}" filter="rodzajObiektu = 'j'" description="jaz">
        <settings calloutType="simple">
      ...
      <rule key="{b37c3963-d724-4319-8b2b-a15e8ad67199}" filter="rodzajObiektu = 'l'" description="śluza">
        <settings calloutType="simple">
      ...
      <rule key="{2e0f27c5-ec8a-4752-8e25-599edb7eeff1}" filter="rodzajObiektu = 'o'" description="pomost, molo">
        <settings calloutType="simple">
