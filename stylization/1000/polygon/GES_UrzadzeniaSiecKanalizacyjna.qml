...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      ...
      <rule label="kanalizacyjne urządzenie techniczne" symbol="5" key="{05cdf051-c1d8-4b2e-b151-1ed2e00c4e2d}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{1643c0d7-6597-49bf-a04c-5a911aa5d365}">
      <rule key="{0456f73e-d75f-44eb-ad89-3b573151ca0f}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="kanalizacyjne urządzenie techniczne">
      ...
      <rule key="{5fa0ab80-feef-417e-9448-c64cbc7a03bc}" filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="studnia kanalizacyjna">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="128,51,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'k'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
      ...
      <rule key="{ee21ab10-8dad-4638-9b84-808ccda376c8}" filter="rodzajUrzadzenia = 'k' and try(&quot;status&quot;) is not 'p'" description="kratka ściekowa">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="128,51,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'k'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
      ...
      <rule key="{f72a9ee5-84f3-412c-8212-0bdcf106d049}" filter="rodzajUrzadzenia = 'm' and try(&quot;status&quot;) is not 'p'" description="osadnik, szambo">
        <settings calloutType="simple">
      ...
      <rule key="{eae27f7c-ef29-429e-be63-9bbd562ce230}" filter="rodzajUrzadzenia = 'd' and try(&quot;status&quot;) is not 'p'" description="przydomowa oczyszczalnia ścieków">
        <settings calloutType="simple">
      ...
      <rule key="{d8b5c2aa-e6e2-4a90-b962-6bc0ee784dcc}" filter="rodzajUrzadzenia = 'n' and try(&quot;status&quot;) is not 'p'" description="przepompownia">
        <settings calloutType="simple">
      ...
      <rule key="{d93372fa-74e9-4f20-9987-af73a12943d1}" filter="try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
