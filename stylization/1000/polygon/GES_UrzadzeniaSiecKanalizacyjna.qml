...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule filter="rodzajUrzadzenia = 's'" label="studnia kanalizacyjna" symbol="0" key="{1676059a-dc29-4eac-8bd9-b36a27650c98}"/>
      <rule filter="rodzajUrzadzenia = 'k'" label="kratka ściekowa" symbol="1" key="{dfe076b1-9606-4ff8-a97d-e01b5ee22696}"/>
      <rule filter="rodzajUrzadzenia = 'm'" label="osadnik, szambo" symbol="2" key="{e3fd26e9-8ac5-435b-81af-191e86adbd4e}"/>
      <rule filter="rodzajUrzadzenia = 'd'" label="przydomowa oczyszczalnia ścieków" symbol="3" key="{adf95eda-930a-45e1-926f-11c5445d0a56}"/>
      <rule filter="rodzajUrzadzenia = 'n'" label="przepompownia" symbol="4" key="{c0c30269-e0fd-438c-8aba-f36964146691}"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="kanalizacyjne urządzenie techniczne" symbol="5" key="{05cdf051-c1d8-4b2e-b151-1ed2e00c4e2d}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{1643c0d7-6597-49bf-a04c-5a911aa5d365}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="kanalizacyjne urządzenie techniczne" key="{0456f73e-d75f-44eb-ad89-3b573151ca0f}">
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="studnia kanalizacyjna" key="{5fa0ab80-feef-417e-9448-c64cbc7a03bc}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'k'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="128,51,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 'k' and try(&quot;status&quot;) is not 'p'" description="kratka ściekowa" key="{ee21ab10-8dad-4638-9b84-808ccda376c8}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'k'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="128,51,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 'm' and try(&quot;status&quot;) is not 'p'" description="osadnik, szambo" key="{f72a9ee5-84f3-412c-8212-0bdcf106d049}">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajUrzadzenia = 'd' and try(&quot;status&quot;) is not 'p'" description="przydomowa oczyszczalnia ścieków" key="{eae27f7c-ef29-429e-be63-9bbd562ce230}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'sc'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="128,51,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="0" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
      ...
      <rule filter="rodzajUrzadzenia = 'n' and try(&quot;status&quot;) is not 'p'" description="przepompownia" key="{d8b5c2aa-e6e2-4a90-b962-6bc0ee784dcc}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'P'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="128,51,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="0" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" description="projektowane" key="{d93372fa-74e9-4f20-9987-af73a12943d1}">
        <settings calloutType="simple">
