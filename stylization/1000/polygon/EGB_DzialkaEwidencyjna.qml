...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="2.0832999999999999" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="string_to_array( &quot;idDzialki&quot;,'.')[-1]" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
        <families/>
      ...
      <placement polygonPlacementFlags="2" xOffset="0" yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" quadOffset="4" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" centroidWhole="0" centroidInside="1" lineAnchorType="0" placementFlags="10" lineAnchorClipping="0" rotationAngle="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" offsetUnits="MapUnit" repeatDistance="0" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placement="1" rotationUnit="AngleDegrees" preserveRotation="1" overrunDistance="0" geometryGenerator="" dist="0" overrunDistanceUnit="MM" layerType="PolygonGeometry" distUnits="MM"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="rodzajBloku" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="OFU"/>
    <field editable="1" name="dataWyceny"/>
    <field editable="1" name="dodatkoweInformacje"/>
    <field editable="1" name="dokladnoscReprezentacjiPola"/>
    <field editable="1" name="dzialkaObjetaFormaOchronyPrzyrody"/>
    <field editable="1" name="fid"/>
    <field editable="1" name="gml_id"/>
    <field editable="1" name="idDzialki"/>
    <field editable="1" name="idRejonuStatystycznego"/>
    <field editable="1" name="identifier"/>
    <field editable="1" name="informacjaODokladnReprezentacjiPola"/>
    <field editable="1" name="koniecObiekt"/>
    <field editable="1" name="koniecWersjaObiekt"/>
    <field editable="1" name="lokalnyId"/>
    <field editable="1" name="nrRejestruZabytkow"/>
    <field editable="1" name="numerElektronicznejKW"/>
    <field editable="1" name="numerKW"/>
    <field editable="1" name="poleEwidencyjne"/>
    <field editable="1" name="poleEwidencyjne_uom"/>
    <field editable="1" name="powierzchnia"/>
    <field editable="1" name="powierzchniaEwidencyjna"/>
    <field editable="1" name="powierzchniaEwidencyjna_uom"/>
    <field editable="1" name="powierzchnia_uom"/>
    ...
    <field editable="1" name="wartoscGruntu"/>
    <field editable="1" name="waznoscDo"/>
    <field editable="1" name="waznoscOd"/>
    <field editable="1" name="wersjaId"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="OFU"/>
    <field labelOnTop="0" name="dataWyceny"/>
    <field labelOnTop="0" name="dodatkoweInformacje"/>
    <field labelOnTop="0" name="dokladnoscReprezentacjiPola"/>
    <field labelOnTop="0" name="dzialkaObjetaFormaOchronyPrzyrody"/>
    <field labelOnTop="0" name="fid"/>
    <field labelOnTop="0" name="gml_id"/>
    <field labelOnTop="0" name="idDzialki"/>
    <field labelOnTop="0" name="idRejonuStatystycznego"/>
    <field labelOnTop="0" name="identifier"/>
    <field labelOnTop="0" name="informacjaODokladnReprezentacjiPola"/>
    <field labelOnTop="0" name="koniecObiekt"/>
    <field labelOnTop="0" name="koniecWersjaObiekt"/>
    <field labelOnTop="0" name="lokalnyId"/>
    <field labelOnTop="0" name="nrRejestruZabytkow"/>
    <field labelOnTop="0" name="numerElektronicznejKW"/>
    <field labelOnTop="0" name="numerKW"/>
    <field labelOnTop="0" name="poleEwidencyjne"/>
    <field labelOnTop="0" name="poleEwidencyjne_uom"/>
    <field labelOnTop="0" name="powierzchnia"/>
    <field labelOnTop="0" name="powierzchniaEwidencyjna"/>
    <field labelOnTop="0" name="powierzchniaEwidencyjna_uom"/>
    <field labelOnTop="0" name="powierzchnia_uom"/>
    ...
    <field labelOnTop="0" name="wartoscGruntu"/>
    <field labelOnTop="0" name="waznoscDo"/>
    <field labelOnTop="0" name="waznoscOd"/>
    <field labelOnTop="0" name="wersjaId"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="OFU"/>
    <field reuseLastValue="0" name="dokladnoscReprezentacjiPola"/>
    <field reuseLastValue="0" name="fid"/>
    <field reuseLastValue="0" name="gml_id"/>
    <field reuseLastValue="0" name="idDzialki"/>
    ...
    <field reuseLastValue="0" name="poleEwidencyjne"/>
    <field reuseLastValue="0" name="poleEwidencyjne_uom"/>
    <field reuseLastValue="0" name="powierzchnia"/>
    <field reuseLastValue="0" name="powierzchnia_uom"/>
