...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="string_to_array( &quot;idDzialki&quot;,'.')[-1]" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="2.0832999999999999" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
        <families/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    <field name="OFU" labelOnTop="0"/>
    <field name="dataWyceny" labelOnTop="0"/>
    <field name="dodatkoweInformacje" labelOnTop="0"/>
    <field name="dokladnoscReprezentacjiPola" labelOnTop="0"/>
    <field name="dzialkaObjetaFormaOchronyPrzyrody" labelOnTop="0"/>
    <field name="fid" labelOnTop="0"/>
    <field name="gml_id" labelOnTop="0"/>
    <field name="idDzialki" labelOnTop="0"/>
    <field name="idRejonuStatystycznego" labelOnTop="0"/>
    <field name="identifier" labelOnTop="0"/>
    <field name="informacjaODokladnReprezentacjiPola" labelOnTop="0"/>
    <field name="koniecObiekt" labelOnTop="0"/>
    <field name="koniecWersjaObiekt" labelOnTop="0"/>
    <field name="lokalnyId" labelOnTop="0"/>
    <field name="nrRejestruZabytkow" labelOnTop="0"/>
    <field name="numerElektronicznejKW" labelOnTop="0"/>
    <field name="numerKW" labelOnTop="0"/>
    <field name="poleEwidencyjne" labelOnTop="0"/>
    <field name="poleEwidencyjne_uom" labelOnTop="0"/>
    <field name="powierzchnia" labelOnTop="0"/>
    <field name="powierzchniaEwidencyjna" labelOnTop="0"/>
    <field name="powierzchniaEwidencyjna_uom" labelOnTop="0"/>
    <field name="powierzchnia_uom" labelOnTop="0"/>
    ...
    <field name="wartoscGruntu" labelOnTop="0"/>
    <field name="waznoscDo" labelOnTop="0"/>
    <field name="waznoscOd" labelOnTop="0"/>
