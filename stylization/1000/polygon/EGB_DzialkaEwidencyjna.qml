...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="string_to_array( &quot;idDzialki&quot;,'.')[-1]" legendString="Aa" fontSize="2.0832999999999999" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
        <families/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="OFU" editable="1"/>
    <field name="dataWyceny" editable="1"/>
    <field name="dodatkoweInformacje" editable="1"/>
    <field name="dokladnoscReprezentacjiPola" editable="1"/>
    <field name="dzialkaObjetaFormaOchronyPrzyrody" editable="1"/>
    <field name="fid" editable="1"/>
    <field name="gml_id" editable="1"/>
    <field name="idDzialki" editable="1"/>
    <field name="idRejonuStatystycznego" editable="1"/>
    <field name="identifier" editable="1"/>
    <field name="informacjaODokladnReprezentacjiPola" editable="1"/>
    <field name="koniecObiekt" editable="1"/>
    <field name="koniecWersjaObiekt" editable="1"/>
    <field name="lokalnyId" editable="1"/>
    <field name="nrRejestruZabytkow" editable="1"/>
    <field name="numerElektronicznejKW" editable="1"/>
    <field name="numerKW" editable="1"/>
    <field name="poleEwidencyjne" editable="1"/>
    <field name="poleEwidencyjne_uom" editable="1"/>
    <field name="powierzchnia" editable="1"/>
    <field name="powierzchniaEwidencyjna" editable="1"/>
    <field name="powierzchniaEwidencyjna_uom" editable="1"/>
    <field name="powierzchnia_uom" editable="1"/>
    ...
    <field name="wartoscGruntu" editable="1"/>
    <field name="waznoscDo" editable="1"/>
    <field name="waznoscOd" editable="1"/>
  ...
  <reuseLastValue>
    <field name="OFU" reuseLastValue="0"/>
    <field name="dokladnoscReprezentacjiPola" reuseLastValue="0"/>
    <field name="fid" reuseLastValue="0"/>
    <field name="gml_id" reuseLastValue="0"/>
    <field name="idDzialki" reuseLastValue="0"/>
    ...
    <field name="poleEwidencyjne" reuseLastValue="0"/>
    <field name="poleEwidencyjne_uom" reuseLastValue="0"/>
    <field name="powierzchnia" reuseLastValue="0"/>
    <field name="powierzchnia_uom" reuseLastValue="0"/>
