...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <labeling type="rule-based">
    <rules key="{dc71b8d9-bb64-4e4b-9464-c0c14a435732}">
      <rule key="{df44ee13-e9b1-4d2a-85e3-57fd289de61f}" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" description="właz do komory, kanału ">
      ...
      <rule key="{3c69cc0e-44be-42f4-a5f6-f78b562370da}" filter="rodzajUrzadzenia = 'b' and try(&quot;status&quot;) is not 'p'" description="budowla podziemna">
        <settings calloutType="simple">
      ...
      <rule key="{d3460a3c-56f9-4139-9848-189a8fad03cf}" filter="try(&quot;status&quot;) is  'p'" description="projektowane">
        <settings calloutType="simple">
