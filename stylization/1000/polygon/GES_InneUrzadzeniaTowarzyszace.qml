...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{7e7666ba-9fa1-4747-aadb-c8119055cca7}">
      <rule filter="rodzajUrzadzenia = 'k'" symbol="0" label="komora podziemna" key="{c9f6255f-26a3-4216-8d3d-9685d2875405}"/>
      <rule filter="rodzajUrzadzenia = 'w'" symbol="1" label="właz do komory, kanału " key="{f24f9bf1-f454-41b0-b5ac-8d19d9fea99f}"/>
      <rule filter="rodzajUrzadzenia = 'b'" symbol="2" label="budowla podziemna" key="{1a853d61-b843-43ee-a75e-5482bc95d3b4}"/>
      <rule filter="ELSE" symbol="3" label="nieoznaczone" key="{427914c2-1048-4e08-b88d-475ca325312a}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{92d20271-2e1c-4e7f-be1d-050b98563c87}">
      <rule description="właz do komory, kanału " filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" key="{8960af76-24ea-4956-9c0a-3efc563aee9e}">
        <settings calloutType="simple">
          <text-style fontWeight="50" fontSizeUnit="MapUnit" textColor="0,0,0,255" fontKerning="1" legendString="Aa" fontStrikeout="0" fontLetterSpacing="0" namedStyle="Normal" allowHtml="0" fieldName=" regexp_substr(  &quot;rodzajSieci&quot; , '([a-zA-Z,]+)')&#xa;" fontSize="1.5625" fontItalic="0" fontFamily="Arial" capitalization="0" fontUnderline="0" useSubstitutions="0" blendMode="0" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" textOpacity="1" fontWordSpacing="0" multilineHeight="1" textOrientation="horizontal" isExpression="1">
            <families/>
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{6a2681d6-7153-4afc-b761-90212e18c424}">
        <settings calloutType="simple">
