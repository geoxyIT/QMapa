...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{7e7666ba-9fa1-4747-aadb-c8119055cca7}">
      <rule filter="rodzajUrzadzenia = 'k'" label="komora podziemna" symbol="0" key="{c9f6255f-26a3-4216-8d3d-9685d2875405}"/>
      <rule filter="rodzajUrzadzenia = 'w'" label="właz do komory, kanału " symbol="1" key="{f24f9bf1-f454-41b0-b5ac-8d19d9fea99f}"/>
      <rule filter="rodzajUrzadzenia = 'b'" label="budowla podziemna" symbol="2" key="{1a853d61-b843-43ee-a75e-5482bc95d3b4}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{dc71b8d9-bb64-4e4b-9464-c0c14a435732}">
      <rule filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" description="właz do komory, kanału " key="{df44ee13-e9b1-4d2a-85e3-57fd289de61f}">
      ...
      <rule filter="try(&quot;status&quot;) is  'p'" description="projektowane" key="{d3460a3c-56f9-4139-9848-189a8fad03cf}">
        <settings calloutType="simple">
