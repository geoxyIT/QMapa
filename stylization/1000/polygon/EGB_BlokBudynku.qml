...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{8a54f2a3-9034-43d6-b62f-a446aef2d964}">
      <rule filter="rodzajBloku = 'n'" label="kondygnacja nadziemna" symbol="0" key="{3db8e58c-7e52-4d01-a37f-5b74a0bd063f}"/>
      <rule filter="rodzajBloku = 'p'" label="kondygnacja podziemna" symbol="1" key="{5f899ab2-12d9-4605-9142-89cfe23f6b5f}"/>
      <rule filter="rodzajBloku = 'l'" label="łącznik" symbol="2" key="{aee4fe68-8e44-4828-a4b1-96a649d97ea7}"/>
      <rule filter="rodzajBloku = 'a'" label="nawis" symbol="3" key="{fe626f24-b1c8-4569-8ccf-face248bdbf8}"/>
      <rule filter="rodzajBloku = 'z'" label="przejazd przez budynek" symbol="4" key="{b0707e6f-239d-4d8f-9ee7-42afadc29247}"/>
      <rule filter="rodzajBloku = 'y' and not try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1" label="inny nadziemny" symbol="5" key="{a93e7301-3156-485b-8d79-3417b8009890}"/>
      <rule filter="rodzajBloku = 'y' and try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1" label="inny podziemny" symbol="6" key="{1a19a0b1-1b51-4d68-a28d-69879941501f}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a594a843-b0ea-467a-b772-11255a1314a3}">
      ...
      <rule filter="&quot;rodzajBloku&quot; = 'p'" key="{fda34cc1-483b-41ea-ae01-f8c815b0a87f}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="2.0832999999999999" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="if(try(to_string(&quot;numerNajnizszejKondygnacji&quot;)) is null, '', try(to_string(&quot;numerNajnizszejKondygnacji&quot;)))&#xa;" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="0,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="0" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="rodzajBloku" type="field" width="-1" hidden="0"/>
