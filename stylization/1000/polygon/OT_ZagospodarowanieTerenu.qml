...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{bb778299-c56c-419a-ba33-8f5dd5a4b6ec}">
      <rule filter="rodzajObiektu = 't'" symbol="0" label="trawnik" key="{f56436ed-5f7e-4ee5-9fa5-4e455bfdc64b}"/>
      <rule filter="rodzajObiektu = 'k'" symbol="1" label="zadrzewienie, zakrzewienie" key="{1bb3a272-7dfe-4a91-b3c0-a4ddf4cc9058}"/>
      <rule filter="rodzajObiektu = 'z'" symbol="2" label="teren zalesiony" key="{af0a366c-0486-4e9a-ac8b-93b5710c1e19}"/>
      ...
      <rule filter="ELSE" symbol="5" label="nieoznaczone" key="{427914c2-1048-4e08-b88d-475ca325312a}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{876705f9-e7cf-4a67-966b-8b3f2e2fed38}">
      <rule description="inny obiekt zagospodarowania terenu" filter="rodzajObiektu = 'i'" key="{3b2e8eb3-cf84-497b-864c-d1b8f1310145}">
