...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{fa52eebb-7997-4077-af46-9e415d571107}">
      <rule label="skarpa umocniona" symbol="0" key="{15922814-7eea-4bdf-b667-7e6b1b53e98f}" filter="rodzajSkarpy = 'u'"/>
      <rule label="skarpa nieumocniona" symbol="1" key="{253c47bf-fdfd-4a5c-ae8e-e1c919c3007a}" filter="rodzajSkarpy = 'k'"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="GeometryGenerator">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@1@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="rodzajSkarpy" width="-1"/>
