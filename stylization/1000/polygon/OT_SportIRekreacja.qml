...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{37df8551-b8b2-485a-a44a-786c3919eb83}">
      <rule filter="rodzajObiektu = 'b'" symbol="0" label="basen odkryty" key="{a0262446-7acd-4906-8231-6375189a82bc}"/>
      <rule filter="rodzajObiektu = 'p'" symbol="1" label="plac sportowy" key="{ba9e2354-c4d4-4bad-8e92-4766f73fedad}"/>
      <rule filter="rodzajObiektu = 'z'" symbol="2" label="plac gier i zabaw" key="{dddcced0-87af-4c26-9292-121c27ff3232}"/>
      <rule filter="rodzajObiektu = 'i'" symbol="3" label="inny obiekt sportowy" key="{d8c5984a-fdc5-4b77-9f0a-ff5202dff23d}"/>
    ...
    <symbols>
      ...
      <symbol name="1" alpha="1" force_rhr="0" type="fill" clip_to_extent="1">
        ...
        <layer locked="0" class="CentroidFill" pass="0" enabled="1">
          ...
          <symbol name="@1@1" alpha="1" force_rhr="0" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer locked="0" class="SvgMarker" pass="0" enabled="1">
              <Option type="Map">
                ...
                <Option name="size" type="QString" value="8.00463"/>
          ...
          <symbol name="@2@1" alpha="1" force_rhr="0" type="marker" clip_to_extent="1">
            ...
            <layer locked="0" class="SvgMarker" pass="0" enabled="1">
              <Option type="Map">
                ...
                <Option name="parameters"/>
                <Option name="scale_method" type="QString" value="diameter"/>
                <Option name="size" type="QString" value="5.13863"/>
                <Option name="size_map_unit_scale" type="QString" value="3x:5000,0,0,0.03,0,0"/>
                <Option name="size_unit" type="QString" value="MapUnit"/>
                <Option name="vertical_anchor_point" type="QString" value="1"/>
              </Option>
