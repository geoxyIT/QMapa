...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{37df8551-b8b2-485a-a44a-786c3919eb83}">
      <rule label="basen odkryty" symbol="0" key="{a0262446-7acd-4906-8231-6375189a82bc}" filter="rodzajObiektu = 'b'"/>
      <rule label="plac sportowy" symbol="1" key="{ba9e2354-c4d4-4bad-8e92-4766f73fedad}" filter="rodzajObiektu = 'p'"/>
      <rule label="plac gier i zabaw" symbol="2" key="{dddcced0-87af-4c26-9292-121c27ff3232}" filter="rodzajObiektu = 'z'"/>
      <rule label="inny obiekt sportowy" symbol="3" key="{d8c5984a-fdc5-4b77-9f0a-ff5202dff23d}" filter="rodzajObiektu = 'i'"/>
    </rules>
    <symbols>
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@1@1" force_rhr="0">
            ...
            <layer pass="0" enabled="1" locked="0" class="SvgMarker">
              <Option type="Map">
                ...
                <Option type="QString" value="8.00463" name="size"/>
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@2@1" force_rhr="0">
            ...
            <layer pass="0" enabled="1" locked="0" class="SvgMarker">
              <Option type="Map">
                ...
                <Option name="parameters"/>
                <Option type="QString" value="diameter" name="scale_method"/>
                <Option type="QString" value="5.13863" name="size"/>
                <Option type="QString" value="3x:3000,0,1,0.03,0,0" name="size_map_unit_scale"/>
                <Option type="QString" value="MapUnit" name="size_unit"/>
                <Option type="QString" value="1" name="vertical_anchor_point"/>
              </Option>
