...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule symbol="0" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}" filter="rodzajUrzadzenia = 'u'" label="elektroenergetyczne urządzenie techniczne"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4f20f799-94cc-463f-bfa5-6dff3de928ae}">
      <rule key="{784b737b-2e3a-437c-a684-0ca7db5e0f8c}" description="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{f04def91-e54e-40cf-856e-81ada29bdb02}" description="projektowane" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
