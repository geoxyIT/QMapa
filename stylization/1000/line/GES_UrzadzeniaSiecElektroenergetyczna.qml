...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule filter="rodzajUrzadzenia = 'u'" label="elektroenergetyczne urządzenie techniczne" symbol="0" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4f20f799-94cc-463f-bfa5-6dff3de928ae}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="elektroenergetyczne urządzenie techniczne" key="{784b737b-2e3a-437c-a684-0ca7db5e0f8c}">
      ...
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="projektowane" key="{f04def91-e54e-40cf-856e-81ada29bdb02}">
        <settings calloutType="simple">
