...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{4f20f799-94cc-463f-bfa5-6dff3de928ae}">
      <rule description="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{784b737b-2e3a-437c-a684-0ca7db5e0f8c}">
      ...
      <rule description="projektowane" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{f04def91-e54e-40cf-856e-81ada29bdb02}">
        <settings calloutType="simple">
