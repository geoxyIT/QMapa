...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule filter="rodzajUrzadzenia = 'u'" symbol="0" label="elektroenergetyczne urządzenie techniczne" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}"/>
      <rule filter="ELSE" symbol="1" label="nieoznaczone" key="{5b0fbbe2-6105-4bbe-9b0e-1472f3438e4e}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{ac697b26-1dad-4d2b-947f-46456f80dd2e}">
      <rule description="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{3c92032d-eea8-4f11-8a1d-798c65dc8b97}">
      ...
      <rule description="projektowane" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{b4193040-31d6-4e93-8e11-a3e5fd6ac7b2}">
        <settings calloutType="simple">
