...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule label="elektroenergetyczne urządzenie techniczne" symbol="0" filter="rodzajUrzadzenia = 'u'" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4f20f799-94cc-463f-bfa5-6dff3de928ae}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{784b737b-2e3a-437c-a684-0ca7db5e0f8c}" description="elektroenergetyczne urządzenie techniczne">
      ...
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{f04def91-e54e-40cf-856e-81ada29bdb02}" description="projektowane">
        <settings calloutType="simple">
