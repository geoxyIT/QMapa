...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{c87c7111-3f19-4465-850a-18b01e6dc805}">
      ...
      <rule filter="ELSE" symbol="8" label="nieoznaczone" key="{5b0fbbe2-6105-4bbe-9b0e-1472f3438e4e}"/>
    </rules>
    <symbols>
      ...
      <symbol name="4" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
        ...
        <layer locked="0" class="MarkerLine" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option name="interval_unit" type="QString" value="MapUnit"/>
            <Option name="offset" type="QString" value="0"/>
            <Option name="offset_along_line" type="QString" value="1.125"/>
            <Option name="offset_along_line_map_unit_scale" type="QString" value="3x:5000,0,0,0,0,0"/>
            <Option name="offset_along_line_unit" type="QString" value="MapUnit"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:5000,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
  ...
  <labeling type="rule-based">
    <rules key="{e4e29c55-4182-4839-8fce-20493001e751}">
      <rule description="rów przydrożny" filter="rodzajObiektu = 'r'" key="{eeffd356-6188-47c9-9617-1694db40286d}">
      ...
      <rule description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'" key="{9365b222-fad7-45ad-bb7f-4edde506e54d}">
        <settings calloutType="simple">
