...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{55b54652-d654-45a6-920e-ada5066836ef}">
      <rule symbol="0" key="{93b33c59-76ec-4378-84a9-8b737af2fd38}" label="urządzenie techniczne sieci niezidentyfikowanej"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{ba3cd2c4-cb08-4951-b3ca-330feff12212}">
      <rule key="{ec085e48-a9f7-456a-90ef-38e50f1aaa6e}" description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{41f6fa80-8043-45e8-a8e1-fbcca48f0384}" description="projektowane" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
