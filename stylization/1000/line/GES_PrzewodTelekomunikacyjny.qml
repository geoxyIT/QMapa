...
<qgis simplifyLocal="1" simplifyDrawingTol="1" simplifyAlgorithm="0" minScale="100000000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" maxScale="0" labelsEnabled="1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{bb713a4a-de07-42ab-af3a-db3c75e01785}">
      <rule key="{e326e669-f506-4cd1-96d3-34443dc59fda}" symbol="0" label="podziemny / naziemny" filter="ELSE"/>
      <rule key="{30a16acd-5998-4a3a-b025-814702434acb}" symbol="1" label="napowietrzny" filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; "/>
    </rules>
    <symbols>
          ...
          <symbol name="@1@2" alpha="1" clip_to_extent="1" force_rhr="0" type="line">
            ...
            <layer class="MarkerLine" pass="0" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option name="offset" value="0" type="QString"/>
                <Option name="offset_along_line" value="11.25" type="QString"/>
              ...
              <prop v="0" k="offset"/>
              <prop v="11.25" k="offset_along_line"/>
