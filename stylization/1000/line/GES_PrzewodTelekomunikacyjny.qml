...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{bb713a4a-de07-42ab-af3a-db3c75e01785}">
      <rule filter="try(&quot;przebieg&quot;) = 'p' or try(&quot;przebieg&quot;) = 'z'" symbol="0" key="{e326e669-f506-4cd1-96d3-34443dc59fda}" label="podziemny / naziemny"/>
      <rule filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; " symbol="1" key="{30a16acd-5998-4a3a-b025-814702434acb}" label="napowietrzny"/>
      <rule filter="ELSE" symbol="2" key="{ba8c405c-82ed-47f8-b050-e086c4fbb2de}" label="przebieg nieokreślony"/>
    </rules>
    <symbols>
          ...
          <symbol name="@1@2" clip_to_extent="1" type="line" force_rhr="0" alpha="1">
            ...
            <layer class="MarkerLine" locked="0" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="offset" type="QString" value="0"/>
                <Option name="offset_along_line" type="QString" value="11.25"/>
              ...
              <prop k="offset" v="0"/>
              <prop k="offset_along_line" v="11.25"/>
  ...
  <fieldConfiguration>
    ...
    <field name="wiazka" configurationFlags="None">
  ...
  <aliases>
    ...
    <alias name="" index="13" field="wiazka"/>
  ...
  <defaults>
    ...
    <default expression="" field="wiazka" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="wiazka" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="wiazka" exp=""/>
