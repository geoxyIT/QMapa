...
<qgis simplifyLocal="1" simplifyDrawingTol="1" simplifyAlgorithm="0" minScale="100000000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" maxScale="0" labelsEnabled="1" simplifyDrawingHints="1" readOnly="0">
                  ...
                  <data_defined_properties>
                    <Option type="Map">
                      ...
                      <Option name="properties" type="Map">
                        <Option name="enabled" type="Map">
                          <Option name="active" value="true" type="bool"/>
                          <Option name="expression" value="not array_contains( array('n','s','w','ww'),try(&quot;typPrzewodu&quot;))" type="QString"/>
                          <Option name="type" value="3" type="int"/>
                        </Option>
                        <Option name="outlineColor" type="Map">
                          <Option name="active" value="false" type="bool"/>
  ...
  <labeling type="rule-based">
    <rules key="{0107ae6c-58d2-4b07-b000-db6563a14156}">
      <rule key="{88632300-eac3-47e6-beba-975b92ca24e8}" filter="try(&quot;przebieg&quot;) is not 'n'" description="przewód elektroenergetyczny podziemny">
