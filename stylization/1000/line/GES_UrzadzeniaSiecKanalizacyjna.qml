...
<qgis hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" simplifyLocal="1" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule filter="rodzajUrzadzenia = 'l'" label="odwodnienie liniowe" key="{72f23876-434c-4c64-b35c-93cea5088203}" symbol="0"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="kanalizacyjne urządzenie techniczne" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}" symbol="1"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="line" force_rhr="0" clip_to_extent="1">
        ...
        <layer pass="0" enabled="1" locked="0" class="HashLine">
          <Option type="Map">
            ...
            <Option name="hash_length" type="QString" value="0.75"/>
            ...
            <Option name="interval" type="QString" value="0.525"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="HashLine">
          ...
          <symbol alpha="1" name="@0@1" type="line" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="HashLine">
          ...
          <symbol alpha="1" name="@0@2" type="line" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{7265c391-5fe4-4018-879f-460fff7de8c7}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{a2123a8f-ff51-48a6-992b-ff4941d5b087}" description="kanalizacyjne urządzenie techniczne">
        <settings calloutType="simple">
          ...
          <text-format placeDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" autoWrapLength="0" addDirectionSymbol="0" multilineAlign="0" formatNumbers="0" decimals="3" plussign="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;"/>
          <placement repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" centroidWhole="0" repeatDistance="0" lineAnchorType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" rotationUnit="AngleDegrees" placement="2" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" centroidInside="0" maxCurvedCharAngleIn="25" layerType="LineGeometry" distUnits="MM" geometryGenerator="" overrunDistanceUnit="MM" yOffset="0" polygonPlacementFlags="2" preserveRotation="1" fitInPolygonOnly="0" priority="5" lineAnchorPercent="0.5" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" offsetType="0" overrunDistance="0" xOffset="0" quadOffset="4" offsetUnits="MM"/>
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{cf3ae3be-bb7f-41ab-a2ac-1e963867784f}" description="projektowane">
        <settings calloutType="simple">
  ...
  <DiagramLayerSettings placement="2" zIndex="0" obstacle="0" showAll="1" linePlacementFlags="18" dist="0" priority="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
