...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule filter="rodzajUrzadzenia = 'l'" label="odwodnienie liniowe" symbol="0" key="{72f23876-434c-4c64-b35c-93cea5088203}"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="kanalizacyjne urządzenie techniczne" symbol="1" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="line" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="HashLine" enabled="1">
          ...
          <symbol alpha="1" name="@0@2" type="line" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{7265c391-5fe4-4018-879f-460fff7de8c7}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="kanalizacyjne urządzenie techniczne" key="{a2123a8f-ff51-48a6-992b-ff4941d5b087}">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" description="projektowane" key="{cf3ae3be-bb7f-41ab-a2ac-1e963867784f}">
        <settings calloutType="simple">
