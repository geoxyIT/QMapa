...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule label="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{85a48275-aa05-4a9c-93f7-ddf9203de79a}"/>
      <rule label="odwodnienie liniowe" filter="rodzajUrzadzenia = 'l'" symbol="1" key="{72f23876-434c-4c64-b35c-93cea5088203}"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" force_rhr="0" alpha="1" name="1" clip_to_extent="1">
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          ...
          <symbol type="line" force_rhr="0" alpha="1" name="@1@0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          ...
          <symbol type="line" force_rhr="0" alpha="1" name="@1@1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{af04cc24-549c-4393-983c-f89abc148c50}">
      <rule description="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{7288d499-813d-4143-8900-3233a9a620f3}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{6666f761-9567-4781-a34f-629d64247795}">
        <settings calloutType="simple">
