...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule label="odwodnienie liniowe" symbol="0" filter="rodzajUrzadzenia = 'l'" key="{72f23876-434c-4c64-b35c-93cea5088203}"/>
      <rule label="kanalizacyjne urządzenie techniczne" symbol="1" filter="rodzajUrzadzenia = 'u'" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" name="0" type="line" clip_to_extent="1">
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@0@0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@0@1" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@0@2" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
