...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule label="odwodnienie liniowe" symbol="0" key="{72f23876-434c-4c64-b35c-93cea5088203}" filter="rodzajUrzadzenia = 'l'"/>
      <rule label="kanalizacyjne urządzenie techniczne" symbol="1" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="HashLine">
          <Option type="Map">
            ...
            <Option type="QString" value="0.525" name="interval"/>
  ...
  <labeling type="rule-based">
    <rules key="{7265c391-5fe4-4018-879f-460fff7de8c7}">
      <rule key="{a2123a8f-ff51-48a6-992b-ff4941d5b087}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="kanalizacyjne urządzenie techniczne">
      ...
      <rule key="{cf3ae3be-bb7f-41ab-a2ac-1e963867784f}" filter="try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
