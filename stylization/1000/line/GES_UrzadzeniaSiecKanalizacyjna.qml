...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule filter="rodzajUrzadzenia = 'l'" symbol="0" label="odwodnienie liniowe" key="{72f23876-434c-4c64-b35c-93cea5088203}" />
      <rule filter="rodzajUrzadzenia = 'u'" symbol="1" label="kanalizacyjne urządzenie techniczne" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}" />
    ...
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
        ...
        <layer locked="0" class="HashLine" pass="0" enabled="1">
          ...
          <symbol name="@0@1" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value="" />
                <Option name="properties" />
        ...
        <layer locked="0" class="HashLine" pass="0" enabled="1">
          ...
          <symbol name="@0@2" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value="" />
                <Option name="properties" />
  ...
  <labeling type="rule-based">
    <rules key="{60f921cb-28c5-44d3-b4f5-2ca2517ad7c8}">
      <rule description="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{7923de6f-dacf-428f-87fb-75d8cd3110ae}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{7ecd50ae-2670-475a-8680-4b82e1c960f5}">
        <settings calloutType="simple">
