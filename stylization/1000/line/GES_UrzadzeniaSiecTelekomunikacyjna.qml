...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{8cdde566-27b9-486b-a534-d42334ce59b7}">
      <rule label="telekomunikacyjne urządzenie techniczne" symbol="0" key="{1f6b5bf6-44c2-4409-8529-7fed19503ff8}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b204033a-7d30-4889-9a3b-2534900e8ad0}">
      <rule key="{2528d71d-181d-4515-8d87-94b4d5e4722d}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="telekomunikacyjne urządzenie techniczne">
      ...
      <rule key="{bc9b7f63-4d09-45ea-80e5-8d864a4423a1}" filter="try(&quot;status&quot;) is  'p'" description="projektowane">
        <settings calloutType="simple">
