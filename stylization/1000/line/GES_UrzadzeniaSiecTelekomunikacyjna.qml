...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{14ef3470-81aa-48a9-9ce7-04424a842468}">
      <rule description="telekomunikacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{7b03b317-8ede-4cfd-8ddc-e3c089e63597}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{e00367ad-8b0b-4d57-ab66-95115eadf42d}">
        <settings calloutType="simple">
