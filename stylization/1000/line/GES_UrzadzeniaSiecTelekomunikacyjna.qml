...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{b204033a-7d30-4889-9a3b-2534900e8ad0}">
      <rule description="telekomunikacyjne urządzenie techniczne" key="{2528d71d-181d-4515-8d87-94b4d5e4722d}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{bc9b7f63-4d09-45ea-80e5-8d864a4423a1}" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
