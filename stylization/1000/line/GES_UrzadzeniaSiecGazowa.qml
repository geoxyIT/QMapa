...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{0c6f25d9-20bc-4379-a5d2-73b60d3a0055}">
      <rule description="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" key="{79b3a76d-ca9e-42e1-83f9-648249d3ff54}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{dfe3a22c-2a68-4182-9852-fb7395dc4471}">
        <settings calloutType="simple">
