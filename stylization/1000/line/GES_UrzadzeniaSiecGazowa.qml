...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule filter="rodzajUrzadzenia = 'u'" label="gazowe urządzenie techniczne" symbol="0" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7ba71089-ebb0-4413-9aa1-20fb7aae0aa1}">
      <rule filter="rodzajUrzadzenia = 'u'" description="gazowe urządzenie techniczne" key="{a2707b8e-7247-4e39-8ef8-c1e3d01d4fd0}">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" description="projektowane" key="{f36d00f3-93b4-4f0a-842d-d20150e785b1}">
        <settings calloutType="simple">
