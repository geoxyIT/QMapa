...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{e3fcdfd7-f47b-4bae-adab-d6cafa303663}">
      <rule label="ciepłownicze urządzenie techniczne" symbol="0" key="{c6338a8f-d43e-425c-8224-bc207f129fa9}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7689a618-601a-488c-8cba-9bdc99b207ec}">
      <rule key="{7a2c4023-05c6-4290-85b4-103c667c52ec}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="ciepłownicze urządzenie techniczne">
      ...
      <rule key="{623e5c1b-4e91-4eb3-8962-8e2ce6ab5d42}" filter=" try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
