...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{e3fcdfd7-f47b-4bae-adab-d6cafa303663}">
      <rule filter="rodzajUrzadzenia = 'u'" label="ciepłownicze urządzenie techniczne" symbol="0" key="{c6338a8f-d43e-425c-8224-bc207f129fa9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7689a618-601a-488c-8cba-9bdc99b207ec}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="ciepłownicze urządzenie techniczne" key="{7a2c4023-05c6-4290-85b4-103c667c52ec}">
      ...
      <rule filter=" try(&quot;status&quot;) is 'p'" description="projektowane" key="{623e5c1b-4e91-4eb3-8962-8e2ce6ab5d42}">
        <settings calloutType="simple">
