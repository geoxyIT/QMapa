...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule symbol="0" key="{59c376fa-9e29-4149-9068-3fbc8580017a}" filter="rodzajUrzadzenia = 'l' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 1500) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 1500) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 1500))" label="kanał technologiczny oś"/>
      <rule symbol="1" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}" filter="rodzajUrzadzenia = 'l' and (try(&quot;srednica&quot;) > 1500 or try(&quot;wymiarPoziomy&quot;) > 1500 or try(&quot;wymiarPionowy&quot;) > 1500) " label="kanał technologiczny"/>
      <rule symbol="2" key="{f21e5fd8-576b-4a18-a2bb-653af00a8352}" filter="rodzajUrzadzenia = 'o' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 1500) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 1500) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 1500))" label="obudowa ochronna przewodu oś"/>
      <rule symbol="3" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}" filter="rodzajUrzadzenia = 'o' and (try(&quot;srednica&quot;) > 1500 or try(&quot;wymiarPoziomy&quot;) > 1500 or try(&quot;wymiarPionowy&quot;) > 1500) " label="obudowa ochronna przewodu"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6c041e97-2149-4b2c-9c74-4cf4ce50a37d}">
      ...
      <rule key="{dc7e2456-c4fa-4b89-b312-926df84152ec}" description="projektowane" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'proj.' + regexp_substr(  &quot;rodzajSieci&quot; , '([a-zA-Z,]+)')" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.5625" allowHtml="0" textColor="0,0,0,255">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferSize="1" bufferOpacity="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
            <text-mask maskJoinStyle="128" maskEnabled="0" maskType="0" maskSizeUnits="MM" maskOpacity="1" maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers=""/>
            <background shapeType="0" shapeRotationType="0" shapeDraw="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeRotation="0" shapeSizeX="0" shapeSizeUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeSVGFile="" shapeRadiiX="0" shapeSizeY="0" shapeBorderWidthUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
