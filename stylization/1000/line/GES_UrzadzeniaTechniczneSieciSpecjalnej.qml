...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{8b97a732-835a-4d2f-b9e8-15e477cb5382}">
      <rule symbol="0" key="{95683d64-875f-493b-8b49-bd8c03424abd}" filter="rodzajUrzadzenia = 'u'" label="urządzenie techniczne sieci specjalnej"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3c81e704-76e2-4152-b337-dd5d3d509c12}">
      <rule key="{64a93a5d-49e7-415e-8bab-c566e148366e}" description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{38df1658-8b0c-4dc3-9d87-c743f7781117}" description="projektowane" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
