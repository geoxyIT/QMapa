...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{8b97a732-835a-4d2f-b9e8-15e477cb5382}">
      <rule label="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{95683d64-875f-493b-8b49-bd8c03424abd}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3c81e704-76e2-4152-b337-dd5d3d509c12}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{64a93a5d-49e7-415e-8bab-c566e148366e}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{38df1658-8b0c-4dc3-9d87-c743f7781117}">
        <settings calloutType="simple">
