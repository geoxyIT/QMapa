...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{8b97a732-835a-4d2f-b9e8-15e477cb5382}">
      <rule filter="rodzajUrzadzenia = 'u'" label="urządzenie techniczne sieci specjalnej" symbol="0" key="{95683d64-875f-493b-8b49-bd8c03424abd}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3c81e704-76e2-4152-b337-dd5d3d509c12}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="urządzenie techniczne sieci specjalnej" key="{64a93a5d-49e7-415e-8bab-c566e148366e}">
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" description="projektowane" key="{38df1658-8b0c-4dc3-9d87-c743f7781117}">
        <settings calloutType="simple">
