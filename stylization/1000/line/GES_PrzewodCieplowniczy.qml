...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{a3b21d0b-99c0-4f48-bd8c-6507027d0cca}">
      ...
      <rule filter="try(&quot;srednica&quot;) > 1500" key="{feef48db-430b-454c-9e97-7b7e2cda2ad8}" description="przewód ciepłowniczy">
        <settings calloutType="simple">
          <text-style fontItalic="0" multilineHeight="1" useSubstitutions="0" textOpacity="1" blendMode="0" fieldName="CASE&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'c'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'c'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#xd;&#xa;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#xd;&#xa;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' THEN &#xd;&#xa;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' THEN &#xd;&#xa;'c'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;END&#xd;&#xa;" fontKerning="1" capitalization="0" fontUnderline="0" fontWordSpacing="0" isExpression="1" fontLetterSpacing="0" allowHtml="0" legendString="Aa" fontFamily="Arial" textColor="210,0,210,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" namedStyle="Normal" fontSizeUnit="MapUnit" fontWeight="50" fontSize="1.5625" previewBkgrdColor="255,255,255,255" fontStrikeout="0">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferNoFill="1"/>
