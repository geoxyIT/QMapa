...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule symbol="0" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}" filter="rodzajBudowli = 'n'" label="ściana oporowa"/>
      <rule symbol="1" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}" filter="rodzajBudowli = 'i'" label="inna budowla"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" type="line">
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="hash_angle" value="45" type="QString"/>
            ...
            <Option name="interval" value="8.25" type="QString"/>
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@0@2" force_rhr="0" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@0@3" force_rhr="0" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{4b21cbc0-493f-4936-8dbb-f05c23619cfb}">
      <rule key="{5b636914-872f-4429-8111-c4905269c150}" description="inna budowla" filter="rodzajBudowli = 'i'">
