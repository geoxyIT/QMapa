...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      ...
      <rule filter="rodzajUrzadzenia = 'u'" symbol="1" label="ciepłownicze urządzenie techniczne" key="{71ffe7af-c4ad-44d6-9a4c-1e68859be54b}"/>
  ...
  <labeling type="rule-based">
    <rules key="{31d7c48d-c71c-4881-8282-f0efe5e66dbb}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{d677c1eb-5c45-4b84-91a9-fecb7eb132be}">
      ...
      <rule description="ciepłownicze urządzenie techniczne" filter=" try(&quot;status&quot;) is 'p'" key="{4db6274b-f44c-45d6-9b92-726fdda59956}">
        <settings calloutType="simple">
