...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule label="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{a602ef9e-0c53-4ec5-abfb-f92c872da368}"/>
      <rule label="zasuwa, zawór" filter="rodzajUrzadzenia = 'w'" symbol="1" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6dcc4d64-220c-4118-bae2-14f5e1ad168a}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{0006bc98-8a5f-4850-8b94-a1796b7ff555}">
      ...
      <rule description="ciepłownicze urządzenie techniczne" filter=" try(&quot;status&quot;) is 'p'" key="{ef6ccb4e-efc5-4751-9f82-bfb3a0feaefd}">
        <settings calloutType="simple">
