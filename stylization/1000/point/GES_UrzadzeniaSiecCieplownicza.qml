...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule symbol="0" key="{a602ef9e-0c53-4ec5-abfb-f92c872da368}" filter="rodzajUrzadzenia = 'u'" label="ciepłownicze urządzenie techniczne"/>
      <rule symbol="1" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}" filter="rodzajUrzadzenia = 'w'" label="zasuwa, zawór"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" type="marker">
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="color" value="210,0,210,255" type="QString"/>
            ...
            <Option name="outline_color" value="210,0,210,255" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{6dcc4d64-220c-4118-bae2-14f5e1ad168a}">
      <rule key="{0006bc98-8a5f-4850-8b94-a1796b7ff555}" description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{ef6ccb4e-efc5-4751-9f82-bfb3a0feaefd}" description="ciepłownicze urządzenie techniczne" filter=" try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
