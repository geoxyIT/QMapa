...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule label="zasuwa, zawór" symbol="0" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}" filter="rodzajUrzadzenia = 'w'"/>
      <rule label="ciepłownicze urządzenie techniczne" symbol="1" key="{71ffe7af-c4ad-44d6-9a4c-1e68859be54b}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0f065a61-0d15-47da-b1cb-ece0f06273cb}">
      <rule key="{ac961ef8-8314-4257-b2d2-e9aad87f923c}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="ciepłownicze urządzenie techniczne">
      ...
      <rule key="{ecce4cd1-79b9-4434-939a-d380c603bd44}" filter=" try(&quot;status&quot;) is 'p'" description="ciepłownicze urządzenie techniczne">
        <settings calloutType="simple">
