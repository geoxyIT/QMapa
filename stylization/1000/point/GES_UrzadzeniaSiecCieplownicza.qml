...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule symbol="0" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}" label="zasuwa, zawór" filter="rodzajUrzadzenia = 'w'"/>
      <rule symbol="1" key="{71ffe7af-c4ad-44d6-9a4c-1e68859be54b}" label="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0f065a61-0d15-47da-b1cb-ece0f06273cb}">
      <rule description="ciepłownicze urządzenie techniczne" key="{ac961ef8-8314-4257-b2d2-e9aad87f923c}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="ciepłownicze urządzenie techniczne" key="{ecce4cd1-79b9-4434-939a-d380c603bd44}" filter=" try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
