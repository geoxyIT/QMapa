    ...
    <rules key="{1a52940d-291d-4113-81a0-283b9a6234b6}">
      <rule key="{a19fbbf0-30ed-496f-b4f0-07eaa96d84ef}" filter=" try(&quot;rzedna&quot;) is not null" description="rzedna">
        <settings calloutType="simple">
          <text-style fontWordSpacing="0" blendMode="0" allowHtml="0" fontSizeUnit="MapUnit" useSubstitutions="0" fontLetterSpacing="0" fontWeight="50" fontSize="1.5625" legendString="Aa" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" capitalization="0" textColor="0,0,0,255" textOpacity="1" fontUnderline="0" isExpression="1" previewBkgrdColor="255,255,255,255" namedStyle="Normal" fontStrikeout="0" fontItalic="0" multilineHeight="1" fontFamily="Arial" fieldName="format_number(&quot;rzedna&quot;,2,'en')">
            <families/>
