...
<qgis styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyAlgorithm="0" minScale="100000000" simplifyLocal="1" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="1" simplifyDrawingTol="1" simplifyDrawingHints="0" simplifyMaxScale="1">
  <flags>
      ...
      <symbol name="0" force_rhr="0" alpha="1" type="marker" clip_to_extent="1">
        ...
        <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="200,50,120,255"/>
            ...
            <Option name="outline_width_map_unit_scale" type="QString" value="3x:5000,0,0,0,0,0"/>
            <Option name="outline_width_unit" type="QString" value="MapUnit"/>
            <Option name="scale_method" type="QString" value="diameter"/>
            <Option name="size" type="QString" value="1.6"/>
            <Option name="size_map_unit_scale" type="QString" value="3x:5000,0,0,0,0,0"/>
            <Option name="size_unit" type="QString" value="MapUnit"/>
            <Option name="vertical_anchor_point" type="QString" value="1"/>
          </Option>
          <prop k="angle" v="0"/>
          <prop k="cap_style" v="square"/>
          <prop k="color" v="200,50,120,255"/>
          ...
          <prop k="outline_width_map_unit_scale" v="3x:5000,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="scale_method" v="diameter"/>
          <prop k="size" v="1.6"/>
          <prop k="size_map_unit_scale" v="3x:5000,0,0,0,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style blendMode="0" legendString="Aa" textOpacity="1" capitalization="0" textOrientation="horizontal" fontSize="2.6000000000000001" fontWordSpacing="0" textColor="200,50,120,255" allowHtml="0" fontLetterSpacing="0" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontSizeUnit="MapUnit" namedStyle="Regular" isExpression="1" useSubstitutions="0" fontKerning="1" multilineHeight="1" fontFamily="Liberation Sans" previewBkgrdColor="255,255,255,255" fieldName="'P'" fontItalic="0" fontSizeMapUnitScale="3x:5000,0,0,0,0,0">
        <families/>
        <text-buffer bufferColor="250,250,250,255" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferOpacity="1" bufferJoinStyle="128"/>
        <text-mask maskEnabled="0" maskType="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskSize="0" maskedSymbolLayers="" maskJoinStyle="128"/>
        <background shapeSizeType="0" shapeFillColor="255,255,255,255" shapeSizeX="0" shapeOpacity="1" shapeOffsetUnit="Point" shapeRadiiX="0" shapeRotation="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetY="0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeSizeY="0" shapeBorderWidth="0" shapeType="0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeRadiiUnit="Point" shapeBorderWidthUnit="Point" shapeBlendMode="0" shapeRadiiY="0" shapeOffsetX="0" shapeSizeUnit="Point">
        ...
        <shadow shadowRadiusUnit="MM" shadowRadius="1.5" shadowOffsetGlobal="1" shadowScale="100" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowOffsetAngle="135" shadowUnder="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowDraw="0" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowOpacity="0.69999999999999996"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <text-format leftDirectionSymbol="&lt;" placeDirectionSymbol="0" addDirectionSymbol="0" wrapChar="" reverseDirectionSymbol="0" plussign="0" multilineAlign="3" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" autoWrapLength="0" decimals="3" formatNumbers="0"/>
      <placement layerType="PointGeometry" yOffset="-0.10000000000000001" overrunDistance="0" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" offsetType="1" labelOffsetMapUnitScale="3x:2500,0,0,0,0,0" xOffset="0.10000000000000001" maxCurvedCharAngleIn="25" quadOffset="2" priority="5" repeatDistanceUnits="MM" rotationAngle="0" placement="1" lineAnchorType="0" placementFlags="10" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" fitInPolygonOnly="0" dist="0" polygonPlacementFlags="2" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" preserveRotation="1" maxCurvedCharAngleOut="-25" repeatDistance="0" overrunDistanceUnit="MM" geometryGenerator="" offsetUnits="MapUnit" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering unplacedVisibility="0" limitNumLabels="0" fontMaxPixelSize="10000" fontLimitPixelSize="1" minFeatureSize="0" scaleVisibility="0" drawLabels="1" scaleMin="0" upsidedownLabels="0" scaleMax="0" zIndex="0" obstacle="1" labelPerPart="0" fontMinPixelSize="3" obstacleFactor="1" displayAll="1" maxNumLabels="2000" mergeLines="0" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="rodzajSkarpy" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="8" field="rodzajSkarpy"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="zrodlo" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="rodzajSkarpy" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="rodzajSkarpy" desc="" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="zrodlo" width="-1" hidden="0" type="field"/>
      <column name="rodzajSkarpy" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="geometria" labelOnTop="0"/>
    <field name="gml_id" labelOnTop="0"/>
    <field name="koniecGorySkarpy" labelOnTop="0"/>
    ...
    <field name="rodzajSkarpy" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="geometria" reuseLastValue="0"/>
    <field name="gml_id" reuseLastValue="0"/>
    <field name="koniecGorySkarpy" reuseLastValue="0"/>
    ...
    <field name="rodzajSkarpy" reuseLastValue="0"/>
