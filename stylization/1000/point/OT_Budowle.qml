...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.0-Tisler">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule key="{7916ec8e-c940-4b47-a4fb-f958121005a7}" label="podpora" filter="rodzajBudowli = 'd'" symbol="0"/>
      <rule key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}" label="figura, krzyż" filter="rodzajBudowli = 'f'" symbol="1"/>
  ...
  <labeling type="rule-based">
    <rules key="{7a56072b-dec8-4c46-987b-eec072fd6c43}">
      <rule description="inna budowla" key="{81a94e38-1981-40e2-86c7-da136d157ec7}" filter="rodzajBudowli = 'i'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontKerning="1" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" fontItalic="0" isExpression="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" textColor="0,0,0,255" fontSizeUnit="MapUnit" fontStrikeout="0" fontSize="1.5625" capitalization="0" fieldName="'ib'" fontFamily="Arial" legendString="Aa" fontUnderline="0" textOpacity="1" namedStyle="Normalny">
            <families/>
          ...
          <placement geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" distUnits="MapUnit" lineAnchorPercent="0.5" offsetType="0" xOffset="0" lineAnchorClipping="0" layerType="PointGeometry" centroidWhole="0" yOffset="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" maxCurvedCharAngleIn="25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" preserveRotation="1" repeatDistance="0" lineAnchorType="0" overrunDistanceUnit="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGenerator="" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" quadOffset="1" dist="0.80000000000000004" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="6" offsetUnits="MapUnit" polygonPlacementFlags="2" geometryGeneratorEnabled="0" centroidInside="0"/>
