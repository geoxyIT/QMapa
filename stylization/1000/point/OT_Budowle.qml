...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule symbol="0" key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}" filter="rodzajBudowli = 'f'" label="figura, krzyż"/>
      <rule symbol="1" key="{5bfb9cf4-4a0c-4e1f-8cb1-e7f01fd0d131}" filter="rodzajBudowli = 't'" label="fontanna"/>
      <rule symbol="2" key="{6c1ee31d-38b4-41ca-b6c1-c9553d391d64}" filter="rodzajBudowli = 'p'" label="pomnik"/>
      <rule symbol="3" key="{3b1e6246-3baf-4933-934d-5afd4f49bc21}" filter="rodzajBudowli = 'd'" label="podpora"/>
      <rule symbol="4" key="{6b012d7a-7a87-4d14-9616-4283d0cda50d}" filter="rodzajBudowli = 'i'" label="inna budowla"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" type="marker">
        ...
        <layer pass="0" class="SvgMarker" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset" value="0,-1.05000000000000004" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MapUnit" type="QString"/>
            <Option name="outline_color" value="0,0,0,255" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{79ad1d62-99c0-42e7-a67e-ed6410e742e6}">
      <rule key="{0e3f8327-f51c-44c0-a37e-1dcd343205af}" description="inna budowla" filter="rodzajBudowli = 'i'">
        <settings calloutType="simple">
          ...
          <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" fitInPolygonOnly="0" lineAnchorClipping="0" layerType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" quadOffset="1" geometryGeneratorEnabled="0" placementFlags="10" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" lineAnchorType="0" polygonPlacementFlags="2" xOffset="0" offsetType="1" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistance="0" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" offsetUnits="MapUnit" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" distUnits="MM" placement="1" centroidWhole="0" rotationAngle="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" yOffset="0"/>
