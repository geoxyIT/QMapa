...
<qgis simplifyDrawingHints="1" maxScale="0" minScale="100000000" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingTol="1" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" readOnly="0">
  ...
  <aliases>
    ...
    <alias index="9" field="numerOperatu" name=""/>
  ...
  <defaults>
    ...
    <default field="rodzajNawierzchni" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="rodzajObiektu" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="numerOperatu" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="informacjaDodatkowa" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="rodzajNawierzchni" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="polozenie" unique_strength="0" notnull_strength="0"/>
  </constraints>
