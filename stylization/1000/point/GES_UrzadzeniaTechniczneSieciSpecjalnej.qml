...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule filter="rodzajUrzadzenia = 'u'" label="urządzenie techniczne sieci specjalnej" symbol="0" key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{eae26ec8-dc0b-4a88-91ea-32a5e9086a48}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="urządzenie techniczne sieci specjalnej" key="{914815e1-7966-46d9-8ef6-df1bfe30a935}">
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" description="projektowane" key="{7c1a49e4-4bc4-4bb6-8d93-4e8e6d810b27}">
        <settings calloutType="simple">
