...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{eae26ec8-dc0b-4a88-91ea-32a5e9086a48}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{914815e1-7966-46d9-8ef6-df1bfe30a935}" description="urządzenie techniczne sieci specjalnej">
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" key="{7c1a49e4-4bc4-4bb6-8d93-4e8e6d810b27}" description="projektowane">
        <settings calloutType="simple">
