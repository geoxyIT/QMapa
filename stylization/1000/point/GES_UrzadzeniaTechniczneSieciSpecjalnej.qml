...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.0-Tisler">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}" label="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'" symbol="0"/>
      <rule key="{53bb4d45-0a49-4ca7-9b7e-afc2310e16b6}" label="nieoznaczone" filter="ELSE" symbol="1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a1e6594e-69eb-4266-b9f5-03bc8350248d}">
      <rule description="urządzenie techniczne sieci specjalnej" key="{e9ca05e3-6532-43ba-b9ff-8423c80793a5}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontKerning="1" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" fontItalic="0" isExpression="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" textColor="0,0,0,255" fontSizeUnit="MapUnit" fontStrikeout="0" fontSize="1.5625" capitalization="0" fieldName="'s'" fontFamily="Arial" legendString="Aa" fontUnderline="0" textOpacity="1" namedStyle="Normalny">
            <families/>
      ...
      <rule description="projektowane" key="{a6cad87f-a557-423d-b754-41eaad38084c}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontKerning="1" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" fontItalic="0" isExpression="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" textColor="0,0,0,255" fontSizeUnit="MapUnit" fontStrikeout="0" fontSize="1.5625" capitalization="0" fieldName="'proj.s'" fontFamily="Arial" legendString="Aa" fontUnderline="0" textOpacity="1" namedStyle="Normalny">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSizeUnits="MM"/>
            <text-mask maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskedSymbolLayers="" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM"/>
            <background shapeDraw="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetY="0" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeSVGFile="" shapeOpacity="1" shapeRadiiY="0" shapeSizeUnit="MM" shapeBorderWidth="0" shapeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeRotationType="0" shapeRadiiX="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeBorderColor="128,128,128,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0">
