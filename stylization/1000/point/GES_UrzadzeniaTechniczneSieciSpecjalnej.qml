...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule filter="rodzajUrzadzenia = 'u'" symbol="0" label="urządzenie techniczne sieci specjalnej" key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}"/>
  ...
  <labeling type="rule-based">
    <rules key="{a4b79929-bf0e-4ad0-9e2a-220de6eb33ef}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{974af0ea-ce01-4220-9372-716b9a9916a3}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{3cc872d8-91a3-4952-b204-d9713440ba92}">
        <settings calloutType="simple">
