...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{3753aa50-9260-4666-8ff7-5310fc7e6fe5}">
      <rule symbol="0" key="{098d828c-220e-4c4a-b239-7317da4af22b}" filter="rodzajUrzadzenia = 'u'" label="wodociągowe urządzenie techniczne"/>
      <rule symbol="1" key="{4796541f-238d-4e7a-a20f-ed5dfb7143f6}" filter="rodzajUrzadzenia = 'w'" label="zasuwa, zawór"/>
      <rule symbol="2" key="{d2434400-6f91-4f6a-bc01-bf84e00d9286}" filter="rodzajUrzadzenia = 'h'" label="hydrant"/>
      <rule symbol="3" key="{1c0166fd-72df-470a-b6d3-3990af7ae044}" filter="rodzajUrzadzenia = 'd'" label="zdrój uliczny"/>
      <rule symbol="4" key="{90a5cb4f-89e5-4563-9213-5bcf2c7afb8c}" filter="rodzajUrzadzenia = 's'" label="studnia zwykła"/>
      <rule symbol="5" key="{ea94455b-b081-424b-8972-b539fb10b42f}" filter="rodzajUrzadzenia = 'g'" label="studnia głębinowa"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7ec2a891-3902-4c68-9531-81cde798da2f}">
      <rule key="{32674111-ba44-4602-82dd-55c6f5a44fd2}" description="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{671b3a57-1a98-4950-80e1-00cb052ab489}" description="zasuwa, zawór" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'w'" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.5625" allowHtml="0" textColor="0,0,255,255">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferSize="1" bufferOpacity="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
          ...
          <text-format multilineAlign="3" addDirectionSymbol="0" plussign="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" leftDirectionSymbol="&lt;" wrapChar="" reverseDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" decimals="3"/>
          <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" fitInPolygonOnly="0" lineAnchorClipping="0" layerType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" quadOffset="5" geometryGeneratorEnabled="0" placementFlags="10" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" lineAnchorType="0" polygonPlacementFlags="2" xOffset="0" offsetType="1" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistance="0" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" offsetUnits="MM" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" distUnits="MM" placement="1" centroidWhole="0" rotationAngle="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" yOffset="0"/>
          <rendering obstacleType="1" unplacedVisibility="0" maxNumLabels="2000" fontLimitPixelSize="0" scaleMax="0" labelPerPart="0" upsidedownLabels="0" fontMaxPixelSize="10000" zIndex="0" scaleVisibility="0" minFeatureSize="0" fontMinPixelSize="3" displayAll="1" limitNumLabels="0" obstacleFactor="1" drawLabels="1" obstacle="1" mergeLines="0" scaleMin="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
      ...
      <rule key="{fdf49fa3-6d3e-49da-873e-fecfeb388c2f}" description="projektowane" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
