...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{3753aa50-9260-4666-8ff7-5310fc7e6fe5}">
      <rule label="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{098d828c-220e-4c4a-b239-7317da4af22b}"/>
      <rule label="zasuwa, zawór" filter="rodzajUrzadzenia = 'w'" symbol="1" key="{4796541f-238d-4e7a-a20f-ed5dfb7143f6}"/>
      <rule label="hydrant" filter="rodzajUrzadzenia = 'h'" symbol="2" key="{d2434400-6f91-4f6a-bc01-bf84e00d9286}"/>
      <rule label="zdrój uliczny" filter="rodzajUrzadzenia = 'd'" symbol="3" key="{1c0166fd-72df-470a-b6d3-3990af7ae044}"/>
      <rule label="studnia zwykła" filter="rodzajUrzadzenia = 's'" symbol="4" key="{90a5cb4f-89e5-4563-9213-5bcf2c7afb8c}"/>
      <rule label="studnia głębinowa" filter="rodzajUrzadzenia = 'g'" symbol="5" key="{ea94455b-b081-424b-8972-b539fb10b42f}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7ec2a891-3902-4c68-9531-81cde798da2f}">
      <rule description="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{32674111-ba44-4602-82dd-55c6f5a44fd2}">
        <settings calloutType="simple">
          ...
          <placement lineAnchorType="0" placementFlags="10" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" quadOffset="4" maxCurvedCharAngleIn="25" dist="0" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" rotationAngle="0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="0" centroidWhole="0" rotationUnit="AngleDegrees" priority="5" layerType="PointGeometry" offsetType="1" placement="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" lineAnchorClipping="0" geometryGenerator="" fitInPolygonOnly="0" overrunDistanceUnit="MM" centroidInside="0" offsetUnits="MM" xOffset="0" distUnits="MM" repeatDistance="0"/>
      ...
      <rule description="zasuwa, zawór" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" key="{671b3a57-1a98-4950-80e1-00cb052ab489}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.5625" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="0,0,255,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="'w'" blendMode="0" isExpression="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128"/>
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{fdf49fa3-6d3e-49da-873e-fecfeb388c2f}">
        <settings calloutType="simple">
