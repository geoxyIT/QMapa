...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="geometria" type="field" width="-1" hidden="0"/>
      <column name="rodzajSkarpy" type="field" width="-1" hidden="0"/>
      <column name="poczatekGorySkarpy" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="poczatekGorySkarpy" editable="1"/>
  ...
  <reuseLastValue>
    ...
    <field name="poczatekGorySkarpy" reuseLastValue="0"/>
