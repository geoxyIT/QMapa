...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{f6abeaac-9eba-4979-83d2-2b5ba7c91f4c}">
      <rule filter="rodzajRzednej = 's'" symbol="0" key="{8bd08c2e-5c20-4dd4-84b7-7a4e4d06a39a}" label="pikieta sztuczna"/>
      <rule filter="rodzajRzednej = 'n'" symbol="1" key="{b7987a54-0f7c-4564-9c92-bec99984c950}" label="pikieta naturalna"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5fe059c5-a9c2-4b6e-8a8c-6898bb99fa91}">
      ...
      <rule filter="rodzajRzednej = 'n'" key="{9c3c9d2c-69f9-4d05-94d5-dd13bb0c0324}" description="pikieta naturalna">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="format_number( &quot;rzedna&quot;, 1, 'en')" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.5625" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
  ...
  <fieldConfiguration>
    ...
    <field name="rodzajRzednej" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="9" field="rodzajRzednej"/>
    <alias name="" index="10" field="rzedna"/>
    <alias name="" index="11" field="prezentacja_etykiety"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="rodzajRzednej"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="rodzajRzednej" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="rzedna" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="rodzajRzednej"/>
    <constraint exp="" desc="" field="rzedna"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="rodzajRzednej" reuseLastValue="0"/>
