...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule filter="rodzajUrzadzenia = 's'" label="szafa elektroenergetyczna, kontener" symbol="0" key="{af1e48db-0e02-4bd7-b25c-d22678f1da34}"/>
      <rule filter="rodzajUrzadzenia = 't'" label="stacja transformatorowa" symbol="1" key="{62351a29-f93e-4326-9473-76a0d1ff7aa6}"/>
      <rule filter="rodzajUrzadzenia = 'o' " label="latarnia" symbol="2" key="{fc7a5af3-0f3d-4743-83b9-8d3d9b5aff9d}"/>
      <rule filter="rodzajUrzadzenia = 'm' " label="maszt oświetleniowy" symbol="3" key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}"/>
      <rule filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa" symbol="4" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}"/>
      <rule filter="rodzajUrzadzenia = 'l'" label="stacja ładowania pojazdów elektrycznych" symbol="5" key="{00d25872-3b1e-4dc5-a42c-b816f6245f46}"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="elektroenergetyczne urządzenie techniczne" symbol="6" key="{465a0f40-4b6e-46e7-a76b-431d315b397c}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d3a819a3-23e9-495a-83be-a4b211177f6e}">
      <rule filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" description="elektroenergetyczne urządzenie techniczne" key="{ee0eeefa-fdf8-4d49-a2ae-844788389877}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'e'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="szafa elektroenergetyczna, kontener" key="{d9a24572-d766-45c7-a769-63897b55d15e}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'e'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 't' and try(&quot;status&quot;) is not 'p'" description="stacja transformatorowa" key="{d4904beb-5e6d-4afe-8bbf-df19cc1d76a6}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'Tr'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="0" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" description="projektowane" key="{853803c4-00c3-4cf6-ab30-25379845f0fe}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.5625" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="'e'" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
