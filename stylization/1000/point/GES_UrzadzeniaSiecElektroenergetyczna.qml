...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule symbol="0" key="{af1e48db-0e02-4bd7-b25c-d22678f1da34}" label="szafa elektroenergetyczna, kontener" filter="rodzajUrzadzenia = 's'"/>
      <rule symbol="1" key="{62351a29-f93e-4326-9473-76a0d1ff7aa6}" label="stacja transformatorowa" filter="rodzajUrzadzenia = 't'"/>
      <rule symbol="2" key="{fc7a5af3-0f3d-4743-83b9-8d3d9b5aff9d}" label="latarnia" filter="rodzajUrzadzenia = 'o' "/>
      <rule symbol="3" key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}" label="maszt oświetleniowy" filter="rodzajUrzadzenia = 'm' "/>
      <rule symbol="4" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" label="turbina wiatrowa" filter="rodzajUrzadzenia = 'a'"/>
      <rule symbol="5" key="{00d25872-3b1e-4dc5-a42c-b816f6245f46}" label="stacja ładowania pojazdów elektrycznych" filter="rodzajUrzadzenia = 'l'"/>
      <rule symbol="6" key="{465a0f40-4b6e-46e7-a76b-431d315b397c}" label="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="1" type="marker" alpha="1">
        ...
        <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            ...
            <Option value="diameter" name="scale_method" type="QString"/>
            <Option value="0.375" name="size" type="QString"/>
            <Option value="3x:5000,0,0,0.03,0,0" name="size_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="size_unit" type="QString"/>
            <Option value="1" name="vertical_anchor_point" type="QString"/>
          </Option>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="2" type="marker" alpha="1">
        ...
        <layer locked="0" pass="0" class="GeometryGenerator" enabled="1">
          <Option type="Map">
            ...
            <Option value="centroid($geometry)" name="geometryModifier" type="QString"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="4" type="marker" alpha="1">
        ...
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option value="0.14999999999999999,-1.84000000000000008" name="offset" type="QString"/>
            <Option value="3x:5000,0,0,0.03,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_unit" type="QString"/>
            <Option value="0,0,0,255" name="outline_color" type="QString"/>
            <Option value="0" name="outline_width" type="QString"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="5" type="marker" alpha="1">
        ...
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="parameters"/>
            <Option value="diameter" name="scale_method" type="QString"/>
            <Option value="2.055" name="size" type="QString"/>
            <Option value="3x:5000,0,0,0.03,0,0" name="size_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="size_unit" type="QString"/>
            <Option value="1" name="vertical_anchor_point" type="QString"/>
          </Option>
  ...
  <labeling type="rule-based">
    <rules key="{d3a819a3-23e9-495a-83be-a4b211177f6e}">
      <rule description="elektroenergetyczne urządzenie techniczne" key="{ee0eeefa-fdf8-4d49-a2ae-844788389877}" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'e'" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.5625" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
      ...
      <rule description="szafa elektroenergetyczna, kontener" key="{d9a24572-d766-45c7-a769-63897b55d15e}" filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'e'" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.5625" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128"/>
      ...
      <rule description="stacja transformatorowa" key="{d4904beb-5e6d-4afe-8bbf-df19cc1d76a6}" filter="rodzajUrzadzenia = 't' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'Tr'" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.5625" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128"/>
            <text-mask maskType="0" maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskSize="1.5" maskedSymbolLayers=""/>
            <background shapeOffsetUnit="MM" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeSizeType="0" shapeSVGFile="" shapeSizeY="0" shapeSizeX="0" shapeType="0" shapeBlendMode="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeJoinStyle="64" shapeRadiiX="0" shapeOffsetY="0" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBorderColor="128,128,128,255">
      ...
      <rule description="projektowane" key="{853803c4-00c3-4cf6-ab30-25379845f0fe}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'e'" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.5625" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128"/>
