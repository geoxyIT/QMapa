...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{9f530e0e-244c-48ba-822a-3168ce469f49}">
      ...
      <rule filter="rodzajUrzadzenia = 'w'" symbol="1" label="właz do komory, kanału" key="{ae106302-3fe3-4e5e-82d4-4ff77b799b51}"/>
      <rule filter="rodzajUrzadzenia = 'p' " symbol="2" label="słup przewodów napowietrznych" key="{91d61cb7-2c1b-450b-86d8-3695b5ab82b5}"/>
      <rule filter="rodzajUrzadzenia = 'y'" symbol="3" label="słup trakcyjny" key="{b495f3e0-92a8-4c3e-be8e-89761da99f47}"/>
      <rule filter="rodzajUrzadzenia = 'n'" symbol="4" label="podpora przewodów" key="{245ad9eb-2c66-44bf-9695-2f89f03e6091}"/>
  ...
  <labeling type="rule-based">
    <rules key="{ebb84086-cfda-457f-b2cb-e82602524830}">
      <rule description="właz do komory, kanału" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" key="{7eb821a0-8dab-406c-ae90-d6e2a19655c5}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{2e4e0e82-854e-4063-abde-66fc52c345e8}">
        <settings calloutType="simple">
