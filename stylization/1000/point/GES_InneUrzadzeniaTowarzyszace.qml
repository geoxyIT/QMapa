...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.0-Tisler">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9f530e0e-244c-48ba-822a-3168ce469f49}">
      <rule key="{c28c6b4f-7d62-48b8-8613-7b7120a5882d}" label="komora podziemna" filter="rodzajUrzadzenia = 'k'" symbol="0"/>
      <rule key="{ae106302-3fe3-4e5e-82d4-4ff77b799b51}" label="właz do komory, kanału" filter="rodzajUrzadzenia = 'w'" symbol="1"/>
      <rule key="{91d61cb7-2c1b-450b-86d8-3695b5ab82b5}" label="słup przewodów napowietrznych" filter="rodzajUrzadzenia = 'p' " symbol="2"/>
      <rule key="{b495f3e0-92a8-4c3e-be8e-89761da99f47}" label="słup trakcyjny" filter="rodzajUrzadzenia = 'y'" symbol="3"/>
      <rule key="{245ad9eb-2c66-44bf-9695-2f89f03e6091}" label="podpora przewodów" filter="rodzajUrzadzenia = 'n'" symbol="4"/>
      <rule key="{53bb4d45-0a49-4ca7-9b7e-afc2310e16b6}" label="nieoznaczone" filter="ELSE" symbol="5"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" alpha="1" name="2" type="marker">
        ...
        <layer enabled="1" locked="0" class="GeometryGenerator" pass="0">
          ...
          <symbol force_rhr="0" clip_to_extent="1" alpha="1" name="@2@0" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{c455e6b4-9244-40d4-bab6-50f0456807a6}">
      <rule description="właz do komory, kanału" key="{301afef5-f933-44db-a992-f116c2ce4fca}" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontKerning="1" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" fontItalic="0" isExpression="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" textColor="0,0,0,255" fontSizeUnit="MapUnit" fontStrikeout="0" fontSize="1.5625" capitalization="0" fieldName="regexp_substr(  &quot;rodzajSieci&quot; , '([a-zA-Z,]+)')&#xa;" fontFamily="Arial" legendString="Aa" fontUnderline="0" textOpacity="1" namedStyle="Normalny">
            <families/>
      ...
      <rule description="projektowane" key="{26c77359-b5d8-4ae1-b358-76456665b579}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontKerning="1" fontSizeMapUnitScale="3x:5000,0,0,0,0,0" fontItalic="0" isExpression="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" textColor="0,0,0,255" fontSizeUnit="MapUnit" fontStrikeout="0" fontSize="1.5625" capitalization="0" fieldName="'proj.' + regexp_substr(  &quot;rodzajSieci&quot; , '([a-zA-Z,]+)')&#xa;" fontFamily="Arial" legendString="Aa" fontUnderline="0" textOpacity="1" namedStyle="Normalny">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSizeUnits="MM"/>
            <text-mask maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskedSymbolLayers="" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM"/>
            <background shapeDraw="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetY="0" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeSVGFile="" shapeOpacity="1" shapeRadiiY="0" shapeSizeUnit="MM" shapeBorderWidth="0" shapeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeRotationType="0" shapeRadiiX="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeBorderColor="128,128,128,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0">
