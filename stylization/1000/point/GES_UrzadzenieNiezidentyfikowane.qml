...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{97cd2648-c58d-43a1-ae17-591a87c8bdb7}">
      <rule filter="try(&quot;status&quot;) is not 'p'" description="urządzenie techniczne sieci niezidentyfikowanej" key="{5f4c55de-fe3c-4456-ad68-eda6da9b1fa1}">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" description="urządzenie techniczne sieci niezidentyfikowanej" key="{a038bcc8-1955-47be-8787-d9032d920cb7}">
        <settings calloutType="simple">
