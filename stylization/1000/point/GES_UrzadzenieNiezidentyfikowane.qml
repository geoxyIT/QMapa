...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{468eda00-1ab1-465c-bd9e-8f303ab5a319}">
      <rule symbol="0" label="urządzenie techniczne sieci niezidentyfikowanej" key="{0d36d4a5-8984-4e48-8905-c9a1aa3c5f97}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{20eaa13a-d8af-44b8-a50c-0689f9434026}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'" key="{2cf66b6f-3d78-4ab9-b3a1-946dc56f904d}">
      ...
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is 'p'" key="{1c1f9c0e-f9f6-4171-9c0e-410edfb23f78}">
        <settings calloutType="simple">
