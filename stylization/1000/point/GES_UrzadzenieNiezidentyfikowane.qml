...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{139b44ee-cc2d-43e6-97cf-cfd783fc92d8}">
      <rule label="urządzenie techniczne sieci niezidentyfikowanej" symbol="0" key="{ea6e0a39-c5e3-4861-af0a-fb05bf8a014d}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{97cd2648-c58d-43a1-ae17-591a87c8bdb7}">
      <rule filter="try(&quot;status&quot;) is not 'p'" key="{5f4c55de-fe3c-4456-ad68-eda6da9b1fa1}" description="urządzenie techniczne sieci niezidentyfikowanej">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{a038bcc8-1955-47be-8787-d9032d920cb7}" description="urządzenie techniczne sieci niezidentyfikowanej">
        <settings calloutType="simple">
