...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <labeling type="rule-based">
    <rules key="{97cd2648-c58d-43a1-ae17-591a87c8bdb7}">
      <rule key="{5f4c55de-fe3c-4456-ad68-eda6da9b1fa1}" filter="try(&quot;status&quot;) is not 'p'" description="urządzenie techniczne sieci niezidentyfikowanej">
      ...
      <rule key="{a038bcc8-1955-47be-8787-d9032d920cb7}" filter="try(&quot;status&quot;) is 'p'" description="urządzenie techniczne sieci niezidentyfikowanej">
        <settings calloutType="simple">
