...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <constraints>
    <constraint notnull_strength="0" unique_strength="0" field="x" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="y" constraints="0" exp_strength="0"/>
  </constraints>
  ...
  <expressionfields>
    <field precision="0" subType="0" length="0" typeName="" comment="" name="x" expression="$x" type="6"/>
    <field precision="0" subType="0" length="0" typeName="" comment="" name="y" expression="$y" type="6"/>
  </expressionfields>
  <attributeactions>
