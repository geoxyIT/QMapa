...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{32e41337-b1bb-4333-ace0-d104f58406a7}">
      ...
      <rule symbol="5" key="{e1c11261-b38c-42ac-a53a-86877ae6e265}" filter="try(&quot;przebieg&quot;) = 'n' and not array_contains( array('n','s','w','ww'),try(&quot;typPrzewodu&quot;))" label="przewód elektroenergetyczny brak napiecia"/>
      <rule symbol="6" key="{8628d324-06d1-40b4-9af9-a550a7c45a57}" filter="ELSE" label="inny nie spełniający reguły"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="5" force_rhr="0" type="line">
        ...
        <layer pass="0" class="GeometryGenerator" enabled="1" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@5@2" force_rhr="0" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer pass="0" class="MarkerLine" enabled="1" locked="0">
              ...
              <symbol alpha="1" clip_to_extent="1" name="@@5@2@0" force_rhr="0" type="marker">
                <data_defined_properties>
                  <Option type="Map">
                    <Option name="name" value="" type="QString"/>
                    <Option name="properties"/>
        ...
        <layer pass="0" class="GeometryGenerator" enabled="1" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@5@3" force_rhr="0" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer pass="0" class="MarkerLine" enabled="1" locked="0">
              ...
              <symbol alpha="1" clip_to_extent="1" name="@@5@3@0" force_rhr="0" type="marker">
                <data_defined_properties>
                  <Option type="Map">
                    <Option name="name" value="" type="QString"/>
                    <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{1d7edf2e-eecf-4de9-9409-56c438fa0e87}">
      <rule key="{9b0f2d57-981c-460f-99f7-1315e8787acc}" description="przewód elektroenergetyczny podziemny" filter="try(&quot;przebieg&quot;) is not 'n'">
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;przebieg&quot;" actionWidgetStyle="dropDown">
    <columns>
