...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{b2cb92e9-0e9c-4528-a9fd-a7fcf71080c7}">
      <rule key="{b60de903-7d3e-48bf-88f9-be0354ddbb79}" description="właz do komory, kanału " filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{5b5dacfe-015c-49ec-a4a3-8e5a8f284e41}" description="budowla podziemna" filter="rodzajUrzadzenia = 'b' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
      ...
      <rule key="{e1db2eca-cc9f-4cfb-aeae-60472acd05c8}" description="projektowane" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
