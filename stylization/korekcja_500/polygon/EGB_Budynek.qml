...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{d38214cf-5767-432a-a153-5bfc1c76977e}">
      ...
      <rule key="{0d76230d-a114-40d7-b681-2f14323d72e7}" filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )">
        <settings calloutType="simple">
      ...
      <rule key="{01fc723e-457e-49ac-9d53-e1799edf4e78}" filter="try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 ">
        <settings calloutType="simple">
