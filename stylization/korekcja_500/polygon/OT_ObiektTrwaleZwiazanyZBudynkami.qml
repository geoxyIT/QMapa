...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule symbol="0" key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}" filter="rodzajObiektu = 't'" label="taras"/>
      <rule symbol="1" key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}" filter="rodzajObiektu = 'w'" label="weranda, ganek"/>
      <rule symbol="2" key="{805755b1-0b08-48ed-8f89-32e251e5e287}" filter="rodzajObiektu = 'i'" label="wiatrołap"/>
      <rule symbol="3" key="{246317b8-0501-45cd-a47d-dcee7ba7d02a}" filter="rodzajObiektu = 's' " label="schody"/>
      <rule symbol="4" key="{9315336e-9352-4f65-a647-a6a44f8b06a3}" filter="rodzajObiektu = 'o'" label="podpora związana z budynkiem"/>
      <rule symbol="5" key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}" filter="rodzajObiektu = 'r'" label="rampa"/>
      <rule symbol="6" key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}" filter="rodzajObiektu = 'j'" label="wjazd do podziemia"/>
      <rule symbol="7" key="{e40132d5-9fba-4968-97b2-e54f213209d9}" filter="rodzajObiektu = 'd'" label="podjazd dla osób niepełnosprawnych"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{70ffda0e-bdcd-4cd2-8786-d0ed5bad7395}">
      <rule key="{dc5864a7-c9c2-4aab-8e89-311dedc47662}" description="rampa" filter="rodzajObiektu = 'r'">
      ...
      <rule key="{af43e013-760c-4d9e-984c-34a78244fb5a}" description="podjazd dla osób niepełnosprawnych" filter="rodzajObiektu = 'd'">
        <settings calloutType="simple">
