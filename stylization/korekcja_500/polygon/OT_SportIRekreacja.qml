...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{37df8551-b8b2-485a-a44a-786c3919eb83}">
      <rule symbol="0" key="{a0262446-7acd-4906-8231-6375189a82bc}" filter="rodzajObiektu = 'b'" label="basen odkryty"/>
      <rule symbol="1" key="{ba9e2354-c4d4-4bad-8e92-4766f73fedad}" filter="rodzajObiektu = 'p'" label="plac sportowy"/>
      <rule symbol="2" key="{dddcced0-87af-4c26-9292-121c27ff3232}" filter="rodzajObiektu = 'z'" label="plac gier i zabaw"/>
      <rule symbol="3" key="{d8c5984a-fdc5-4b77-9f0a-ff5202dff23d}" filter="rodzajObiektu = 'i'" label="inny obiekt sportowy"/>
    </rules>
    <symbols>
          ...
          <symbol alpha="1" clip_to_extent="1" name="@1@1" force_rhr="0" type="marker">
            ...
            <layer pass="0" class="SvgMarker" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="size" value="5.39397" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{3bb51b99-f200-4878-9067-c53ea77d6a8e}">
      <rule key="{2d3e146e-13a8-45fa-9835-331ffb486183}" description="basen odkryty" filter="rodzajObiektu = 'b'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'bas.'" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.0417000000000001" allowHtml="0" textColor="0,0,0,255">
            <families/>
