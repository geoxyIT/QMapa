...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{a6d037a2-21fd-429c-9903-d64fc0ecf799}">
      <rule key="{7a4fade3-4905-4150-a99f-5b7a42476b71}" description="przewód telekomunikacyjny podziemny" filter="try(&quot;przebieg&quot;) = 'p' or try(&quot;przebieg&quot;) = 'z'">
      ...
      <rule key="{52592c63-bd1b-406b-bc5b-339c34759008}" description="przewód telekomunikacyjny napowietrzny" filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; ">
        <settings calloutType="simple">
