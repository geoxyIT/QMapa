...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule symbol="0" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" type="marker">
        ...
        <layer pass="0" class="SvgMarker" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset" value="0.80000000000000004,-9.19999999999999929" type="QString"/>
            ...
            <Option name="size" value="11.25" type="QString"/>
          ...
          <prop v="0.80000000000000004,-9.19999999999999929" k="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{48c92c90-728f-435a-999a-a693be94d547}">
      <rule key="{80b89119-f3ee-461a-b894-8e0f3c2e508e}" description="turbina wiatrowa" filter="rodzajUrzadzenia = 'a' and try(&quot;status&quot;) is 'p' ">
