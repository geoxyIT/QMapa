...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{819f80ed-f2f4-4dd7-b0ce-74d7ebebd95f}">
      <rule key="{e989fa87-701a-4390-a204-064486750684}" description="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="0" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.041666" allowHtml="0" textColor="128,51,0,255">
            <families/>
      ...
      <rule key="{34dafb13-b4e4-4826-8ee6-5554171f91e9}" description="zasuwa, zawór " filter="rodzajUrzadzenia = 'w'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="0" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.041666" allowHtml="0" textColor="128,51,0,255">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferSize="1" bufferOpacity="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
      ...
      <rule key="{c2e68a2a-fdde-4c9d-b608-89305ab9677d}" description="studnia kanalizacyjna" filter="rodzajUrzadzenia = 's'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'k' &#xa;END&#xa;" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="0" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.041666" allowHtml="0" textColor="128,51,0,255">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferSize="1" bufferOpacity="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
      ...
      <rule key="{7d619956-f145-46b2-8e20-463bca3cf734}" description="osadnik, szambo" filter="rodzajUrzadzenia = 'm'">
        <settings calloutType="simple">
