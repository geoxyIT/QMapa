...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule symbol="1" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" filter="rodzajObiektu = 'm'" label="most"/>
      <rule symbol="2" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" filter="rodzajObiektu = 'w'" label="wiadukt"/>
      <rule symbol="3" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" filter="rodzajObiektu = 'e'" label="estakada"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{1a4ea76b-d45b-418e-bc4d-2e2d5504448e}">
      <rule key="{c84b570c-7483-4907-9132-8c3d1cd4052d}" description="jezdnia" filter="rodzajObiektu = 'j'">
