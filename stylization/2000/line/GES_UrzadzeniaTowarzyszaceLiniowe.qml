...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule label="kanał technologiczny oś" filter="rodzajUrzadzenia = 'l' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 3000) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 3000) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 3000))" symbol="0" key="{59c376fa-9e29-4149-9068-3fbc8580017a}"/>
      <rule label="kanał technologiczny" filter="rodzajUrzadzenia = 'l' and (try(&quot;srednica&quot;) > 3000 or try(&quot;wymiarPoziomy&quot;) > 3000 or try(&quot;wymiarPionowy&quot;) > 3000) " symbol="1" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{624ff85a-cfc9-4103-8969-881eef12c018}">
      <rule description="kanał technologiczny" filter=" &quot;rodzajUrzadzenia&quot; ='l'" key="{0b01af03-e793-4565-928f-708012305a9d}">
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="srednica" hidden="0" width="-1"/>
