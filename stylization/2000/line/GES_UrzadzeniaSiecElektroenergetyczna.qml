...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="0"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="nullSymbol" referencescale="-1" />
  <labeling type="rule-based">
    <rules key="{3afba098-a1d4-44fc-b578-b9a74af80964}">
      <rule description="elektroenergetyczne urządzenie techniczne" key="{6aadf581-ac5e-423b-850e-0bcd8594d043}" filter="rodzajUrzadzenia = 'u'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'e' ELSE 'e' END&#10;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.0417000000000001" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
