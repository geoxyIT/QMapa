...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" readOnly="0">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  ...
                  <Option name="expression" type="QString" value="try(&quot;status&quot;) is not 'p' and (try(&quot;srednica&quot;) > 3000 or try(&quot;wymiarPoziomy&quot;) > 3000 or try(&quot;wymiarPionowy&quot;) > 3000 ) is not 1&#xa;"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="try(&quot;status&quot;) = 'p' and (try(&quot;srednica&quot;) > 3000 or try(&quot;wymiarPoziomy&quot;) > 3000 or try(&quot;wymiarPionowy&quot;) > 3000 ) is not 1"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="offset" type="Map">
                  <Option name="active" type="bool" value="false"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="try(&quot;status&quot;) = 'p' and (try(&quot;srednica&quot;) > 3000 or try(&quot;wymiarPoziomy&quot;) > 3000 or try(&quot;wymiarPionowy&quot;) > 3000 ) is 1"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="offset" type="Map">
                  <Option name="active" type="bool" value="true"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="offset" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="CASE&#xd;&#xa;WHEN&#xd;&#xa;try(&quot;srednica&quot;) is not NULL and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;srednica&quot;>&quot;wymiarPionowy&quot;)) and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;srednica&quot;>&quot;wymiarPoziomy&quot;))&#xd;&#xa;THEN try(&quot;srednica&quot;)/1000*-1&#xd;&#xa;WHEN try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPionowy&quot;>=&quot;wymiarPoziomy&quot;) THEN&#xd;&#xa;try(&quot;wymiarPionowy&quot;)/1000*-1&#xd;&#xa;WHEN (try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;>&quot;wymiarPionowy&quot;)) THEN&#xd;&#xa;try(&quot;wymiarPoziomy&quot;)/1000*-1&#xd;&#xa;WHEN&#xd;&#xa;try(&quot;srednica&quot;) is not NULL and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;>&quot;srednica&quot;)) and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPionowy&quot;>&quot;wymiarPoziomy&quot;))&#xd;&#xa;THEN try(&quot;wymiarPionowy&quot;)/1000*-1&#xd;&#xa;WHEN&#xd;&#xa;try(&quot;srednica&quot;) is not NULL and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;>&quot;wymiarPionowy&quot;)) and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;)>try(&quot;srednica&quot;))&#xd;&#xa;THEN try(&quot;wymiarPionowy&quot;)/1000*-1&#xd;&#xa;WHEN try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is not NULL THEN&#xd;&#xa;try(&quot;wymiarPionowy&quot;)/1000*-1&#xd;&#xa;WHEN try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is not NULL THEN&#xd;&#xa;try(&quot;wymiarPoziomy&quot;)/1000*-1&#xd;&#xa;END"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="outlineColor" type="Map">
                  <Option name="active" type="bool" value="false"/>
  ...
  <labeling type="rule-based">
    <rules key="{75505d4a-8518-49a8-948c-5146d9d8afaa}">
      ...
      <rule filter="try(&quot;srednica&quot;) > 3000 or try(&quot;wymiarPoziomy&quot;) > 3000 or try(&quot;wymiarPionowy&quot;) > 3000 " key="{10b90bc5-06e6-40ca-9986-0c8dc5fa1e53}" description="przewód kanalizacyjny oś">
        <settings calloutType="simple">
          <text-style fontItalic="0" multilineHeight="1" useSubstitutions="0" textOpacity="1" blendMode="0" fieldName="CASE&#xa;WHEN &quot;status&quot; = 'p' THEN&#xa;'proj.'+'k'&#xd;&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) = 'n' and try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is NULL) &#xd;&#xa;THEN 'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+'-niecz.'&#xd;&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) = 'n' and try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is NULL) &#xd;&#xa;THEN 'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+'-niecz.'&#xd;&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is NULL) &#xd;&#xa;THEN 'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))&#xd;&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;srednica&quot;) is NULL and try(&quot;wymiarPoziomy&quot;) is NULL and try(&quot;wymiarPionowy&quot;) is NULL) &#xd;&#xa;THEN 'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) is 'n' and try(&quot;srednica&quot;) is not NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) = 'n' and try(&quot;srednica&quot;) is not NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;srednica&quot;) is not NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;srednica&quot;) is not NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) = 'n' and try(&quot;srednica&quot;) is NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+if(try(to_string(&quot;wymiarPionowy&quot;)) is null, '', try(to_string(&quot;wymiarPionowy&quot;)))+'/'+if(try(to_string(&quot;wymiarPoziomy&quot;)) is null, '', try(to_string(&quot;wymiarPoziomy&quot;)))+'-niecz.'&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) = 'n' and try(&quot;srednica&quot;) is NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+if(try(to_string(&quot;wymiarPionowy&quot;)) is null, '', try(to_string(&quot;wymiarPionowy&quot;)))+'/'+if(try(to_string(&quot;wymiarPoziomy&quot;)) is null, '', try(to_string(&quot;wymiarPoziomy&quot;)))+'-niecz.'&#xa;WHEN (&quot;zrodlo&quot; != 'O' and try(&quot;srednica&quot;) is NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+if(try(to_string(&quot;wymiarPionowy&quot;)) is null, '', try(to_string(&quot;wymiarPionowy&quot;)))+'/'+if(try(to_string(&quot;wymiarPoziomy&quot;)) is null, '', try(to_string(&quot;wymiarPoziomy&quot;)))&#xa;WHEN (&quot;zrodlo&quot; = 'O' and try(&quot;srednica&quot;) is NULL) THEN &#xa;'k'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+if(try(to_string(&quot;wymiarPionowy&quot;)) is null, '', try(to_string(&quot;wymiarPionowy&quot;)))+'/'+if(try(to_string(&quot;wymiarPoziomy&quot;)) is null, '', try(to_string(&quot;wymiarPoziomy&quot;)))&#xa;END" fontKerning="1" capitalization="0" fontUnderline="0" fontWordSpacing="0" isExpression="1" fontLetterSpacing="0" allowHtml="0" legendString="Aa" fontFamily="Arial" textColor="128,51,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" namedStyle="Normal" fontSizeUnit="MapUnit" fontWeight="50" fontSize="3.125" previewBkgrdColor="255,255,255,255" fontStrikeout="0">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferNoFill="1"/>
  ...
  <fieldConfiguration>
    ...
    <field name="wymiarPionowy" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="12" field="przebieg"/>
    <alias name="" index="13" field="typPrzewodu"/>
    <alias name="" index="14" field="rodzaj"/>
    <alias name="" index="15" field="srednica"/>
    <alias name="" index="16" field="wladajacy"/>
    <alias name="" index="17" field="informacjaDodatkowa"/>
    <alias name="" index="18" field="wymiarPionowy"/>
    <alias name="" index="19" field="idBranzowy"/>
    <alias name="" index="20" field="wymiarPoziomy"/>
    <alias name="" index="21" field="koniecWersjaObiekt"/>
    <alias name="" index="22" field="koniecObiekt"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="wymiarPionowy" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="rodzaj" unique_strength="0"/>
    ...
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="wymiarPionowy" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="idBranzowy" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="wymiarPionowy" exp=""/>
    <constraint desc="" field="idBranzowy" exp=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="rodzaj" type="field" hidden="0" width="-1"/>
      ...
      <column name="wymiarPionowy" type="field" hidden="0" width="-1"/>
      <column name="idBranzowy" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="wymiarPionowy" labelOnTop="0"/>
