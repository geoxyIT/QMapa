...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{47dbc455-8bc1-4031-a897-63f58905ec4b}">
      <rule description="przewód specjalny" filter="ELSE" key="{d9e769ce-8f9e-4f1f-b4e2-e158891ba360}">
      ...
      <rule description="przewód specjalny" filter="try(&quot;srednica&quot;) > 1500" key="{fdffd374-8f7c-422d-a010-9a41434f1f02}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.0417000000000001" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="0,0,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="CASE&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'s'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'s'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) = 'n' THEN &#xd;&#xa;'s'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) = 'n' THEN &#xd;&#xa;'s'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' THEN &#xd;&#xa;'s'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' THEN &#xd;&#xa;'s'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;END&#xd;&#xa;" blendMode="0" isExpression="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128"/>
