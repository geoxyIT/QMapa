...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{bb713a4a-de07-42ab-af3a-db3c75e01785}">
      <rule label="podziemny / naziemny" symbol="0" filter="ELSE" key="{e326e669-f506-4cd1-96d3-34443dc59fda}"/>
      <rule label="napowietrzny" symbol="1" filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; " key="{30a16acd-5998-4a3a-b025-814702434acb}"/>
    </rules>
    <symbols>
          ...
          <symbol force_rhr="0" alpha="1" name="@1@2" type="line" clip_to_extent="1">
            ...
            <layer class="MarkerLine" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option name="offset" type="QString" value="0"/>
                <Option name="offset_along_line" type="QString" value="22.5"/>
  ...
  <labeling type="rule-based">
    <rules key="{3669703c-3ef3-44fc-a560-e3dd8b5c5cae}">
      <rule filter="try(&quot;przebieg&quot;) is not 'n'" key="{a520cc86-a6de-4e24-932b-deaa868e99db}" description="przewód telekomunikacyjny podziemny">
