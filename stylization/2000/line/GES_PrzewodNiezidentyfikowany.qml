...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{6978bc8b-82f0-4674-9c4b-b5f24e0bec9e}">
      ...
      <rule filter="try(&quot;srednica&quot;) > 1500" description="przewód niezidentyfikowany" key="{cd0f0074-87b2-4ec7-b4ce-dd081849dd2f}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="CASE&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'x'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and &quot;status&quot; = 'p' THEN &#xd;&#xa;'proj.'+'x'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#xd;&#xa;'x'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' and try(&quot;eksploatacja&quot;) is 'n' THEN &#xd;&#xa;'x'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;))) + '-niecz.'&#xd;&#xa;WHEN &quot;zrodlo&quot; != 'O' THEN &#xd;&#xa;'x'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+&quot;zrodlo&quot;+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;WHEN &quot;zrodlo&quot; = 'O' THEN &#xd;&#xa;'x'+if(try(&quot;typPrzewodu&quot;) is null, '', try(&quot;typPrzewodu&quot;))+ if(try(to_string(&quot;srednica&quot;)) is null, '', try(to_string(&quot;srednica&quot;)))&#xd;&#xa;END&#xd;&#xa;" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="0,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
