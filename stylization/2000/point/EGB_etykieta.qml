...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="0" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{95d4814c-afea-469e-a453-a4a60b5df113}">
      <rule filter=" try(  &quot;EGB_DzialkaEwidencyjna_2_lokalnyId&quot;  ) is not null" label="EGB_DzialkaEwidencyjna" description="EGB_DzialkaEwidencyjna" symbol="0" key="{4a396385-b66f-4755-8121-ace382de8ca3}"/>
      <rule filter=" try(  &quot;EGB_KonturUzytkuGruntowego_2_lokalnyId&quot;  ) is not null" label="EGB_KonturUzytkuGruntowego" description="EGB_KonturUzytkuGruntowego" symbol="1" key="{49333d28-de8c-488b-8186-5bea374b0430}"/>
      <rule filter=" try(  &quot;EGB_KonturKlasyfikacyjny_2_lokalnyId&quot;  ) is not null" label="EGB_KonturKlasyfikacyjny" description="EGB_KonturKlasyfikacyjny" symbol="2" key="{fe9580f9-6cc4-48e7-a6ac-9d07c78fec27}"/>
      <rule filter=" try(  &quot;EGB_ObrebEwidencyjny_2_lokalnyId&quot;  ) is not null" label="EGB_ObrebEwidencyjny" description="EGB_ObrebEwidencyjny" symbol="3" key="{587f83a9-f79a-4670-979d-73cb0b79e3bd}"/>
      <rule filter=" try(  &quot;EGB_JednostkaEwidencyjna_2_lokalnyId&quot;  ) is not null" label="EGB_JednostkaEwidencyjna" description="EGB_JednostkaEwidencyjna" symbol="4" key="{8448adf7-b0c5-4e01-a47e-14d0c4d8aa17}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{fd401cb4-111c-412d-8258-54cee97f9436}">
      ...
      <rule filter=" try(  &quot;EGB_DzialkaEwidencyjna_2_lokalnyId&quot;  ) is not null" description="EGB_DzialkaEwidencyjna_2" key="{e6e82b68-7a2f-41a0-8536-205c8165e681}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="4.1660000000000004" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="string_to_array( &quot;EGB_DzialkaEwidencyjna_2_idDzialki&quot;,'.')[-1]" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="0,0,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
            <text-buffer bufferDraw="0" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1"/>
            <text-mask maskType="0" maskJoinStyle="128" maskSize="1.5" maskSizeUnits="MM" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="2.6800000000000002" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeDraw="1" shapeRadiiY="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MapUnit" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetUnit="MapUnit" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeJoinStyle="64" shapeOpacity="1" shapeSVGFile="">
              <symbol alpha="1" name="markerSymbol" type="marker" clip_to_extent="1" force_rhr="0">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
