...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{95d4814c-afea-469e-a453-a4a60b5df113}">
      <rule label="EGB_DzialkaEwidencyjna" symbol="0" key="{4a396385-b66f-4755-8121-ace382de8ca3}" filter=" try(  &quot;EGB_DzialkaEwidencyjna_2_lokalnyId&quot;  ) is not null" description="EGB_DzialkaEwidencyjna"/>
      <rule label="EGB_KonturUzytkuGruntowego" symbol="1" key="{49333d28-de8c-488b-8186-5bea374b0430}" filter=" try(  &quot;EGB_KonturUzytkuGruntowego_2_lokalnyId&quot;  ) is not null" description="EGB_KonturUzytkuGruntowego"/>
      <rule label="EGB_KonturKlasyfikacyjny" symbol="2" key="{fe9580f9-6cc4-48e7-a6ac-9d07c78fec27}" filter=" try(  &quot;EGB_KonturKlasyfikacyjny_2_lokalnyId&quot;  ) is not null" description="EGB_KonturKlasyfikacyjny"/>
      <rule label="EGB_ObrebEwidencyjny" symbol="3" key="{587f83a9-f79a-4670-979d-73cb0b79e3bd}" filter=" try(  &quot;EGB_ObrebEwidencyjny_2_lokalnyId&quot;  ) is not null" description="EGB_ObrebEwidencyjny"/>
      <rule label="EGB_JednostkaEwidencyjna" symbol="4" key="{8448adf7-b0c5-4e01-a47e-14d0c4d8aa17}" filter=" try(  &quot;EGB_JednostkaEwidencyjna_2_lokalnyId&quot;  ) is not null" description="EGB_JednostkaEwidencyjna"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{fd401cb4-111c-412d-8258-54cee97f9436}">
      ...
      <rule key="{4961fecc-9292-40de-8028-4c0b06968c98}" filter=" try(  &quot;EGB_JednostkaEwidencyjna_2_lokalnyId&quot;  ) is not null" description="EGB_JednostkaEwidencyjna_2">
        <settings calloutType="simple">
      ...
      <rule key="{e6e82b68-7a2f-41a0-8536-205c8165e681}" filter=" try(  &quot;EGB_DzialkaEwidencyjna_2_lokalnyId&quot;  ) is not null" description="EGB_DzialkaEwidencyjna_2">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="4.1660000000000004" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="string_to_array( &quot;EGB_DzialkaEwidencyjna_2_idDzialki&quot;,'.')[-1]" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="2.6800000000000002" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="1" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MapUnit" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MapUnit" shapeBorderColor="128,128,128,255">
              <symbol alpha="1" clip_to_extent="1" type="marker" name="markerSymbol" force_rhr="0">
                <data_defined_properties>
                  <Option type="Map">
                    <Option type="QString" value="" name="name"/>
      ...
      <rule key="{26b72a52-e178-4baa-b6e4-dec11a377f14}" filter=" try(  &quot;EGB_KonturUzytkuGruntowego_2_lokalnyId&quot;  ) is not null" description="EGB_KonturUzytkuGruntowego_2">
        <settings calloutType="simple">
      ...
      <rule key="{a85c25ff-6041-4c3f-b97a-f98e3be0f557}" filter=" try(  &quot;EGB_KonturKlasyfikacyjny_2_lokalnyId&quot;  ) is not null" description="EGB_KonturKlasyfikacyjny_2">
        <settings calloutType="simple">
      ...
      <rule active="0" key="{b5750a07-10c4-4ab9-ba90-fbec02a7556b}" filter=" &quot;EGB_PunktGraniczny_0_lokalnyId&quot; is not NULL">
        <settings calloutType="simple">
