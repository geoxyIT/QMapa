...
<qgis labelsEnabled="0" simplifyLocal="1" version="3.24.0-Tisler" minScale="100000000" readOnly="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyAlgorithm="0" maxScale="0" simplifyDrawingHints="0" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <temporal limitMode="0" enabled="0" endField="" durationUnit="min" endExpression="" fixedDuration="0" startExpression="" accumulate="0" durationField="" mode="0" startField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory scaleBasedVisibility="0" spacing="5" penColor="#000000" opacity="1" rotationOffset="270" showAxis="1" maxScaleDenominator="1e+08" sizeScale="3x:0,0,0,0,0,0" penWidth="0" width="15" penAlpha="255" sizeType="MM" enabled="0" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" barWidth="5" backgroundAlpha="255" minimumSize="0" spacingUnitScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" spacingUnit="MM" height="15" direction="0" scaleDependency="Area" minScaleDenominator="0" diagramOrientation="Up">
  ...
  <DiagramLayerSettings obstacle="0" linePlacementFlags="18" priority="0" dist="0" placement="0" showAll="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="x" index="5"/>
    <alias name="" field="y" index="6"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="gml_id"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="justyfikacja"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="katObrotu"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="obiektPrzedstawiany"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="x"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="y"/>
  </constraints>
  ...
  <expressionfields>
    <field comment="" length="0" expression="$x" type="6" precision="0" subType="0" name="x" typeName=""/>
    <field comment="" length="0" expression="$y" type="6" precision="0" subType="0" name="y" typeName=""/>
  </expressionfields>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" name="obiektPrzedstawiany" hidden="0" width="-1"/>
