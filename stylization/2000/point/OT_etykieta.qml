...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{2fda2dc5-fc81-4106-b677-7457feecb322}">
      <rule label="OT_Budowle" symbol="0" filter=" try(  &quot;OT_Budowle_2_zrodlo&quot;  ) is not null" key="{d806dc09-4df1-4cab-9c48-5febb705ee61}" description="OT_Budowle_0"/>
      <rule label="OT_Komunikacja" symbol="1" filter="try(  &quot;OT_Komunikacja_2_zrodlo&quot;  ) is not null" key="{94edb97d-fbd1-4ded-a761-7a71b2554ee8}" description="OT_Komunikacja"/>
      <rule label="OT_SportIRekreacja" symbol="2" filter=" try(  &quot;OT_SportIRekreacja_2_zrodlo&quot;  ) is not null" key="{77732dfa-e4f3-4073-a782-d95bc68b0a15}" description="OT_SportIRekreacja"/>
      <rule label="OT_Wody" symbol="3" filter="try(  &quot;OT_Wody_2_zrodlo&quot;  ) is not null" key="{4d33ad1d-92db-4ff5-95cd-e9ea88cad878}" description="OT_Wody"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{686b6297-5373-44a8-af1a-507a3f744d66}">
      <rule filter=" try(  &quot;OT_Budowle_2_zrodlo&quot;  ) is not null" key="{232c194e-9a25-4acf-b75a-5a269054c81f}" description="OT_Budowle_2">
      ...
      <rule filter=" try(  &quot;OT_Komunikacja_2_zrodlo&quot;  ) is not null" key="{0d1bf25c-f895-453e-ae6a-04c8959e9fe7}" description="OT_Komunikacja_2">
        <settings calloutType="simple">
      ...
      <rule filter=" try(  &quot;OT_SportIRekreacja_2_zrodlo&quot;  ) is not null" key="{618f1e37-9f55-47a6-ae57-e9b757efdbcf}" description="OT_SportIRekreacja_2">
        <settings calloutType="simple">
      ...
      <rule filter=" try(  &quot;OT_Wody_2_zrodlo&quot;  ) is not null and( &quot;OT_Wody_2_rodzajObiektu&quot;   = 'p' or &quot;OT_Wody_2_rodzajObiektu&quot;   = 's')" key="{832bbb3c-72f4-441c-9163-255c7951b417}" description="OT_Wody_2_plynaca_stojaca">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="OT_Wody_2_lokalnyId" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_startObiekt" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_startWersjaObiekt" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_zrodlo" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_rodzajObiektu" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_obliczona_geometria_500" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_obliczona_geometria_1000" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_koniecWersjaObiekt" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_koniecObiekt" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_OT_PrezentacjaGraficzna_0_gml_id" hidden="0" width="-1" type="field"/>
      <column name="OT_Wody_2_OT_PrezentacjaGraficzna_0_katObrotu" hidden="0" width="-1" type="field"/>
