...
<qgis styleCategories="AllStyleCategories" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" minScale="100000000" simplifyDrawingHints="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule symbol="0" label="maszt oświetleniowy" filter="rodzajUrzadzenia = 'm' " key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}"/>
      <rule symbol="1" label="turbina wiatrowa" filter="rodzajUrzadzenia = 'a'" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{9367d66c-5fce-41d4-a812-9c937e5b36fb}">
      <rule description="projektowane" filter="(rodzajUrzadzenia = 'a' or rodzajUrzadzenia = 'm') and try(&quot;status&quot;) is 'p'" key="{9f7f9f83-96f0-4fa2-b3ac-c58827f98b78}">
        <settings calloutType="simple">
          <text-style fontKerning="1" previewBkgrdColor="255,255,255,255" allowHtml="0" namedStyle="Normal" legendString="Aa" fontWordSpacing="0" textOpacity="1" fontFamily="Arial" fieldName=" 'proj.'+'e' " fontSizeUnit="MapUnit" fontStrikeout="0" capitalization="0" fontWeight="50" blendMode="0" fontSize="3.125" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" textOrientation="horizontal" textColor="0,0,0,255" fontUnderline="0" fontLetterSpacing="0" fontItalic="0" multilineHeight="1" isExpression="1">
            <families/>
