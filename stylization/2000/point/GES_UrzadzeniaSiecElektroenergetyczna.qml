...
<qgis version="3.24.0-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule filter="rodzajUrzadzenia = 'm' " label="maszt oświetleniowy" key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}" symbol="0"/>
      <rule filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" symbol="1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f4cc411c-bbdd-46b0-80dd-16d0fc6a52a8}">
      <rule filter="(rodzajUrzadzenia = 'a' or rodzajUrzadzenia = 'm') and try(&quot;status&quot;) is 'p'" description="projektowane" key="{f4865052-9692-4ee5-88cd-65d3243f549c}">
        <settings calloutType="simple">
          <text-style namedStyle="Normalny" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontSize="3.125" textColor="0,0,0,255" fontWordSpacing="0" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" fontWeight="50" textOpacity="1" fieldName=" 'proj.'+'e' " blendMode="0" capitalization="0" fontLetterSpacing="0" fontFamily="Arial" fontStrikeout="0" isExpression="1" fontSizeUnit="MapUnit" fontKerning="1" fontItalic="0" multilineHeight="1">
            <families/>
