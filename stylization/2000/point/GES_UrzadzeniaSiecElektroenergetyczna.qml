...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule symbol="0" key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}" filter="rodzajUrzadzenia = 'm' " label="maszt oświetleniowy"/>
      <rule symbol="1" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" filter="rodzajUrzadzenia = 'a'" label="turbina wiatrowa"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" type="marker">
        ...
        <layer pass="0" class="SvgMarker" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset" value="0.29999999999999999,-3.70000000000000018" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{299ddb1e-0aa8-44aa-b87e-15456432e61b}">
      <rule key="{534081af-85a7-4250-b339-11a69d51b07d}" description="projektowane" filter="(rodzajUrzadzenia = 'a' or rodzajUrzadzenia = 'm') and try(&quot;status&quot;) is 'p'">
