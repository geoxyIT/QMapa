...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{974a531e-725c-4375-aa11-0e205b6c08cd}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" key="{85de3632-e5e4-4b3f-a57f-db8e6a437c2d}">
