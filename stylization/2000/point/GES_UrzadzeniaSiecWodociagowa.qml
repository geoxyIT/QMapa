...
<qgis version="3.24.0-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{3753aa50-9260-4666-8ff7-5310fc7e6fe5}">
      <rule filter="rodzajUrzadzenia = 'h'" label="hydrant" key="{d2434400-6f91-4f6a-bc01-bf84e00d9286}" symbol="0"/>
    </rules>
    <symbols>
      <symbol name="0" type="marker" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="offset" type="QString" value="0,-0.78000000000000003"/>
            ...
            <Option name="size" type="QString" value="3.36"/>
          ...
          <prop k="offset" v="0,-0.78000000000000003"/>
  ...
  <labeling type="rule-based">
    <rules key="{51795702-3b24-4c24-bf34-72cb2eca120a}">
      <rule filter="rodzajUrzadzenia = 'h' and &quot;status&quot; is 'p' " description="hydrofornia" key="{d529dceb-062b-4a4c-b5ed-435a8d2c2a6f}">
        <settings calloutType="simple">
          <text-style namedStyle="Normalny" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontSize="3.125" textColor="0,0,255,255" fontWordSpacing="0" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" fontWeight="50" textOpacity="1" fieldName="'proj.w'" blendMode="0" capitalization="0" fontLetterSpacing="0" fontFamily="Arial" fontStrikeout="0" isExpression="1" fontSizeUnit="MapUnit" fontKerning="1" fontItalic="0" multilineHeight="1">
            <families/>
          ...
          <placement geometryGenerator="" centroidInside="1" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" geometryGeneratorType="PointGeometry" priority="5" rotationUnit="AngleDegrees" maxCurvedCharAngleOut="-25" rotationAngle="0" yOffset="0" repeatDistance="0" repeatDistanceUnits="MM" dist="3.6000000000000001" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MapUnit" preserveRotation="1" offsetUnits="MM" overrunDistanceUnit="MM" overrunDistance="0" lineAnchorClipping="0" placement="6" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorEnabled="0" placementFlags="10" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" lineAnchorPercent="0.5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PointGeometry"/>
