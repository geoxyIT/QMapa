...
<qgis simplifyDrawingHints="0" maxScale="0" version="3.24.0-Tisler" simplifyDrawingTol="1" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="0,-0.78000000000000003" name="offset"/>
            ...
            <Option type="QString" value="3.36" name="size"/>
          ...
          <prop v="0,-0.78000000000000003" k="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{8f6abe5e-cee6-49fa-b27f-c6141b484128}">
      <rule filter="rodzajUrzadzenia = 'h' and &quot;status&quot; is 'p' " description="hydrofornia" key="{4eecf012-7164-44bb-afdb-ff42eea6a755}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="0,0,255,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'proj.w'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="3.125" textOrientation="horizontal" fontWeight="50">
            <families/>
