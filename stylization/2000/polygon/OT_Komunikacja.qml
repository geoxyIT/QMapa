...
<qgis hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" symbol="1" filter="rodzajObiektu = 'm'" label="most"/>
      <rule key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" symbol="2" filter="rodzajObiektu = 'w'" label="wiadukt"/>
      <rule key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" symbol="3" filter="rodzajObiektu = 'e'" label="estakada"/>
    </rules>
    <symbols>
