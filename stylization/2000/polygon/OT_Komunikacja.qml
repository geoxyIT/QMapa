...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule label="most" symbol="1" filter="rodzajObiektu = 'm'" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}"/>
      <rule label="wiadukt" symbol="2" filter="rodzajObiektu = 'w'" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}"/>
      <rule label="estakada" symbol="3" filter="rodzajObiektu = 'e'" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" name="1" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:10000,0,0,0.03,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{bf94e2d6-984b-4a5d-94bf-f61a874bee53}">
      <rule filter="rodzajObiektu = 'j'" key="{ea225dbd-3bc7-4d1a-8e06-54cd1b7f3029}" description="jezdnia">
