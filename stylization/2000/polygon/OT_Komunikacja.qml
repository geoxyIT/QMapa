...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule label="most" symbol="1" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" filter="rodzajObiektu = 'm'"/>
      <rule label="wiadukt" symbol="2" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" filter="rodzajObiektu = 'w'"/>
      <rule label="estakada" symbol="3" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" filter="rodzajObiektu = 'e'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{bf94e2d6-984b-4a5d-94bf-f61a874bee53}">
      <rule key="{ea225dbd-3bc7-4d1a-8e06-54cd1b7f3029}" filter="rodzajObiektu = 'j'" description="jezdnia">
