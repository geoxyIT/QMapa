...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule symbol="0" key="{e3fd26e9-8ac5-435b-81af-191e86adbd4e}" label="osadnik, szambo" filter="rodzajUrzadzenia = 'm'" />
      <rule symbol="1" key="{c0c30269-e0fd-438c-8aba-f36964146691}" label="przepompownia" filter="rodzajUrzadzenia = 'n'" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5e81b42c-4d61-4c51-8147-469634fe435d}">
      <rule description="osadnik, szambo" key="{618ea20b-8edd-4c9b-a242-3a983f7e56fc}" filter="rodzajUrzadzenia = 'm'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'kl' &#10;END&#10;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="3.125" isExpression="1" fontWeight="50" textOpacity="1" textColor="128,51,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
      ...
      <rule description="przepompownia" key="{f1d6ae7d-2b54-4f0c-b93b-22ecbb690033}" filter="rodzajUrzadzenia = 'n'">
        <settings calloutType="simple">
