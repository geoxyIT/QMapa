...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule label="osadnik, szambo" filter="rodzajUrzadzenia = 'm'" symbol="0" key="{e3fd26e9-8ac5-435b-81af-191e86adbd4e}"/>
      <rule label="przepompownia" filter="rodzajUrzadzenia = 'n'" symbol="1" key="{c0c30269-e0fd-438c-8aba-f36964146691}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5e81b42c-4d61-4c51-8147-469634fe435d}">
      <rule description="osadnik, szambo" filter="rodzajUrzadzenia = 'm'" key="{618ea20b-8edd-4c9b-a242-3a983f7e56fc}">
      ...
      <rule description="przepompownia" filter="rodzajUrzadzenia = 'n'" key="{f1d6ae7d-2b54-4f0c-b93b-22ecbb690033}">
        <settings calloutType="simple">
