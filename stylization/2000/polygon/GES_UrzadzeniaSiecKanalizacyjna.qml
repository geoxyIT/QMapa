...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{dce194d6-9f82-4126-b81b-e132f5d70944}">
      <rule filter="rodzajUrzadzenia = 'm'" label="osadnik, szambo" symbol="0" key="{e3fd26e9-8ac5-435b-81af-191e86adbd4e}"/>
      <rule filter="rodzajUrzadzenia = 'n'" label="przepompownia" symbol="1" key="{c0c30269-e0fd-438c-8aba-f36964146691}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5e81b42c-4d61-4c51-8147-469634fe435d}">
      <rule filter="rodzajUrzadzenia = 'm'" description="osadnik, szambo" key="{618ea20b-8edd-4c9b-a242-3a983f7e56fc}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="3.125" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'k' ELSE 'kl' &#xa;END&#xa;" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="128,51,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
      ...
      <rule filter="rodzajUrzadzenia = 'n'" description="przepompownia" key="{f1d6ae7d-2b54-4f0c-b93b-22ecbb690033}">
        <settings calloutType="simple">
