...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
      ...
      <symbol alpha="1" clip_to_extent="1" name="3" force_rhr="0" type="fill">
        ...
        <layer pass="0" class="GeometryGenerator" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="geometryModifier" value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90, $area / ($perimeter/8),0.5)" type="QString"/>
            <Option name="units" value="MapUnit" type="QString"/>
          </Option>
          <prop v="Line" k="SymbolType"/>
          <prop v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90, $area / ($perimeter/8),0.5)" k="geometryModifier"/>
        ...
        <layer pass="0" class="GeometryGenerator" enabled="1" locked="0">
          <Option type="Map">
            <Option name="SymbolType" value="Line" type="QString"/>
            <Option name="geometryModifier" value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90,0,1)" type="QString"/>
            <Option name="units" value="MapUnit" type="QString"/>
          </Option>
          <prop v="Line" k="SymbolType"/>
          <prop v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90,0,1)" k="geometryModifier"/>
          <prop v="MapUnit" k="units"/>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{ceaacb0e-b7d4-4496-b19c-bdfd2c9b3743}">
      <rule key="{3b994a09-6f3a-452a-abaa-49bf716e9eac}" description="woda płynąca" filter="rodzajObiektu = 'p'">
      ...
      <rule key="{1e0dab9e-cce6-480e-8241-f9ad860e6364}" description="woda stojąca" filter="rodzajObiektu = 's'">
        <settings calloutType="simple">
