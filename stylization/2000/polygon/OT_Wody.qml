...
<qgis symbologyReferenceScale="-1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" version="3.24.2-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1">
      ...
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="3">
        ...
        <layer pass="0" locked="0" class="GeometryGenerator" enabled="1">
          <Option type="Map">
            ...
            <Option value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90, $area / ($perimeter/8),0.5)" type="QString" name="geometryModifier"/>
        ...
        <layer pass="0" locked="0" class="GeometryGenerator" enabled="1">
          <Option type="Map">
            <Option value="Line" type="QString" name="SymbolType"/>
            <Option value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90,0,1)" type="QString" name="geometryModifier"/>
            <Option value="MapUnit" type="QString" name="units"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
  ...
  <labeling type="rule-based">
    <rules key="{ceaacb0e-b7d4-4496-b19c-bdfd2c9b3743}">
      <rule description="woda płynąca" key="{3b994a09-6f3a-452a-abaa-49bf716e9eac}" filter="rodzajObiektu = 'p'">
      ...
      <rule description="woda stojąca" key="{1e0dab9e-cce6-480e-8241-f9ad860e6364}" filter="rodzajObiektu = 's'">
        <settings calloutType="simple">
