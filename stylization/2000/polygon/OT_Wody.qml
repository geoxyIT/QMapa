...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      ...
      <rule filter="rodzajObiektu = 'w'" label="wal przeciwpowodziowy" symbol="2" key="{26a2adf8-a111-42ba-9162-6ac994510389}"/>
      <rule filter="rodzajObiektu = 'g'" label="grobla" symbol="3" key="{bd4b73d1-0e2e-43ee-ab75-7bc8a60c6367}"/>
      <rule filter="rodzajObiektu = 'z'" label="zapora" symbol="4" key="{66bb1a4e-5b60-45dd-b8c4-ba6330bd611d}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b9f51c9a-d014-4e08-83ed-79978626a1be}">
      ...
      <rule filter="rodzajObiektu = 's'" description="woda stojąca" key="{48fa3652-9d28-43e0-ada3-a1ff052aadee}">
        <settings calloutType="simple">
