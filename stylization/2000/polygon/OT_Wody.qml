...
<qgis readOnly="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      <rule symbol="0" label="woda płynąca" key="{abd262f0-2c39-406a-b9b3-df9a46365db8}" filter="rodzajObiektu = 'p'"/>
      <rule symbol="1" label="woda stojąca" key="{7c8976f0-1b34-4e10-a7db-d3121faefe42}" filter="rodzajObiektu = 's'"/>
      <rule symbol="2" label="wal przeciwpowodziowy" key="{26a2adf8-a111-42ba-9162-6ac994510389}" filter="rodzajObiektu = 'w'"/>
      <rule symbol="3" label="grobla" key="{bd4b73d1-0e2e-43ee-ab75-7bc8a60c6367}" filter="rodzajObiektu = 'g'"/>
      <rule symbol="4" label="zapora" key="{66bb1a4e-5b60-45dd-b8c4-ba6330bd611d}" filter="rodzajObiektu = 'z'"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="fill" name="2">
        ...
        <layer enabled="1" locked="0" class="GeometryGenerator" pass="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="line" name="@2@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="fill" name="3">
        ...
        <layer enabled="1" locked="0" class="GeometryGenerator" pass="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="line" name="@3@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{b9f51c9a-d014-4e08-83ed-79978626a1be}">
      <rule key="{194a542e-5669-4b8f-bca1-d362a6e85b1b}" filter="rodzajObiektu = 'p'" description="woda płynąca">
        <settings calloutType="simple">
          <text-style fontKerning="1" namedStyle="Normal" fontLetterSpacing="0" legendString="Aa" capitalization="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" textOpacity="1" fontFamily="Arial" multilineHeight="1" allowHtml="0" blendMode="0" fontStrikeout="0" fontSize="5.2084000000000001" fontItalic="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWeight="50" textOrientation="horizontal" textColor="89,217,255,255" fontWordSpacing="0" isExpression="1" fieldName="try(&quot;nazwaWlasna&quot;)">
            <families/>
            <text-buffer bufferBlendMode="0" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferDraw="0" bufferNoFill="1"/>
            <text-mask maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers="" maskSize="1.5" maskSizeUnits="MM" maskType="0"/>
            <background shapeRotation="0" shapeSizeType="0" shapeSizeUnit="MM" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeSizeX="0" shapeDraw="0" shapeBlendMode="0" shapeBorderWidth="0" shapeSVGFile="" shapeRadiiX="0" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeSizeY="0" shapeBorderWidthUnit="MM" shapeJoinStyle="64" shapeRadiiY="0" shapeBorderColor="128,128,128,255">
            ...
            <shadow shadowColor="0,0,0,255" shadowOffsetAngle="135" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowOffsetDist="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowRadiusUnit="MM" shadowOffsetUnit="MM" shadowDraw="0" shadowBlendMode="6" shadowUnder="0" shadowRadius="1.5" shadowOpacity="0.69999999999999996" shadowRadiusAlphaOnly="0"/>
            <dd_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
          ...
          <text-format multilineAlign="3" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" formatNumbers="0" placeDirectionSymbol="0" plussign="0" autoWrapLength="0" leftDirectionSymbol="&lt;" wrapChar="" addDirectionSymbol="0" rightDirectionSymbol=">" decimals="3"/>
          <placement placementFlags="10" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="0" distUnits="MM" repeatDistanceUnits="MM" centroidInside="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" priority="5" offsetUnits="MM" preserveRotation="1" layerType="PolygonGeometry" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" xOffset="0" rotationAngle="0" quadOffset="4" lineAnchorClipping="0" placement="1" rotationUnit="AngleDegrees" offsetType="0" repeatDistance="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" fitInPolygonOnly="0" lineAnchorType="0"/>
          <rendering mergeLines="0" scaleMax="0" fontMaxPixelSize="10000" obstacleType="1" minFeatureSize="0" fontLimitPixelSize="0" maxNumLabels="2000" scaleVisibility="0" drawLabels="1" unplacedVisibility="0" displayAll="1" fontMinPixelSize="3" upsidedownLabels="0" limitNumLabels="0" labelPerPart="0" zIndex="0" obstacle="1" scaleMin="0" obstacleFactor="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option type="Map" name="properties">
      ...
      <rule key="{48fa3652-9d28-43e0-ada3-a1ff052aadee}" filter="rodzajObiektu = 's'" description="woda stojąca">
        <settings calloutType="simple">
          <text-style fontKerning="1" namedStyle="Normal" fontLetterSpacing="0" legendString="Aa" capitalization="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" textOpacity="1" fontFamily="Arial" multilineHeight="1" allowHtml="0" blendMode="0" fontStrikeout="0" fontSize="5.2084000000000001" fontItalic="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWeight="50" textOrientation="horizontal" textColor="89,217,255,255" fontWordSpacing="0" isExpression="1" fieldName="case&#xd;&#xa; when&#xd;&#xa;    &quot;rodzajObiektu&quot;   = 's' and try( &quot;nazwaWlasna&quot; ) is not null&#xd;&#xa; then&#xd;&#xa; try( &quot;nazwaWlasna&quot; )&#xd;&#xa; when&#xd;&#xa;    &quot;rodzajObiektu&quot;   = 's' and try( &quot;nazwaWlasna&quot; ) is null&#xd;&#xa; then&#xd;&#xa; 'w.'&#xd;&#xa; end&#xd;&#xa; ">
            <families/>
            <text-buffer bufferBlendMode="0" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferOpacity="1" bufferColor="255,255,255,255" bufferDraw="0" bufferNoFill="1"/>
            <text-mask maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers="" maskSize="1.5" maskSizeUnits="MM" maskType="0"/>
            <background shapeRotation="0" shapeSizeType="0" shapeSizeUnit="MM" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeSizeX="0" shapeDraw="0" shapeBlendMode="0" shapeBorderWidth="0" shapeSVGFile="" shapeRadiiX="0" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeSizeY="0" shapeBorderWidthUnit="MM" shapeJoinStyle="64" shapeRadiiY="0" shapeBorderColor="128,128,128,255">
  ...
  <aliases>
    ...
    <alias field="rodzajObiektu" index="9" name=""/>
    <alias field="obliczona_geometria_500" index="10" name=""/>
    <alias field="koniecWersjaObiekt" index="11" name=""/>
    <alias field="koniecObiekt" index="12" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" field="numerOperatu" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="rodzajObiektu" unique_strength="0" constraints="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="numerOperatu"/>
      <column hidden="0" width="-1" type="field" name="rodzajObiektu"/>
