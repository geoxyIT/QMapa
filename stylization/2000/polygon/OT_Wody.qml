...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" readOnly="0" labelsEnabled="1" maxScale="0" minScale="100000000" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyDrawingHints="1">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      ...
      <rule label="wal przeciwpowodziowy" symbol="2" filter="rodzajObiektu = 'w'" key="{26a2adf8-a111-42ba-9162-6ac994510389}"/>
      <rule label="grobla" symbol="3" filter="rodzajObiektu = 'g'" key="{bd4b73d1-0e2e-43ee-ab75-7bc8a60c6367}"/>
      <rule label="zapora" symbol="4" filter="rodzajObiektu = 'z'" key="{66bb1a4e-5b60-45dd-b8c4-ba6330bd611d}"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" clip_to_extent="1" force_rhr="0" alpha="1" name="2">
        ...
        <layer class="GeometryGenerator" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90, $area / ($perimeter/8),0.5)" name="geometryModifier"/>
            <Option type="QString" value="MapUnit" name="units"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90, $area / ($perimeter/8),0.5)"/>
        ...
        <layer class="GeometryGenerator" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" value="Line" name="SymbolType"/>
            <Option type="QString" value="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90,0,1)" name="geometryModifier"/>
            <Option type="QString" value="MapUnit" name="units"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="kreskowanie(skarpy($geometry, geometry(get_feature('OT_poczatekGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),geometry(get_feature('OT_koniecGorySkarpy',  'gml_id' , &quot;gml_id&quot;  )),'top'),buffer($geometry,0.001), $area / ($perimeter/16), 50, 90,0,1)"/>
          <prop k="units" v="MapUnit"/>
          <data_defined_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
          ...
          <symbol type="line" clip_to_extent="1" force_rhr="0" alpha="1" name="@2@1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="fill" clip_to_extent="1" force_rhr="0" alpha="1" name="3">
        ...
        <layer class="GeometryGenerator" enabled="1" pass="0" locked="0">
          ...
          <symbol type="line" clip_to_extent="1" force_rhr="0" alpha="1" name="@3@1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{89e34b7b-8554-4c2f-bc67-3ac19fd44983}">
      <rule description="woda płynąca" filter="rodzajObiektu = 'p'" key="{a8b4da82-fafc-4892-8ef7-754dba630718}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" capitalization="0" fontStrikeout="0" fontSizeUnit="MapUnit" legendString="Aa" textColor="89,217,255,255" fieldName="try(&quot;nazwaWlasna&quot;)" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="5.2084000000000001" blendMode="0" isExpression="1" namedStyle="Normal" textOpacity="1" fontWordSpacing="0" fontWeight="50" allowHtml="0" useSubstitutions="0" textOrientation="horizontal" multilineHeight="1" fontFamily="Arial" fontItalic="0" fontKerning="1" previewBkgrdColor="255,255,255,255" fontUnderline="0">
            <families/>
      ...
      <rule description="woda stojąca" filter="rodzajObiektu = 's'" key="{c44fedd1-b07d-49aa-a79e-b90ca26d9d48}">
        <settings calloutType="simple">
