...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    <rules key="{18f234d1-5dec-49a5-980f-1561d9498a3d}">
      <rule filter="rodzajUrzadzenia = 'w'" label="wieża telekomunikacyjna" symbol="0" key="{c3f9e874-3fc7-411b-8ec0-4f6543face55}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0d860c3f-acef-421b-81f2-b382f99c592e}">
      <rule filter="rodzajUrzadzenia = 'w'" description="wieża telekomunikacyjna" key="{80279f1b-4a33-4133-9675-94a11b2b659e}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontSize="5.2084000000000001" textOpacity="1" multilineHeight="1" capitalization="0" fontStrikeout="0" fontItalic="0" fieldName="CASE&#xa;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'t' ELSE 'WT' END&#xa;" textOrientation="horizontal" useSubstitutions="0" fontUnderline="0" fontWeight="50" namedStyle="Normal" fontLetterSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa" textColor="255,145,0,255" allowHtml="0" fontKerning="1" isExpression="1" fontFamily="Arial" fontWordSpacing="0" fontSizeUnit="MapUnit">
            <families/>
