...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{0d860c3f-acef-421b-81f2-b382f99c592e}">
      <rule description="wieża telekomunikacyjna" key="{80279f1b-4a33-4133-9675-94a11b2b659e}" filter="rodzajUrzadzenia = 'w'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="CASE&#10;WHEN &quot;status&quot; is 'p' THEN 'proj.'+'t' ELSE 'WT' END&#10;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="5.2084000000000001" isExpression="1" fontWeight="50" textOpacity="1" textColor="255,145,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families />
