...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{cc1c9b43-b1c0-40fc-9e4f-64036345a28b}">
      <rule label="budynek naziemny" symbol="0" filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" key="{119a77b0-c572-4a1e-8b89-d6a0768c4603}"/>
      <rule label="budynek podziemny" symbol="1" filter="(try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" key="{86bf6f44-6aa3-41f8-92dd-c3f8e7c4fcfd}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="customdash_map_unit_scale" type="QString" value="3x:10000,0,0,0.03,0,0"/>
            ...
            <Option name="width_map_unit_scale" type="QString" value="3x:10000,0,0,0.03,0,0"/>
          </Option>
  ...
  <labeling type="rule-based">
    <rules key="{e4e0c815-6893-4062-bc7e-942c07b27e8b}">
      <settings calloutType="simple">
        <text-style textOpacity="1" namedStyle="" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="0" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="Point" fontFamily="MS Shell Dlg 2" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="" legendString="Aa" fontSize="10" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
          <families/>
        ...
        <placement rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" overrunDistance="0" dist="0" placement="0" preserveRotation="1" geometryGenerator="" repeatDistance="0" lineAnchorPercent="0.5" placementFlags="10" layerType="UnknownGeometry" centroidWhole="0" offsetType="0" fitInPolygonOnly="0" priority="5" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" polygonPlacementFlags="2" lineAnchorType="0" quadOffset="4" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0"/>
        <rendering fontMaxPixelSize="10000" displayAll="0" labelPerPart="0" mergeLines="0" obstacleFactor="1" fontLimitPixelSize="0" obstacle="1" scaleMax="0" obstacleType="1" scaleVisibility="0" zIndex="0" upsidedownLabels="0" scaleMin="0" unplacedVisibility="0" maxNumLabels="2000" limitNumLabels="0" minFeatureSize="0" drawLabels="1" fontMinPixelSize="0"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <rule filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )" key="{32042e5b-1d6a-4774-b2e7-ffae2df16582}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+to_string(&quot;liczbaKondygnacjiNadziemnych&quot;) END" legendString="Aa" fontSize="1.7361" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskEnabled="0" maskSize="1.5" maskJoinStyle="128" maskSizeUnits="MM" maskOpacity="1" maskType="0"/>
            <background shapeOffsetY="0" shapeDraw="0" shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSVGFile="" shapeSizeX="0" shapeSizeY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeSizeUnit="MM">
      ...
      <rule filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )" key="{ed881181-3efc-493c-8576-c0bfba9ec735}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="CASE WHEN &quot;rodzajWgKST&quot; = 101 THEN 'p'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 102 THEN 't'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 103 THEN 'h'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 104 THEN 's'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 105 THEN 'b'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 106 THEN 'z'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 107 THEN 'k'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 108 THEN 'g'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 109 THEN 'i'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) WHEN &quot;rodzajWgKST&quot; = 110 THEN 'm'+'-'+to_string(&quot;liczbaKondygnacjiPodziemnych&quot;) END" legendString="Aa" fontSize="1.7361" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskEnabled="0" maskSize="1.5" maskJoinStyle="128" maskSizeUnits="MM" maskOpacity="1" maskType="0"/>
            <background shapeOffsetY="0" shapeDraw="0" shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSVGFile="" shapeSizeX="0" shapeSizeY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeSizeUnit="MM">
      ...
      <rule filter="(&quot;statusBudynku&quot; = 1 or &quot;statusBudynku&quot; = 3) and not (&quot;liczbaKondygnacjiPodziemnych&quot;>0 and &quot;liczbaKondygnacjiNadziemnych&quot;&lt;1 )" key="{ca5655a9-2104-4e5d-beeb-eebc82693772}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="string_to_array(string_to_array( &quot;idBudynku&quot; ,'.')[-1],'_')[0]" legendString="Aa" fontSize="1.7361" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskEnabled="0" maskSize="1.5" maskJoinStyle="128" maskSizeUnits="MM" maskOpacity="1" maskType="0"/>
            <background shapeOffsetY="0" shapeDraw="0" shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSVGFile="" shapeSizeX="0" shapeSizeY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeSizeUnit="MM">
          ...
          <text-format placeDirectionSymbol="0" leftDirectionSymbol="&lt;" multilineAlign="3" rightDirectionSymbol=">" wrapChar="" formatNumbers="0" plussign="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" reverseDirectionSymbol="0" decimals="3"/>
          <placement rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" overrunDistance="0" dist="0" placement="1" preserveRotation="1" geometryGenerator="" repeatDistance="0" lineAnchorPercent="0.5" placementFlags="10" layerType="PolygonGeometry" centroidWhole="0" offsetType="0" fitInPolygonOnly="0" priority="5" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" polygonPlacementFlags="2" lineAnchorType="0" quadOffset="4" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="2"/>
          <rendering fontMaxPixelSize="10000" displayAll="1" labelPerPart="0" mergeLines="0" obstacleFactor="1" fontLimitPixelSize="0" obstacle="1" scaleMax="0" obstacleType="1" scaleVisibility="0" zIndex="0" upsidedownLabels="0" scaleMin="0" unplacedVisibility="0" maxNumLabels="2000" limitNumLabels="0" minFeatureSize="0" drawLabels="1" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
  ...
  <attributetableconfig sortExpression="&quot;liczbaKondygnacjiNadziemnych&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      ...
      <column name="idBudynku" hidden="0" width="-1" type="field"/>
      <column name="rodzajWgKST" hidden="0" width="-1" type="field"/>
      <column name="liczbaKondygnacjiNadziemnych" hidden="0" width="-1" type="field"/>
      <column name="liczbaKondygnacjiPodziemnych" hidden="0" width="-1" type="field"/>
      <column name="powZabudowy" hidden="0" width="-1" type="field"/>
      <column name="powZabudowy_uom" hidden="0" width="-1" type="field"/>
