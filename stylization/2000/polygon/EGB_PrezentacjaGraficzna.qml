...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{2507f574-194b-4d87-9ef0-f8b0a4601984}">
      <rule key="{682bd854-5723-4fea-b822-e9dee035f03e}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{6eec675b-d431-4540-b9fa-e4d1d8245448}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{d589de20-290e-4230-a90c-140e804839fc}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{5e6a423d-7dd2-4430-a402-11c32aa88970}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{97fe0896-c8ca-4ad2-926f-567da7c42fd1}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{888107a9-a7a8-40d1-b7d5-3e177f3928f9}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{28d67a1b-02e7-460b-b2f4-5895cd6bd3c6}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{fd0b413b-5ee8-4b9f-a2c5-0681287fc8fb}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
