...
<qgis simplifyDrawingTol="1" maxScale="0" version="3.24.2-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" readOnly="0">
  <flags>
  ...
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{bb778299-c56c-419a-ba33-8f5dd5a4b6ec}">
      <rule symbol="0" filter="rodzajObiektu = 'k'" label="zadrzewienie, zakrzewienie" key="{ce8b465e-42f3-4e37-a473-2eb218599461}"/>
      <rule symbol="1" filter="rodzajObiektu = 'z'" label="teren zalesiony" key="{466a2f79-81e2-4586-8148-a54180c262cd}"/>
      <rule symbol="2" filter="rodzajObiektu = 'c'" label="cmentarz" key="{a24c3933-1b4c-4d6f-877e-fd0435143c1d}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="0" type="fill">
        ...
        <layer pass="0" enabled="1" locked="0" class="PointPatternFill">
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="@0@0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="1" type="fill">
        ...
        <layer pass="0" enabled="1" locked="0" class="PointPatternFill">
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="@1@0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="2" type="fill">
        ...
        <layer pass="0" enabled="1" locked="0" class="PointPatternFill">
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" name="@2@0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
