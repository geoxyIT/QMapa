...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="0"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="nullSymbol" referencescale="-1" />
  <labeling type="rule-based">
    <rules key="{61b27497-d746-42ca-afc1-5351073ccb52}">
      <rule description="właz do komory, kanału " key="{2cb5902a-11a9-406d-9d69-2fb3012541a6}" filter="rodzajUrzadzenia = 'w'">
      ...
      <rule description="budowla podziemna" key="{0bc9186a-a896-4fa7-9b0d-6b1228f79868}" filter="rodzajUrzadzenia = 'b'">
        <settings calloutType="simple">
