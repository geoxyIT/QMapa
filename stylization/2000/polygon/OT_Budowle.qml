...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{fa5d61a8-2272-42b8-923d-8f4b9b68029b}">
      <rule key="{6c31fdfb-b83b-4c50-85c2-55ce0579f46e}" description="wieża ciśnień" filter="rodzajBudowli = 'c'">
      ...
      <rule key="{e2beba6e-af17-4b32-8a1c-beea7efb654c}" description="wieża przeciwpożarowa" filter="rodzajBudowli = 'z'">
        <settings calloutType="simple">
      ...
      <rule key="{d351ef93-9a19-43cf-a865-24999576e275}" description="wieża szybu kopalnianego" filter="rodzajBudowli = 's'">
        <settings calloutType="simple">
      ...
      <rule key="{1c04882f-3e2a-4316-ae45-43542dbf8a66}" description="wieża widokowa" filter="rodzajBudowli = 'w'">
        <settings calloutType="simple">
