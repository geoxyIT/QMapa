...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  <flags>
  ...
  <temporal mode="0" startExpression="" endExpression="" fixedDuration="0" accumulate="0" startField="" durationField="" durationUnit="min" endField="" limitMode="0" enabled="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <labeling type="rule-based">
    <rules key="{efc59cc7-1db2-4fb3-8483-f8d582d34726}">
      <rule key="{33ffece8-ce64-46d3-99ac-9ebf7f4ce713}" description="jezdnia" filter="rodzajObiektu = 'j'">
        <settings calloutType="simple">
          <text-style textColor="0,0,0,255" previewBkgrdColor="255,255,255,255" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:2500,0,0,0,0,0" fontStrikeout="0" fontItalic="0" namedStyle="Normal" fontWeight="50" isExpression="1" textOrientation="horizontal" capitalization="0" fontWordSpacing="0" fontUnderline="0" multilineHeight="1" fontKerning="1" fontFamily="Arial" useSubstitutions="0" fontSize="1.0417000000000001" fontLetterSpacing="0" textOpacity="1" blendMode="0" allowHtml="0" fieldName="'j.' + try(&quot;rodzajNawierzchni&quot;)" legendString="Aa">
            <families/>
            <text-buffer bufferNoFill="1" bufferSize="1" bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferDraw="0" bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
            <text-mask maskJoinStyle="128" maskOpacity="1" maskSizeUnits="MM" maskEnabled="0" maskType="0" maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers=""/>
            <background shapeRotationType="0" shapeSizeX="0" shapeSVGFile="" shapeSizeUnit="MM" shapeSizeY="0" shapeBorderColor="128,128,128,255" shapeRadiiUnit="MM" shapeOffsetY="0" shapeRotation="0" shapeDraw="0" shapeOpacity="1" shapeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeJoinStyle="64" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeBlendMode="0" shapeRadiiX="0" shapeSizeType="0" shapeFillColor="255,255,255,255" shapeBorderWidth="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeOffsetUnit="MM">
            ...
            <shadow shadowOffsetUnit="MM" shadowBlendMode="6" shadowOffsetAngle="135" shadowRadiusUnit="MM" shadowOffsetGlobal="1" shadowUnder="0" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowOffsetDist="1" shadowColor="0,0,0,255" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowDraw="0"/>
            <dd_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
          ...
          <text-format wrapChar="" multilineAlign="3" leftDirectionSymbol="&lt;" plussign="0" reverseDirectionSymbol="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" rightDirectionSymbol=">" decimals="3" placeDirectionSymbol="0" formatNumbers="0"/>
          <placement distMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" rotationUnit="AngleDegrees" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MM" overrunDistance="0" yOffset="0" preserveRotation="1" geometryGeneratorEnabled="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" lineAnchorPercent="0.5" lineAnchorType="0" maxCurvedCharAngleIn="25" lineAnchorClipping="0" overrunDistanceUnit="MM" placementFlags="10" geometryGenerator="" dist="0" layerType="PolygonGeometry" polygonPlacementFlags="2" repeatDistance="0" distUnits="MM" maxCurvedCharAngleOut="-25" centroidWhole="0" offsetType="0" fitInPolygonOnly="0" repeatDistanceUnits="MM" placement="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" quadOffset="4"/>
          <rendering scaleVisibility="0" minFeatureSize="0" obstacle="1" displayAll="1" maxNumLabels="2000" unplacedVisibility="0" scaleMax="0" upsidedownLabels="0" mergeLines="0" limitNumLabels="0" obstacleType="1" scaleMin="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" zIndex="0" drawLabels="1" obstacleFactor="1" labelPerPart="0" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
      ...
      <rule key="{4dff2c63-3fd8-44ae-bac2-cf0de5e22ae9}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{e4053b0d-547e-4620-b282-388a90c5f2d4}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{9a60250e-4a26-4d33-89a4-9ce0a4ad15de}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{22105a4e-cc28-4304-bd48-4095a048f978}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{925f5b41-6d32-4947-b135-5b4110c78456}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{bbc3af8b-466e-4e31-b06e-0ff5b93719b9}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{d8a2d0b6-46aa-4e6e-a3e0-d925e64d4ec2}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory penAlpha="255" scaleBasedVisibility="0" minScaleDenominator="0" spacingUnit="MM" barWidth="5" penWidth="0" enabled="0" width="15" lineSizeType="MM" direction="0" minimumSize="0" penColor="#000000" spacing="5" opacity="1" backgroundAlpha="255" diagramOrientation="Up" sizeType="MM" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" height="15" lineSizeScale="3x:0,0,0,0,0,0" showAxis="1" labelPlacementMethod="XHeight" backgroundColor="#ffffff" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" scaleDependency="Area">
  ...
  <aliases>
    ...
    <alias name="" field="rodzajObiektu" index="10"/>
    <alias name="" field="rodzajNawierzchni" index="11"/>
    <alias name="" field="polozenie" index="12"/>
    <alias name="" field="koniecObiekt" index="13"/>
    <alias name="" field="obliczona_geometria_500" index="14"/>
    <alias name="" field="obliczona_geometria_1000" index="15"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="gml_id" exp_strength="0"/>
    ...
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="startObiekt" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="startWersjaObiekt" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="koniecWersjaObiekt" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="zrodlo" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="numerOperatu" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="rodzajObiektu" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="rodzajNawierzchni" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="polozenie" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="koniecObiekt" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="obliczona_geometria_500" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="obliczona_geometria_1000" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="lokalnyId" hidden="0"/>
      <column width="-1" type="field" name="przestrzenNazw" hidden="0"/>
      <column width="-1" type="field" name="wersjaId" hidden="0"/>
      <column width="-1" type="field" name="startObiekt" hidden="0"/>
      <column width="-1" type="field" name="startWersjaObiekt" hidden="0"/>
      <column width="-1" type="field" name="koniecWersjaObiekt" hidden="0"/>
      <column width="-1" type="field" name="zrodlo" hidden="0"/>
      <column width="-1" type="field" name="numerOperatu" hidden="0"/>
      <column width="-1" type="field" name="rodzajObiektu" hidden="0"/>
      <column width="-1" type="field" name="rodzajNawierzchni" hidden="0"/>
      <column width="-1" type="field" name="polozenie" hidden="0"/>
      <column width="-1" type="field" name="koniecObiekt" hidden="0"/>
      <column width="-1" type="field" name="obliczona_geometria_500" hidden="0"/>
      <column width="-1" type="field" name="obliczona_geometria_1000" hidden="0"/>
