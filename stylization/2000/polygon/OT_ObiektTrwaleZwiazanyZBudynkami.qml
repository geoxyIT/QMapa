...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="0"><renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="nullSymbol" referencescale="-1" />
  <labeling type="rule-based">
    <rules key="{51843953-7c5f-4233-a9be-580afc48ae1e}">
      ...
      <rule description="podjazd dla osób niepełnosprawnych" key="{60a526f3-5dd6-46e0-9937-ef6fcfa78ea5}" filter="rodzajObiektu = 'd'">
        <settings calloutType="simple">
