...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{51843953-7c5f-4233-a9be-580afc48ae1e}">
      <rule key="{7bcb8371-8e37-4615-ab5a-688070feff07}" description="rampa" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'rmp'" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.5624990000000001" allowHtml="0" textColor="0,0,0,255">
            <families/>
      ...
      <rule key="{60a526f3-5dd6-46e0-9937-ef6fcfa78ea5}" description="podjazd dla osób niepełnosprawnych" filter="rodzajObiektu = 'd'">
        <settings calloutType="simple">
