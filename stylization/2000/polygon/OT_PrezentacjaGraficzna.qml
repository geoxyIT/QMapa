...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{e719d0be-e35b-45c0-a580-3db902ad53b9}">
      <rule key="{120935d9-00da-4da5-9feb-144345e98364}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{04d673a9-e9d8-434c-a9bc-5e132283fd6b}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{47971caa-1cbb-4776-a765-a648588796f1}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{c256264a-f7d7-4790-8a29-3cd63c8ffada}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{9b2f4103-6bc7-4ec6-bb84-06a3f2806033}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{d01aff13-afac-4c3e-8a47-aae628bc013f}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{f6c5c037-f637-4e10-9e79-df3a824564b0}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{36105ce8-2fdb-4059-a135-8536207375f0}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
