...
<qgis simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" maxScale="0">
      ...
      <symbol alpha="1" name="0" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="MarkerLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:12000,0,1,0.03,0,0" name="interval_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="interval_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
            <Option value="6" name="offset_along_line" type="QString"/>
            <Option value="3x:12000,0,1,0.03,0,0" name="offset_along_line_map_unit_scale" type="QString"/>
          ...
          <prop k="interval_map_unit_scale" v="3x:12000,0,1,0.03,0,0"/>
          <prop k="interval_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="6"/>
          <prop k="offset_along_line_map_unit_scale" v="3x:12000,0,1,0.03,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement placement="7" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" quadOffset="4" repeatDistance="200" rotationAngle="0" centroidInside="0" dist="0.5" offsetUnits="MM" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" layerType="PolygonGeometry" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" placementFlags="6" distUnits="MapUnit" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" preserveRotation="1" repeatDistanceUnits="MapUnit" overrunDistance="0" geometryGenerator="" xOffset="0" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="0" fitInPolygonOnly="1" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" centroidWhole="0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry"/>
