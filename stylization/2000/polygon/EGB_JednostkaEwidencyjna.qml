...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
      ...
      <symbol force_rhr="0" alpha="1" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="interval_map_unit_scale" type="QString" value="3x:10000,0,0,0,0,0"/>
            <Option name="interval_unit" type="QString" value="MapUnit"/>
            <Option name="offset" type="QString" value="0"/>
            <Option name="offset_along_line" type="QString" value="6"/>
            <Option name="offset_along_line_map_unit_scale" type="QString" value="3x:10000,0,0,0,0,0"/>
            <Option name="offset_along_line_unit" type="QString" value="MapUnit"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:10000,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
          ...
          <prop k="interval_map_unit_scale" v="3x:10000,0,0,0,0,0"/>
          <prop k="interval_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="6"/>
          <prop k="offset_along_line_map_unit_scale" v="3x:10000,0,0,0,0,0"/>
          <prop k="offset_along_line_unit" v="MapUnit"/>
          <prop k="offset_map_unit_scale" v="3x:10000,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="4.5;3"/>
            <Option name="customdash_map_unit_scale" type="QString" value="3x:10000,0,0,0.03,0,0"/>
            <Option name="customdash_unit" type="QString" value="MapUnit"/>
            <Option name="dash_pattern_offset" type="QString" value="0"/>
            <Option name="dash_pattern_offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="if(try(to_string(&quot;idJednostkiEwid&quot;)) is null, '', try(to_string(&quot;idJednostkiEwid&quot;)))&#xa;+' '+if(try(to_string(&quot;nazwaWlasna&quot;)) is null, '', try(to_string(&quot;nazwaWlasna&quot;)))&#xa;" legendString="Aa" fontSize="7.2915999999999999" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
        <families/>
