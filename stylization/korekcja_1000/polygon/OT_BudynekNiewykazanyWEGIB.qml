...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{7414ebb7-f1e0-42f3-a0f4-e05c769d8eb2}">
      <rule key="{467292b4-fd38-412c-8be2-10862463fb7e}" filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )">
      ...
      <rule key="{10d44f85-2d53-4ef1-a952-d5ceb8d16cbf}" filter="try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 ">
        <settings calloutType="simple">
