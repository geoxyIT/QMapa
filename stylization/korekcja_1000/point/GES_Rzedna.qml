...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="fillColor" type="Map">
                  ...
                  <Option name="expression" value="&quot;color&quot;" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{1a52940d-291d-4113-81a0-283b9a6234b6}">
      <rule key="{a19fbbf0-30ed-496f-b4f0-07eaa96d84ef}" description="rzedna" filter=" try(&quot;rzedna&quot;) is not null">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="format_number(&quot;rzedna&quot;,2,'en')" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normal" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.5625" allowHtml="0" textColor="0,0,0,255">
            <families/>
      ...
      <rule key="{66fa733e-9fb6-4ad4-9143-f5791d1f1e81}" description="rzedna" filter=" try(&quot;rzednaGory&quot;) is not null or  try(&quot;rzednaDolu&quot;) is not null">
        <settings calloutType="simple">
              ...
              <symbol alpha="1" clip_to_extent="1" name="fillSymbol" force_rhr="0" type="fill">
                ...
                <layer pass="0" class="LinePatternFill" enabled="1" locked="0">
                  <Option type="Map">
                    ...
                    <Option name="offset" value="-0.18" type="QString"/>
                    <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
          ...
          <text-format multilineAlign="0" addDirectionSymbol="0" plussign="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" leftDirectionSymbol="&lt;" wrapChar="" reverseDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" decimals="3"/>
          <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" fitInPolygonOnly="0" lineAnchorClipping="0" layerType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" quadOffset="5" geometryGeneratorEnabled="0" placementFlags="9" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" lineAnchorType="0" polygonPlacementFlags="2" xOffset="0" offsetType="0" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistance="0" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" offsetUnits="MM" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" distUnits="MM" placement="1" centroidWhole="0" rotationAngle="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" yOffset="0"/>
          <rendering obstacleType="1" unplacedVisibility="0" maxNumLabels="2000" fontLimitPixelSize="0" scaleMax="0" labelPerPart="0" upsidedownLabels="0" fontMaxPixelSize="10000" zIndex="0" scaleVisibility="0" minFeatureSize="0" fontMinPixelSize="3" displayAll="1" limitNumLabels="0" obstacleFactor="1" drawLabels="1" obstacle="1" mergeLines="0" scaleMin="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;rzedna&quot;" actionWidgetStyle="dropDown">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField index="-1" name="fid" showLabel="1"/>
    <attributeEditorField index="-1" name="fid" showLabel="1"/>
    <attributeEditorField index="-1" name="relacja" showLabel="1"/>
    <attributeEditorField index="-1" name="lokalnyId" showLabel="1"/>
    <attributeEditorField index="-1" name="wersjaId" showLabel="1"/>
    <attributeEditorField index="-1" name="startObiekt" showLabel="1"/>
    <attributeEditorField index="-1" name="rzednaDolu" showLabel="1"/>
    <attributeEditorField index="-1" name="rzednaGory" showLabel="1"/>
    <attributeEditorField index="-1" name="numerOperatu" showLabel="1"/>
    <attributeEditorField index="-1" name="rzedna" showLabel="1"/>
    <attributeEditorField index="-1" name="startWersjaObiekt" showLabel="1"/>
    <attributeEditorField index="-1" name="zrodlo" showLabel="1"/>
    <attributeEditorField index="-1" name="przestrzenNazw" showLabel="1"/>
    <attributeEditorField index="-1" name="gml_id" showLabel="1"/>
    <attributeEditorRelation nmRelationId="" name="" showLabel="1" forceSuppressFormPopup="0" relationWidgetTypeId="relation_editor" label="" relation="">
