...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule symbol="0" key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}" filter="rodzajUrzadzenia = 'u'" label="urządzenie techniczne sieci specjalnej"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{eae26ec8-dc0b-4a88-91ea-32a5e9086a48}">
      <rule key="{914815e1-7966-46d9-8ef6-df1bfe30a935}" description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{7c1a49e4-4bc4-4bb6-8d93-4e8e6d810b27}" description="projektowane" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
