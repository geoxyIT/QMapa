...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule symbol="0" key="{85a48275-aa05-4a9c-93f7-ddf9203de79a}" filter="rodzajUrzadzenia = 'u'" label="kanalizacyjne urządzenie techniczne"/>
      <rule symbol="1" key="{72f23876-434c-4c64-b35c-93cea5088203}" filter="rodzajUrzadzenia = 'l'" label="odwodnienie liniowe"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="HashLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="interval" value="0.525" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{af04cc24-549c-4393-983c-f89abc148c50}">
      <rule key="{7288d499-813d-4143-8900-3233a9a620f3}" description="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{6666f761-9567-4781-a34f-629d64247795}" description="projektowane" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
