...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{8cd897ec-5fa2-4698-8396-8beac0a50b02}">
      <rule symbol="0" key="{4b91d97a-1dbd-4bf2-a89a-cc4671cd8385}" filter="rodzajObiektu = 'i'" label="inny obiekt związany z wodą"/>
      <rule symbol="1" key="{4e4c491f-fa89-4750-9d05-86c996a282bf}" filter="rodzajObiektu = 'm'" label="rów melioracyjny"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a52e64d4-a9f2-49cd-a5d4-abde4e195a2c}">
      <rule key="{9dc57369-a7c5-48bb-9905-a311f1025cab}" description="rów melioracyjny" filter="rodzajObiektu = 'm'">
