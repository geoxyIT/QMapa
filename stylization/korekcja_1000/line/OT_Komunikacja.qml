...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{c87c7111-3f19-4465-850a-18b01e6dc805}">
      <rule symbol="0" key="{9a770a83-6641-4694-8258-068d729f4a1f}" filter="rodzajObiektu = 'k'" label="krawężnik"/>
      <rule symbol="1" key="{97849d9e-1b38-4533-ba4f-51a39181082a}" filter="rodzajObiektu = 'r'" label="rów przydrożny"/>
      <rule symbol="2" key="{6977910c-9fd4-444b-b548-1bea8fde5ac1}" filter="rodzajObiektu = 'z'" label="przepust"/>
      <rule symbol="3" key="{77bb9f02-2d11-43b9-bd94-e5d988df5207}" filter="rodzajObiektu = 'b'" label="bariera ochronna"/>
      <rule symbol="4" key="{011262d7-b494-42d7-8457-2656a65ba28a}" filter="rodzajObiektu = 'y'" label="ekran akustyczny"/>
      <rule symbol="5" key="{94367d1f-22e9-4901-aca9-0ad4edc2b35e}" filter="rodzajObiektu = 't'" label="tor"/>
      <rule symbol="6" key="{2459b0a4-eed8-4322-95a4-5234315e8eb0}" filter="rodzajObiektu = 'l'" label="kolej linowa"/>
      <rule symbol="7" key="{8fe03f10-852f-4512-ab38-3646e1420e11}" filter="rodzajObiektu = 'i'" label="inny obiekt komunikacyjny"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b7dcf1c4-908c-459b-b50e-cc99422ee19d}">
      <rule key="{b2c53fc5-bc20-4a61-9eff-6c7fdbed8b86}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
      ...
      <rule key="{bfbc19f9-4289-4b9a-a2ee-de84a21bc4a7}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="rodzajNawierzchni" type="field" hidden="0" width="-1"/>
      <column name="polozenie" type="field" hidden="0" width="-1"/>
