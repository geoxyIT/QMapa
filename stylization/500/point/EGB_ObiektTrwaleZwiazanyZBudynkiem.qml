...
<qgis simplifyLocal="1" simplifyAlgorithm="0" symbologyReferenceScale="-1" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyMaxScale="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" readOnly="0">
  <flags>
  ...
  <temporal durationField="" enabled="0" startField="" startExpression="" durationUnit="min" fixedDuration="0" accumulate="0" mode="0" limitMode="0" endExpression="" endField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0" referencescale="-1">
    <rules key="{3fbdb05d-2225-448a-9af4-5102af2410a6}">
      <rule key="{bfb1ab0e-b2ab-4e4a-bd5c-a41b890e5f83}" symbol="0" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'o'"/>
    </rules>
    <symbols>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory rotationOffset="270" spacing="5" penColor="#000000" minScaleDenominator="0" enabled="0" lineSizeType="MM" spacingUnitScale="3x:0,0,0,0,0,0" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" maxScaleDenominator="1e+08" height="15" spacingUnit="MM" scaleBasedVisibility="0" opacity="1" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" showAxis="1" labelPlacementMethod="XHeight" backgroundAlpha="255" barWidth="5" minimumSize="0" penWidth="0" diagramOrientation="Up" direction="0" width="15" sizeType="MM">
  ...
  <DiagramLayerSettings dist="0" zIndex="0" priority="0" placement="0" linePlacementFlags="18" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="idPunktu"/>
    <default applyOnUpdate="0" expression="" field="sposobPozyskania"/>
    <default applyOnUpdate="0" expression="" field="spelnienieWarunkowDokl"/>
    <default applyOnUpdate="0" expression="" field="rodzajStabilizacji"/>
    <default applyOnUpdate="0" expression="" field="oznWMaterialeZrodlowym"/>
    <default applyOnUpdate="0" expression="" field="numerOperatuTechnicznego"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="gml_id" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="lokalnyId" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="przestrzenNazw" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="wersjaId" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="startObiekt" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="startWersjaObiekt" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="idPunktu" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="sposobPozyskania" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="spelnienieWarunkowDokl" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="rodzajStabilizacji" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="oznWMaterialeZrodlowym" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="numerOperatuTechnicznego" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="prezentacja_etykiety" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="idPunktu" desc=""/>
    <constraint exp="" field="sposobPozyskania" desc=""/>
    <constraint exp="" field="spelnienieWarunkowDokl" desc=""/>
    <constraint exp="" field="rodzajStabilizacji" desc=""/>
    <constraint exp="" field="oznWMaterialeZrodlowym" desc=""/>
    <constraint exp="" field="numerOperatuTechnicznego" desc=""/>
    <constraint exp="" field="prezentacja_etykiety" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="startObiekt" hidden="0" type="field" width="-1"/>
      <column name="startWersjaObiekt" hidden="0" type="field" width="-1"/>
      <column name="idPunktu" hidden="0" type="field" width="-1"/>
      <column name="sposobPozyskania" hidden="0" type="field" width="-1"/>
      <column name="spelnienieWarunkowDokl" hidden="0" type="field" width="-1"/>
      <column name="rodzajStabilizacji" hidden="0" type="field" width="-1"/>
      <column name="oznWMaterialeZrodlowym" hidden="0" type="field" width="-1"/>
      <column name="numerOperatuTechnicznego" hidden="0" type="field" width="-1"/>
      <column name="prezentacja_etykiety" hidden="0" type="field" width="-1"/>
