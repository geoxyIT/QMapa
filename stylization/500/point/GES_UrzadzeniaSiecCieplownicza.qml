...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" minScale="100000000" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule symbol="0" label="ciepłownicze urządzenie techniczne" key="{a602ef9e-0c53-4ec5-abfb-f92c872da368}" filter="rodzajUrzadzenia = 'u'"/>
      <rule symbol="1" label="zasuwa, zawór" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}" filter="rodzajUrzadzenia = 'w'"/>
    </rules>
    <symbols>
      <symbol type="marker" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="210,0,210,255"/>
            ...
            <Option type="QString" name="outline_color" value="210,0,210,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{533c5735-2ea0-4233-ab4d-e58077a1400b}">
      <rule key="{13b25de7-83c1-43e6-9b0e-8aa7d88002bd}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="ciepłownicze urządzenie techniczne">
        <settings calloutType="simple">
          <text-style fontSize="1.0417000000000001" blendMode="0" fontWeight="50" fontWordSpacing="0" textOpacity="1" legendString="Aa" fieldName="'c'" isExpression="1" fontUnderline="0" fontItalic="0" namedStyle="Normal" capitalization="0" fontLetterSpacing="0" textOrientation="horizontal" fontKerning="1" fontSizeUnit="MapUnit" fontStrikeout="0" allowHtml="0" useSubstitutions="0" textColor="210,0,210,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontFamily="Arial">
            <families/>
      ...
      <rule key="{37a7c1c9-b172-49a7-86b3-b052c67d7a8f}" filter=" try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
          <text-style fontSize="1.0417000000000001" blendMode="0" fontWeight="50" fontWordSpacing="0" textOpacity="1" legendString="Aa" fieldName="'proj.c'" isExpression="1" fontUnderline="0" fontItalic="0" namedStyle="Normal" capitalization="0" fontLetterSpacing="0" textOrientation="horizontal" fontKerning="1" fontSizeUnit="MapUnit" fontStrikeout="0" allowHtml="0" useSubstitutions="0" textColor="210,0,210,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontFamily="Arial">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskType="0" maskOpacity="1" maskSize="1.5"/>
            <background shapeSizeUnit="MM" shapeJoinStyle="64" shapeOffsetY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeBlendMode="0" shapeOffsetX="0" shapeSizeType="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeSizeX="0" shapeRadiiX="0" shapeType="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeBorderColor="128,128,128,255" shapeDraw="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeBorderWidth="0" shapeSVGFile="">
  ...
  <aliases>
    ...
    <alias field="eksploatacja" name="" index="9"/>
    <alias field="informacjaDodatkowa" name="" index="10"/>
    <alias field="rodzajUrzadzenia" name="" index="11"/>
    <alias field="prezentacja_etykiety" name="" index="12"/>
    <alias field="numerOperatu" name="" index="13"/>
    <alias field="GES_PrezentacjaGraficzna_0_fid" name="" index="14"/>
    <alias field="GES_PrezentacjaGraficzna_0_gml_id" name="" index="15"/>
    <alias field="GES_PrezentacjaGraficzna_0_katObrotu" name="" index="16"/>
  </aliases>
  <defaults>
