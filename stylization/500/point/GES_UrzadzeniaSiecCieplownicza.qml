...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      ...
      <rule symbol="1" key="{d0146c8d-e75e-49d0-a82e-f14b7a037dff}" label="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{20e60e8b-6d4b-4a9c-8c8d-16d4f59bcc5b}">
      <rule description="ciepłownicze urządzenie techniczne" key="{0db6d9b9-efd5-4267-8438-98c9b242adb1}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{dd8ba5aa-4bb6-4692-8b72-c10a480135ea}" filter=" try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
