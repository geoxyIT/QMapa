...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      <rule filter="rodzajUrzadzenia = 'w'" key="{16a067d8-738d-43d4-8bce-fe3b47fbb02a}" symbol="0" label="zasuwa, zawór"/>
      <rule filter="rodzajUrzadzenia = 'u'" key="{d0146c8d-e75e-49d0-a82e-f14b7a037dff}" symbol="1" label="ciepłownicze urządzenie techniczne"/>
      ...
      <symbol name="0" force_rhr="0" type="marker" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="210,0,210,255"/>
            ...
            <Option name="outline_color" type="QString" value="210,0,210,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{19e4c970-571f-4281-98b9-b6271f65450a}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{259d32c0-693e-4ac4-9ccc-d61a12c007df}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is 'p'" key="{5440ecb8-0bd0-4f8d-94a2-25f4533e8847}">
        <settings calloutType="simple">
