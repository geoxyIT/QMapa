...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{bdb8c3e3-6c92-4ee7-91fe-b2e6b3202371}">
      ...
      <rule label="ciepłownicze urządzenie techniczne" symbol="1" key="{d0146c8d-e75e-49d0-a82e-f14b7a037dff}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{20e60e8b-6d4b-4a9c-8c8d-16d4f59bcc5b}">
      <rule key="{0db6d9b9-efd5-4267-8438-98c9b242adb1}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="ciepłownicze urządzenie techniczne">
      ...
      <rule key="{dd8ba5aa-4bb6-4692-8b72-c10a480135ea}" filter=" try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
