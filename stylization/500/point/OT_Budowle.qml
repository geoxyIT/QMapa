...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule label="podpora" symbol="0" filter="rodzajBudowli = 'd'" key="{d7bc3e94-ba73-4ae0-89c0-773305cd2286}"/>
      <rule label="figura, krzyż" symbol="1" filter="rodzajBudowli = 'f'" key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}"/>
      <rule label="fontanna" symbol="2" filter="rodzajBudowli = 't'" key="{5bfb9cf4-4a0c-4e1f-8cb1-e7f01fd0d131}"/>
      <rule label="pomnik" symbol="3" filter="rodzajBudowli = 'p'" key="{6c1ee31d-38b4-41ca-b6c1-c9553d391d64}"/>
      <rule label="inna budowla" symbol="4" filter="rodzajBudowli = 'i'" key="{6b012d7a-7a87-4d14-9616-4283d0cda50d}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" name="1" type="marker" clip_to_extent="1">
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="offset" type="QString" value="0,0.045"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:2500,0,0,0.03,0,0"/>
            ...
            <Option name="scale_method" type="QString" value="diameter"/>
            <Option name="size" type="QString" value="1.00541"/>
            <Option name="size_map_unit_scale" type="QString" value="3x:2500,0,0,0.03,0,0"/>
            <Option name="size_unit" type="QString" value="MapUnit"/>
      ...
      <symbol force_rhr="0" alpha="1" name="2" type="marker" clip_to_extent="1">
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="offset" type="QString" value="0,-0.75"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:2500,0,0,0.03,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
            <Option name="outline_color" type="QString" value="0,0,0,255"/>
            <Option name="outline_width" type="QString" value="0"/>
            ...
            <Option name="parameters"/>
            <Option name="scale_method" type="QString" value="diameter"/>
            <Option name="size" type="QString" value="1.79504"/>
            <Option name="size_map_unit_scale" type="QString" value="3x:2500,0,0,0.03,0,0"/>
            <Option name="size_unit" type="QString" value="MapUnit"/>
            <Option name="vertical_anchor_point" type="QString" value="1"/>
          </Option>
  ...
  <labeling type="rule-based">
    <rules key="{8d4d4eb4-a910-4d8b-9bd6-521586aef101}">
      <rule filter="rodzajBudowli = 'i'" key="{31f72e48-e8a8-4f60-a82e-d3666bcb277b}" description="inna budowla">
        <settings calloutType="simple">
          ...
          <placement rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" overrunDistance="0" dist="0" placement="1" preserveRotation="1" geometryGenerator="" repeatDistance="0" lineAnchorPercent="0.5" placementFlags="10" layerType="PointGeometry" centroidWhole="0" offsetType="1" fitInPolygonOnly="0" priority="5" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" polygonPlacementFlags="2" lineAnchorType="0" quadOffset="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0"/>
