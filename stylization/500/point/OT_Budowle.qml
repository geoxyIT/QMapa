...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule filter="rodzajBudowli = 'f'" symbol="0" key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}" label="figura, krzyż"/>
      <rule filter="rodzajBudowli = 't'" symbol="1" key="{5bfb9cf4-4a0c-4e1f-8cb1-e7f01fd0d131}" label="fontanna"/>
      <rule filter="rodzajBudowli = 'p'" symbol="2" key="{6c1ee31d-38b4-41ca-b6c1-c9553d391d64}" label="pomnik"/>
      <rule filter="rodzajBudowli = 'd'" symbol="3" key="{3b1e6246-3baf-4933-934d-5afd4f49bc21}" label="podpora"/>
      <rule filter="rodzajBudowli = 'i'" symbol="4" key="{6b012d7a-7a87-4d14-9616-4283d0cda50d}" label="inna budowla"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias name="" index="9" field="rodzajBudowli"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="rodzajBudowli" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="rodzajBudowli"/>
