...
<qgis simplifyDrawingTol="1" maxScale="0" version="3.24.2-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingHints="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule symbol="0" filter="rodzajBudowli = 'd'" label="podpora" key="{d7bc3e94-ba73-4ae0-89c0-773305cd2286}"/>
      <rule symbol="1" filter="rodzajBudowli = 'f'" label="figura, krzyż" key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}"/>
      <rule symbol="2" filter="rodzajBudowli = 't'" label="fontanna" key="{5bfb9cf4-4a0c-4e1f-8cb1-e7f01fd0d131}"/>
      <rule symbol="3" filter="rodzajBudowli = 'p'" label="pomnik" key="{6c1ee31d-38b4-41ca-b6c1-c9553d391d64}"/>
      <rule symbol="4" filter="rodzajBudowli = 'i'" label="inna budowla" key="{6b012d7a-7a87-4d14-9616-4283d0cda50d}"/>
    </rules>
    <symbols>
    ...
    <rules key="{8d4d4eb4-a910-4d8b-9bd6-521586aef101}">
      <rule filter="rodzajBudowli = 'i'" description="inna budowla" key="{31f72e48-e8a8-4f60-a82e-d3666bcb277b}">
        <settings calloutType="simple">
          ...
          <placement quadOffset="1" rotationUnit="AngleDegrees" lineAnchorType="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" polygonPlacementFlags="2" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" yOffset="0" priority="5" centroidWhole="0" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" lineAnchorClipping="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" preserveRotation="1" maxCurvedCharAngleOut="-25" repeatDistance="0" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" centroidInside="0" offsetType="1" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" layerType="PointGeometry" fitInPolygonOnly="0" xOffset="0" rotationAngle="0" placement="1" geometryGenerator=""/>
