...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{1a7128c2-c115-407b-8c89-902497ea4929}">
      <rule filter="rodzajBudowli = 'd'" key="{d7bc3e94-ba73-4ae0-89c0-773305cd2286}" symbol="0" label="podpora"/>
      <rule filter="rodzajBudowli = 'f'" key="{c9e30caa-ea9b-4005-b682-ffbb6cf3ac95}" symbol="1" label="figura, krzyż"/>
      <rule filter="rodzajBudowli = 't'" key="{5bfb9cf4-4a0c-4e1f-8cb1-e7f01fd0d131}" symbol="2" label="fontanna"/>
      <rule filter="rodzajBudowli = 'p'" key="{6c1ee31d-38b4-41ca-b6c1-c9553d391d64}" symbol="3" label="pomnik"/>
      <rule filter="rodzajBudowli = 'i'" key="{6b012d7a-7a87-4d14-9616-4283d0cda50d}" symbol="4" label="inna budowla"/>
  ...
  <labeling type="rule-based">
    <rules key="{3f3b623f-d486-4def-bf41-c64fcfbf8959}">
      <rule description="inna budowla" filter="rodzajBudowli = 'i'" key="{40f1dd2c-1d98-418f-90af-697c451c62ef}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontSize="1.0417000000000001" blendMode="0" fontFamily="Arial" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontSizeUnit="MapUnit" allowHtml="0" useSubstitutions="0" multilineHeight="1" fontKerning="1" fieldName="'ib'" legendString="Aa" fontWeight="50" textColor="0,0,0,255" fontSizeMapUnitScale="3x:2500,0,0,0,0,0" fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="1" capitalization="0" fontWordSpacing="0" fontStrikeout="0">
            <families/>
          ...
          <placement dist="0" preserveRotation="1" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" placement="1" centroidInside="0" offsetType="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" maxCurvedCharAngleOut="-25" lineAnchorType="0" quadOffset="1" xOffset="0" distUnits="MM" priority="5" centroidWhole="0" overrunDistance="0" rotationUnit="AngleDegrees" rotationAngle="0" geometryGeneratorEnabled="0" offsetUnits="MapUnit" yOffset="0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" layerType="PointGeometry"/>
