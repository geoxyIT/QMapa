...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" enableorderby="0" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{40d7649d-368e-4a18-840d-65ceca156f28}">
      <rule description="rzedna" filter=" try(&quot;rzedna&quot;) is not null" key="{f171014d-3c43-4a09-9c74-0d2aa873c923}">
      ...
      <rule description="rzedna" filter=" try(&quot;rzednaGory&quot;) is not null or  try(&quot;rzednaDolu&quot;) is not null" key="{ae68424d-0778-4a50-b15a-cc116839470f}">
        <settings calloutType="simple">
