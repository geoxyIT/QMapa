...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" minScale="100000000" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
    <rules key="{c81fa3aa-0a41-4f24-b1fe-a5b7d58c047f}">
      <rule symbol="0" label="gazowe urządzenie techniczne" key="{fd7c2466-7db1-4c06-a668-89d1ef35af31}" filter="rodzajUrzadzenia = 'u'"/>
      <rule symbol="1" label="zasuwa, zawór" key="{01570c97-ecac-4408-b800-9111152377b7}" filter="rodzajUrzadzenia = 'w'"/>
      <rule symbol="2" label="szafa gazowa, kontener" key="{12025034-7b2a-4531-8718-197a864a8b6d}" filter="rodzajUrzadzenia = 's'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{63d00641-6333-4cda-9c6f-a7d1fdd69b18}">
      <rule key="{4c11d52a-5d9b-4c85-a92e-3a32019ac9eb}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="gazowe urządzenie techniczne">
      ...
      <rule key="{8f98e4a7-6a7e-4c1e-b688-3856f842d5e7}" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" description="zasuwa, zawór">
        <settings calloutType="simple">
          <text-style fontSize="1.0417000000000001" blendMode="0" fontWeight="50" fontWordSpacing="0" textOpacity="1" legendString="Aa" fieldName="'g'" isExpression="1" fontUnderline="0" fontItalic="0" namedStyle="Normal" capitalization="0" fontLetterSpacing="0" textOrientation="horizontal" fontKerning="1" fontSizeUnit="MapUnit" fontStrikeout="0" allowHtml="0" useSubstitutions="0" textColor="191,191,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontFamily="Arial">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
      ...
      <rule key="{b28a6442-aa05-4561-9915-9fa1d678fdfd}" filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="szafa gazowa, kontener">
        <settings calloutType="simple">
          <text-style fontSize="1.0417000000000001" blendMode="0" fontWeight="50" fontWordSpacing="0" textOpacity="1" legendString="Aa" fieldName="'g'" isExpression="1" fontUnderline="0" fontItalic="0" namedStyle="Normal" capitalization="0" fontLetterSpacing="0" textOrientation="horizontal" fontKerning="1" fontSizeUnit="MapUnit" fontStrikeout="0" allowHtml="0" useSubstitutions="0" textColor="191,191,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontFamily="Arial">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
      ...
      <rule key="{d669cad1-c9d5-4539-b703-f28a0234a033}" filter=" try(&quot;status&quot;) is  'p'" description="projektowane">
        <settings calloutType="simple">
