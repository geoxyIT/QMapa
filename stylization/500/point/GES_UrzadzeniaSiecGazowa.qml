...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{c81fa3aa-0a41-4f24-b1fe-a5b7d58c047f}">
      ...
      <rule label="gazowe urządzenie techniczne" symbol="2" filter="rodzajUrzadzenia = 'u'" key="{89794b8a-5086-42e5-895c-6418849e1f63}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{eb150e30-0f00-45ca-b939-70162c1a19a4}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{f2d39d03-5d95-4799-a971-252bce7fce2d}" description="gazowe urządzenie techniczne">
      ...
      <rule filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" key="{514a3e94-3f87-4255-adde-419aebe08709}" description="zasuwa, zawór">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="191,191,0,255" fieldName="'g'" legendString="Aa" fontSize="1.0417000000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" key="{43d2f4a4-865c-468b-8eb0-29ae76c8b145}" description="szafa gazowa, kontener">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="191,191,0,255" fieldName="'g'" legendString="Aa" fontSize="1.0417000000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" key="{7c7e85f3-30c1-484d-88ea-84d3721f1d94}" description="projektowane">
        <settings calloutType="simple">
