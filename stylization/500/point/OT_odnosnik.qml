...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1">
  ...
  <constraints>
    <constraint constraints="0" field="x" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="y" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  ...
  <expressionfields>
    <field subType="0" precision="0" type="6" comment="" length="0" expression="$x" name="x" typeName=""/>
    <field subType="0" precision="0" type="6" comment="" length="0" expression="$y" name="y" typeName=""/>
  </expressionfields>
  <attributeactions>
