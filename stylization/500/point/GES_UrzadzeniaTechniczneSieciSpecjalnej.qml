...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{f9aa7c73-2d4e-48d7-ae57-9949dc025034}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{3fe85785-6498-495e-9f0f-2584fd56afef}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{b2072ae3-5d50-40b0-9d95-01175a285d1b}">
        <settings calloutType="simple">
