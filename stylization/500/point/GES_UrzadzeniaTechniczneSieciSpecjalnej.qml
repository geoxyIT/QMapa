...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule label="urządzenie techniczne sieci specjalnej" symbol="0" filter="rodzajUrzadzenia = 'u'" key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{150d3f0d-9834-42f4-8d19-754b9350e8b5}">
      <rule filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{1936bc97-c778-4fe7-9da3-0c23ccd2941c}" description="urządzenie techniczne sieci specjalnej">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{d7d256ef-bb0f-49ff-9742-9e4e166fa068}" description="projektowane">
        <settings calloutType="simple">
