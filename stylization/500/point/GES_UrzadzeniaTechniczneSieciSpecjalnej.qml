...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{71421841-109f-4129-aa05-750b9999b298}">
      <rule symbol="0" key="{c0d32b3e-1258-46ec-8188-acebf1d7c8a5}" label="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{150d3f0d-9834-42f4-8d19-754b9350e8b5}">
      <rule description="urządzenie techniczne sieci specjalnej" key="{1936bc97-c778-4fe7-9da3-0c23ccd2941c}" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{d7d256ef-bb0f-49ff-9742-9e4e166fa068}" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
