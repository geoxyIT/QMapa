...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{32f788af-992b-4f2b-8160-89f613b99043}">
      <rule filter="rodzajUrzadzenia = 'u'" symbol="0" label="urządzenie techniczne sieci specjalnej" key="{f157d857-feb4-4b34-b01a-16cb64b42f1a}"/>
      <rule filter="ELSE" symbol="1" label="nieoznaczone" key="{187d5296-b0ed-4226-b3bc-f5e5a731ce8c}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d04bb58a-a950-48aa-9442-918510df75a1}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{91b98d9c-e771-41a4-800c-e0e663e35534}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{e1f8147c-31b9-4675-acee-7abc04b748e8}">
        <settings calloutType="simple">
