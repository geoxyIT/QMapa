...
<qgis simplifyDrawingHints="0" maxScale="0" version="3.24.0-Tisler" simplifyDrawingTol="1" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <labeling type="rule-based">
    <rules key="{40e31d29-95c6-4da4-9b5b-980e80667b07}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="kanalizacyjne urządzenie techniczne" key="{840c14bb-e3b2-4573-90d4-79b32f817998}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="128,51,0,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'k'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="1.0417000000000001" textOrientation="horizontal" fontWeight="50">
            <families/>
      ...
      <rule filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" description="zasuwa, zawór " key="{d286eb2f-f8a5-483a-8740-0d872033f3dd}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="128,51,0,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'k'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="1.0417000000000001" textOrientation="horizontal" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="0"/>
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" description="studnia kanalizacyjna" key="{5a1285a4-9c32-4c8e-87ce-428b04f48af0}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="128,51,0,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'k'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="1.0417000000000001" textOrientation="horizontal" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="0"/>
      ...
      <rule filter="rodzajUrzadzenia = 'm' and try(&quot;status&quot;) is not 'p'" description="osadnik, szambo" key="{41fca2c2-5f71-4d06-8319-4d717f4e2be8}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="128,51,0,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'kl'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="1.0417000000000001" textOrientation="horizontal" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="0"/>
            <text-mask maskJoinStyle="128" maskSize="1.5" maskType="0" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderColor="128,128,128,255" shapeJoinStyle="64" shapeDraw="0" shapeSizeX="0" shapeSizeType="0" shapeFillColor="255,255,255,255" shapeOffsetUnit="MM" shapeBorderWidth="0" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiY="0" shapeSizeUnit="MM" shapeOffsetY="0" shapeRotation="0" shapeRotationType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1">
      ...
      <rule filter=" try(&quot;status&quot;) is  'p'" description="projektowane" key="{37fe2943-9b8e-4614-b54b-964bc567d4ea}">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" textColor="128,51,0,255" fontLetterSpacing="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="1" fontSizeUnit="MapUnit" useSubstitutions="0" multilineHeight="1" fieldName="'proj.k'" blendMode="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Arial" namedStyle="Normal" fontSize="1.0417000000000001" textOrientation="horizontal" fontWeight="50">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="0"/>
            <text-mask maskJoinStyle="128" maskSize="1.5" maskType="0" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeBorderColor="128,128,128,255" shapeJoinStyle="64" shapeDraw="0" shapeSizeX="0" shapeSizeType="0" shapeFillColor="255,255,255,255" shapeOffsetUnit="MM" shapeBorderWidth="0" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiY="0" shapeSizeUnit="MM" shapeOffsetY="0" shapeRotation="0" shapeRotationType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1">
