...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" minScale="100000000" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
    <rules key="{9f530e0e-244c-48ba-822a-3168ce469f49}">
      <rule symbol="0" label="komora podziemna" key="{c28c6b4f-7d62-48b8-8613-7b7120a5882d}" filter="rodzajUrzadzenia = 'k'"/>
      <rule symbol="1" label="właz do komory, kanału bez kształtu" key="{5612aaff-a2ed-4791-80e2-8a6f787cbccb}" filter="rodzajUrzadzenia = 'w' and &quot;ksztaltUrzadzenia&quot; is NULL"/>
      <rule symbol="2" label="właz do komory, kanału o" key="{ddec7177-5dca-4647-97d1-9f16201ff860}" filter="rodzajUrzadzenia = 'w' and &quot;ksztaltUrzadzenia&quot; = 'o'"/>
      <rule symbol="3" label="właz do komory, kanału kw" key="{ae106302-3fe3-4e5e-82d4-4ff77b799b51}" filter="rodzajUrzadzenia = 'w' and &quot;ksztaltUrzadzenia&quot; = 'k'"/>
      <rule symbol="4" label="właz do komory, kanału pros" key="{16b8d36c-ff04-4628-80b7-1d50eba37772}" filter="rodzajUrzadzenia = 'w' and &quot;ksztaltUrzadzenia&quot; = 'p'"/>
      <rule symbol="5" label="słup przewodów napowietrznych" key="{91d61cb7-2c1b-450b-86d8-3695b5ab82b5}" filter="rodzajUrzadzenia = 'p' "/>
      <rule symbol="6" label="słup trakcyjny" key="{b495f3e0-92a8-4c3e-be8e-89761da99f47}" filter="rodzajUrzadzenia = 'y'"/>
      <rule symbol="7" label="podpora przewodów" key="{245ad9eb-2c66-44bf-9695-2f89f03e6091}" filter="rodzajUrzadzenia = 'n'"/>
    </rules>
    <symbols>
      ...
      <symbol type="marker" name="5" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="GeometryGenerator" locked="0" pass="0" enabled="1">
          ...
          <symbol type="line" name="@5@0" alpha="1" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{c4ef86c7-5134-4a1e-b382-8dea786573b6}">
      <rule key="{175f9d1f-9c9c-45d5-ab61-bcfcefba42c4}" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" description="właz do komory, kanału">
      ...
      <rule key="{8933781a-59b6-46fe-a8f8-e5a758a28d59}" filter="try(&quot;status&quot;) is  'p'" description="projektowane">
        <settings calloutType="simple">
