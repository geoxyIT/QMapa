...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{d50a75e2-5026-4791-bca6-d6918cdc5be0}">
      <rule symbol="0" label="urządzenie techniczne sieci niezidentyfikowanej" key="{db2f7260-fb61-4a65-9a81-7d946d731cff}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{be0ee865-51bb-4342-91e8-7fdf43377c02}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'" key="{66e4e274-b2a1-42b5-8b03-722100f70cb3}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{ba5fa336-d955-4df1-8001-12d90184e899}">
        <settings calloutType="simple">
