...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{e6a89679-538c-438e-8ac2-12f2ab26bc4c}">
      <rule filter="rodzajBloku = 'n'" key="{f8438921-ad6e-43be-984d-bbbee32158df}" symbol="0" label="kondygnacja nadziemna"/>
      <rule filter="rodzajBloku = 'p'" key="{a6be0aa1-4713-4565-b16c-f9d97fc8e798}" symbol="1" label="kondygnacja podziemna"/>
      <rule filter="rodzajBloku = 'l'" key="{06fee6e3-3b38-4b56-9bbb-9a5348402500}" symbol="2" label="łącznik"/>
      <rule filter="rodzajBloku = 'a'" key="{92b486d1-540a-4fbc-9c26-d6f1967b1cef}" symbol="3" label="nawis"/>
      <rule filter="rodzajBloku = 'z'" key="{d1b98d1c-f73e-4c79-b958-83af1b8159be}" symbol="4" label="przejazd przez budynek"/>
      <rule filter="rodzajBloku = 'y' and not try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1" key="{7b70cfe8-94d8-4db6-b810-383859e701fe}" symbol="5" label="inny nadziemny"/>
      <rule filter="rodzajBloku = 'y' and try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1" key="{d1b9990f-47c2-4a3e-b7a6-507a153a74c2}" symbol="6" label="inny podziemny"/>
