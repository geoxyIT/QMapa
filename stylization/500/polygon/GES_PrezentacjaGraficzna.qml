...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{c20c3221-2f03-4fda-8275-0aa42fb95573}">
      <rule key="{f58a02a1-51d5-4e8b-a08e-2cd1c0e1b2f7}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{14684174-a20e-4352-85ba-13f4a844d26e}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{c28a90e9-6f69-484f-9146-6fafed50c377}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{12854369-0100-4ec4-a472-20643d484eb7}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{710e4a83-d20a-4c37-9537-6334456fa4c9}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{97315a49-be2b-4940-8b6e-c8dca4a8a0f8}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{d9775c56-aa40-4b12-830d-4ac18bce8924}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{d0c2e39d-bdd7-48f4-82b2-1f414fe7b3e5}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
