...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{71582cbe-1e93-488f-89e9-bf554833455f}">
      <rule label="woda płynąca" symbol="0" key="{abd262f0-2c39-406a-b9b3-df9a46365db8}" filter="rodzajObiektu = 'p'"/>
      <rule label="woda stojąca" symbol="1" key="{7c8976f0-1b34-4e10-a7db-d3121faefe42}" filter="rodzajObiektu = 's'"/>
      <rule label="wal przeciwpowodziowy" symbol="2" key="{91c85476-d29e-465f-8e36-2dd231001cc0}" filter="rodzajObiektu = 'w'"/>
      <rule label="row melioracyjny" symbol="3" key="{1de5dcbc-2167-44d4-a92c-8b91a6a77764}" filter="rodzajObiektu = 'm'"/>
      <rule label="jaz" symbol="4" key="{989a9418-e9c4-4a38-9efc-7e3493323205}" filter="rodzajObiektu = 'j'"/>
      <rule label="śluza" symbol="5" key="{a45032ba-6bf8-492b-9ae9-73a3bb120dad}" filter="rodzajObiektu = 'l'"/>
      <rule label="grobla" symbol="6" key="{5a9d5ea5-0451-495a-874b-e1862da607bd}" filter="rodzajObiektu = 'g'"/>
      <rule label="zapora" symbol="7" key="{66bb1a4e-5b60-45dd-b8c4-ba6330bd611d}" filter="rodzajObiektu = 'z'"/>
      <rule label="ostroga" symbol="8" key="{7eea6079-e176-4928-8e4a-f48e7b59f0bd}" filter="rodzajObiektu = 't'"/>
      <rule label="pomost, molo" symbol="9" key="{9630ff64-f70f-4372-b921-e4b27899b092}" filter="rodzajObiektu = 'o'"/>
      <rule label="inny obiekt" symbol="10" key="{3b13d8b0-dfc3-4c23-9e93-df2c074807db}" filter="rodzajObiektu = 'i'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{80776532-8c41-47a5-be04-72253fc6158b}">
      ...
      <rule key="{efec7cc0-ed3a-4ebd-8097-15aaf4dd5fda}" filter="rodzajObiektu = 's'" description="woda stojąca">
        <settings calloutType="simple">
      ...
      <rule key="{4f732344-a48e-4702-904f-7e3971fdad72}" filter="rodzajObiektu = 'm'" description="rów melioracyjny">
        <settings calloutType="simple">
      ...
      <rule key="{0b275d6d-2eb8-4cdd-97d5-16b5e988a524}" filter="rodzajObiektu = 'j'" description="jaz">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.0417000000000001" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'jaz'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{fb004fb9-6a95-40ec-8965-0951d06a7ace}" filter="rodzajObiektu = 'l'" description="śluza">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.0417000000000001" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'śl'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{cc43663a-64b6-49c4-8691-3ed658bf24f3}" filter="rodzajObiektu = 'o'" description="pomost, molo">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontFamily="Arial" namedStyle="Normal" legendString="Aa" fontKerning="1" textColor="0,0,0,255" fontWeight="50" useSubstitutions="0" fontLetterSpacing="0" fontSize="1.0417000000000001" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontStrikeout="0" isExpression="1" fontItalic="0" fieldName="'molo'" textOpacity="1" multilineHeight="1" fontSizeUnit="MapUnit" fontWordSpacing="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" capitalization="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskOpacity="1"/>
            <background shapeRotation="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeDraw="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeSizeY="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeOpacity="1" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;obliczona_geometria_1000&quot;">
    <columns>
      ...
      <column type="field" hidden="0" name="obliczona_geometria_500" width="145"/>
      <column type="field" hidden="0" name="obliczona_geometria_1000" width="-1"/>
      <column type="field" hidden="0" name="OT_PrezentacjaGraficzna_0_gml_id" width="-1"/>
      <column type="field" hidden="0" name="OT_PrezentacjaGraficzna_0_katObrotu" width="-1"/>
      <column type="field" hidden="0" name="numerOperatu" width="-1"/>
      <column type="field" hidden="0" name="nazwaWlasna" width="-1"/>
      <column type="field" hidden="0" name="dataPrzyjeciaDoZasobu" width="-1"/>
