...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{4937f69e-2908-4148-bb7e-f5d930d3e038}">
      <rule filter="&quot;status&quot; = 'i' and not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNaziemnych&quot;)&lt;1 )" key="{45fc6522-a391-4cde-981c-f04936bba46c}" symbol="0" label="budynek naziemny"/>
      <rule filter="&quot;status&quot; = 'i' and (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" key="{5eb3bb01-e268-4988-89b8-3e740d8014c3}" symbol="1" label="budynek podziemny"/>
      <rule filter="status = 'b'" key="{24120ac1-4524-4590-8454-cc8c83f69a61}" symbol="2" label="budynek w budowie"/>
  ...
  <labeling type="rule-based">
    <rules key="{ea9d713d-3e8d-4f29-a535-4f9064edcc10}">
      ...
      <rule filter="try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 " key="{53ea9ec5-412b-4330-8ce9-1fb4c1146270}">
        <settings calloutType="simple">
