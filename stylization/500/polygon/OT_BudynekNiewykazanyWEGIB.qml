...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{4937f69e-2908-4148-bb7e-f5d930d3e038}">
      <rule filter="&quot;status&quot; = 'i' and not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNaziemnych&quot;)&lt;1 )" symbol="0" label="budynek naziemny" key="{45fc6522-a391-4cde-981c-f04936bba46c}" />
      <rule filter="&quot;status&quot; = 'i' and (try(&quot;liczbaKondygnacjiPodziemnych&quot;)&gt;0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )" symbol="1" label="budynek podziemny" key="{5eb3bb01-e268-4988-89b8-3e740d8014c3}" />
      <rule filter="status = 'b'" symbol="2" label="budynek w budowie" key="{24120ac1-4524-4590-8454-cc8c83f69a61}" />
