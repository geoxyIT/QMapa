...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{10008f7c-e739-4cb9-8d4a-8571f9ea12ba}">
      <rule key="{3ea5231c-c126-410e-895a-7fdc7bfe9a2e}" filter="not (try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 )">
      ...
      <rule key="{88a79324-9b14-4cf6-a156-40dc1aa78b1c}" filter="try(&quot;liczbaKondygnacjiPodziemnych&quot;)>0 and try(&quot;liczbaKondygnacjiNadziemnych&quot;)&lt;1 ">
        <settings calloutType="simple">
