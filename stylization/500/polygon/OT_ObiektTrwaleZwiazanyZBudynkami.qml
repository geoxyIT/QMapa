...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule filter="rodzajObiektu = 't'" key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}" symbol="0" label="taras"/>
      <rule filter="rodzajObiektu = 'w'" key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}" symbol="1" label="weranda, ganek"/>
      <rule filter="rodzajObiektu = 'i'" key="{805755b1-0b08-48ed-8f89-32e251e5e287}" symbol="2" label="wiatrołap"/>
      <rule filter="rodzajObiektu = 's' " key="{246317b8-0501-45cd-a47d-dcee7ba7d02a}" symbol="3" label="schody"/>
      <rule filter="rodzajObiektu = 'o'" key="{9315336e-9352-4f65-a647-a6a44f8b06a3}" symbol="4" label="podpora związana z budynkiem"/>
      <rule filter="rodzajObiektu = 'r'" key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}" symbol="5" label="rampa"/>
      <rule filter="rodzajObiektu = 'j'" key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}" symbol="6" label="wjazd do podziemia"/>
      <rule filter="rodzajObiektu = 'd'" key="{e40132d5-9fba-4968-97b2-e54f213209d9}" symbol="7" label="podjazd dla osób niepełnosprawnych"/>
    ...
    <rules key="{7e724c5f-568e-4878-959f-0fc56ee9903f}">
      <rule description="rampa" filter="rodzajObiektu = 'r'" key="{f5aac7d2-50c5-4524-b7ca-f8df0d71e827}">
        <settings calloutType="simple">
          ...
          <rendering obstacle="1" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2000" fontMinPixelSize="3" zIndex="0" drawLabels="1" mergeLines="0" limitNumLabels="0" obstacleFactor="1" displayAll="0" scaleVisibility="0" scaleMin="0" minFeatureSize="0" fontMaxPixelSize="10000" labelPerPart="0" unplacedVisibility="0" obstacleType="1" scaleMax="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
