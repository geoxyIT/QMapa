...
<qgis styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.24.0-Tisler" maxScale="0" simplifyDrawingHints="1">
  <flags>
  ...
  <temporal durationField="" endExpression="" limitMode="0" startField="" endField="" accumulate="0" durationUnit="min" fixedDuration="0" mode="0" enabled="0" startExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}" symbol="0" filter="rodzajObiektu = 't'" label="taras"/>
      <rule key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}" symbol="1" filter="rodzajObiektu = 'w'" label="weranda, ganek"/>
      <rule key="{805755b1-0b08-48ed-8f89-32e251e5e287}" symbol="2" filter="rodzajObiektu = 'i'" label="wiatrołap"/>
      <rule key="{246317b8-0501-45cd-a47d-dcee7ba7d02a}" symbol="3" filter="rodzajObiektu = 's' " label="schody"/>
      <rule key="{9315336e-9352-4f65-a647-a6a44f8b06a3}" symbol="4" filter="rodzajObiektu = 'o'" label="podpora związana z budynkiem"/>
      <rule key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}" symbol="5" filter="rodzajObiektu = 'r'" label="rampa"/>
      <rule key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}" symbol="6" filter="rodzajObiektu = 'j'" label="wjazd do podziemia"/>
      <rule key="{e40132d5-9fba-4968-97b2-e54f213209d9}" symbol="7" filter="rodzajObiektu = 'd'" label="podjazd dla osób niepełnosprawnych"/>
    </rules>
    <symbols>
      ...
      <symbol name="2" type="fill" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="MarkerLine">
          ...
          <symbol name="@2@0" type="marker" alpha="1" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="3" type="fill" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="GeometryGenerator">
          ...
          <symbol name="@3@0" type="line" alpha="1" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="6" type="fill" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@6@1" type="marker" alpha="1" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{70ffda0e-bdcd-4cd2-8786-d0ed5bad7395}">
      <rule key="{dc5864a7-c9c2-4aab-8e89-311dedc47662}" filter="rodzajObiektu = 'r'" description="rampa">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontKerning="1" fontItalic="0" fontFamily="Arial" fontUnderline="0" fontSize="1.0417000000000001" useSubstitutions="0" capitalization="0" blendMode="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" textColor="0,0,0,255" fontSizeUnit="MapUnit" isExpression="1" namedStyle="Normal" fieldName="'rmp'" fontWeight="50" multilineHeight="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferOpacity="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSize="1" bufferDraw="0" bufferNoFill="1"/>
            <text-mask maskSizeUnits="MM" maskedSymbolLayers="" maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="0" maskType="0" maskOpacity="1"/>
            <background shapeRadiiX="0" shapeOffsetUnit="MM" shapeBorderWidth="0" shapeOpacity="1" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeBlendMode="0" shapeRadiiUnit="MM" shapeSizeUnit="MM" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetX="0" shapeRotationType="0" shapeSizeType="0" shapeRotation="0" shapeOffsetY="0" shapeBorderColor="128,128,128,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeType="0" shapeDraw="0" shapeFillColor="255,255,255,255">
            ...
            <shadow shadowBlendMode="6" shadowDraw="0" shadowRadiusAlphaOnly="0" shadowRadiusUnit="MM" shadowOpacity="0.69999999999999996" shadowOffsetGlobal="1" shadowOffsetAngle="135" shadowRadius="1.5" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetUnit="MM" shadowScale="100" shadowUnder="0" shadowOffsetDist="1" shadowColor="0,0,0,255" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
            <dd_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <text-format addDirectionSymbol="0" rightDirectionSymbol=">" autoWrapLength="0" decimals="3" placeDirectionSymbol="0" plussign="0" reverseDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" multilineAlign="3" formatNumbers="0"/>
          <placement offsetType="0" fitInPolygonOnly="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" xOffset="0" lineAnchorPercent="0.5" geometryGeneratorEnabled="0" distUnits="MM" rotationUnit="AngleDegrees" lineAnchorClipping="0" placement="0" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" dist="0" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" polygonPlacementFlags="2" lineAnchorType="0" centroidInside="0" preserveRotation="1" layerType="PolygonGeometry" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" placementFlags="10" repeatDistanceUnits="MM" overrunDistance="0" geometryGeneratorType="PointGeometry" quadOffset="4" yOffset="0"/>
          <rendering drawLabels="1" limitNumLabels="0" unplacedVisibility="0" scaleMax="0" obstacleType="1" mergeLines="0" maxNumLabels="2000" fontLimitPixelSize="0" scaleMin="0" scaleVisibility="0" obstacle="1" displayAll="0" minFeatureSize="0" labelPerPart="0" fontMinPixelSize="3" obstacleFactor="1" upsidedownLabels="0" zIndex="0" fontMaxPixelSize="10000"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
      ...
      <rule key="{af43e013-760c-4d9e-984c-34a78244fb5a}" filter="rodzajObiektu = 'd'" description="podjazd dla osób niepełnosprawnych">
        <settings calloutType="simple">
          <text-style textOpacity="1" fontKerning="1" fontItalic="0" fontFamily="Arial" fontUnderline="0" fontSize="1.0417000000000001" useSubstitutions="0" capitalization="0" blendMode="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" textColor="0,0,0,255" fontSizeUnit="MapUnit" isExpression="1" namedStyle="Normal" fieldName="'n'" fontWeight="50" multilineHeight="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" legendString="Aa">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferOpacity="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSize="1" bufferDraw="0" bufferNoFill="1"/>
            <text-mask maskSizeUnits="MM" maskedSymbolLayers="" maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="0" maskType="0" maskOpacity="1"/>
            <background shapeRadiiX="0" shapeOffsetUnit="MM" shapeBorderWidth="0" shapeOpacity="1" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeBlendMode="0" shapeRadiiUnit="MM" shapeSizeUnit="MM" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetX="0" shapeRotationType="0" shapeSizeType="0" shapeRotation="0" shapeOffsetY="0" shapeBorderColor="128,128,128,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeType="0" shapeDraw="0" shapeFillColor="255,255,255,255">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penAlpha="255" backgroundColor="#ffffff" rotationOffset="270" sizeType="MM" spacingUnit="MM" direction="0" showAxis="1" penColor="#000000" minScaleDenominator="0" enabled="0" spacingUnitScale="3x:0,0,0,0,0,0" opacity="1" height="15" scaleBasedVisibility="0" diagramOrientation="Up" maxScaleDenominator="1e+08" width="15" scaleDependency="Area" penWidth="0" spacing="5" backgroundAlpha="255" minimumSize="0" sizeScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" lineSizeType="MM" barWidth="5">
  ...
  <aliases>
    ...
    <alias name="" field="rodzajObiektuZwiazanegoZBudynkiem" index="7"/>
    <alias name="" field="geometria_kresek" index="8"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="rodzajObiektuZwiazanegoZBudynkiem"/>
    <default applyOnUpdate="0" expression="" field="geometria_kresek"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="1" unique_strength="1" constraints="3" exp_strength="0" field="fid"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="gml_id"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="lokalnyId"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="przestrzenNazw"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="wersjaId"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="startObiekt"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="startWersjaObiekt"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="rodzajObiektuZwiazanegoZBudynkiem"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="geometria_kresek"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="geometria_kresek" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="geometria_kresek" width="-1" hidden="0" type="field"/>
