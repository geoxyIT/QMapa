...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{1aed1771-116e-4ba7-a492-cd5f1573b91b}">
      <rule label="taras" symbol="0" filter="rodzajObiektu = 't'" key="{803b29a7-0c6a-401d-a3b9-6f5c5931288c}"/>
      <rule label="weranda, ganek" symbol="1" filter="rodzajObiektu = 'w'" key="{1e4318cd-a9cc-4fb4-89d5-d1ace62f0e05}"/>
      <rule label="wiatrołap" symbol="2" filter="rodzajObiektu = 'i'" key="{805755b1-0b08-48ed-8f89-32e251e5e287}"/>
      <rule label="schody" symbol="3" filter="rodzajObiektu = 's' " key="{246317b8-0501-45cd-a47d-dcee7ba7d02a}"/>
      <rule label="podpora związana z budynkiem" symbol="4" filter="rodzajObiektu = 'o'" key="{9315336e-9352-4f65-a647-a6a44f8b06a3}"/>
      <rule label="rampa" symbol="5" filter="rodzajObiektu = 'r'" key="{a3179843-9e2c-4e33-8fe6-68f95271a0b2}"/>
      <rule label="wjazd do podziemia" symbol="6" filter="rodzajObiektu = 'j'" key="{a29feab3-a9ed-4c13-87ff-df5cb8cd32a2}"/>
      <rule label="podjazd dla osób niepełnosprawnych" symbol="7" filter="rodzajObiektu = 'd'" key="{e40132d5-9fba-4968-97b2-e54f213209d9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{70ffda0e-bdcd-4cd2-8786-d0ed5bad7395}">
      <rule filter="rodzajObiektu = 'r'" key="{dc5864a7-c9c2-4aab-8e89-311dedc47662}" description="rampa">
      ...
      <rule filter="rodzajObiektu = 'd'" key="{af43e013-760c-4d9e-984c-34a78244fb5a}" description="podjazd dla osób niepełnosprawnych">
        <settings calloutType="simple">
