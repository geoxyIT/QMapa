...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{4402cd2b-a26f-44a1-a5bc-6664c7967240}">
      <rule label="taras" symbol="0" filter="rodzajObiektuZwiazanegoZBudynkiem = 't'" key="{fa065e21-bd4d-4b32-95d5-1b14a396186a}"/>
      <rule label="weranda, ganek" symbol="1" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'w'" key="{b11b6b99-f24c-4dac-b2ad-a96f9f2699b1}"/>
      <rule label="wiatrołap" symbol="2" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'i'" key="{795ad3ec-f7a8-4344-9278-b74b6547559f}"/>
      <rule label="schody" symbol="3" filter="rodzajObiektuZwiazanegoZBudynkiem = 's' " key="{6188d76b-a136-4240-9b44-72b1f4a180ce}"/>
      <rule label="podpora" symbol="4" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'o'" key="{0d857496-54b8-4ece-bc37-2c0a3ad07e4f}"/>
      <rule label="rampa" symbol="5" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'r'" key="{4f92aea1-46ea-40bd-91e8-1f71bc3cabf3}"/>
      <rule label="wjazd do podziemia" symbol="6" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'j'" key="{7446eccf-4e2d-4a13-8113-61a5ba239d4c}"/>
      <rule label="podjazd dla osób niepełnosprawnych" symbol="7" filter="rodzajObiektuZwiazanegoZBudynkiem  = 'd'" key="{89f057ff-ee2b-43fb-b41f-67e5a58b4ef6}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" name="3" type="fill" clip_to_extent="1">
        ...
        <layer class="GeometryGenerator" enabled="1" locked="0" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@3@0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{3ec8ebc9-2331-4679-bada-70988f5e859c}">
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'r'" key="{1069a994-1f34-4681-ab35-e9fd057f9c01}">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'd'" key="{0d86329b-44ac-4ef9-820a-e699df238373}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="'n'" legendString="Aa" fontSize="1.0417000000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskEnabled="0" maskSize="1.5" maskJoinStyle="128" maskSizeUnits="MM" maskOpacity="1" maskType="0"/>
            <background shapeOffsetY="0" shapeDraw="0" shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRadiiY="0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSVGFile="" shapeSizeX="0" shapeSizeY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeSizeUnit="MM">
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="rodzajObiektuZwiazanegoZBudynkiem" hidden="0" width="-1" type="field"/>
