...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{4402cd2b-a26f-44a1-a5bc-6664c7967240}">
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 't'" key="{fa065e21-bd4d-4b32-95d5-1b14a396186a}" symbol="0" label="taras"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'w'" key="{b11b6b99-f24c-4dac-b2ad-a96f9f2699b1}" symbol="1" label="weranda, ganek"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'i'" key="{795ad3ec-f7a8-4344-9278-b74b6547559f}" symbol="2" label="wiatrołap"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem = 's' " key="{6188d76b-a136-4240-9b44-72b1f4a180ce}" symbol="3" label="schody"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'o'" key="{0d857496-54b8-4ece-bc37-2c0a3ad07e4f}" symbol="4" label="podpora"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'r'" key="{4f92aea1-46ea-40bd-91e8-1f71bc3cabf3}" symbol="5" label="rampa"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'j'" key="{7446eccf-4e2d-4a13-8113-61a5ba239d4c}" symbol="6" label="wjazd do podziemia"/>
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'd'" key="{89f057ff-ee2b-43fb-b41f-67e5a58b4ef6}" symbol="7" label="podjazd dla osób niepełnosprawnych"/>
      <rule filter="ELSE" key="{9fc44e7b-5e6b-469b-92de-cb3c5de27acf}" symbol="8" label="nieoznaczone"/>
    </rules>
    <symbols>
      ...
      <symbol name="2" force_rhr="0" type="fill" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="MarkerLine">
          ...
          <symbol name="@2@0" force_rhr="0" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{c6bf984f-d243-4efb-9d73-601f5f45b682}">
      <settings calloutType="simple">
        <text-style textOpacity="1" namedStyle="" fontSize="10" blendMode="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontSizeUnit="Point" allowHtml="0" useSubstitutions="0" multilineHeight="1" fontKerning="1" fieldName="" legendString="Aa" fontWeight="50" textColor="0,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="0" capitalization="0" fontWordSpacing="0" fontStrikeout="0">
          <families/>
        ...
        <placement dist="0" preserveRotation="1" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" placement="0" centroidInside="0" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" maxCurvedCharAngleOut="-25" lineAnchorType="0" quadOffset="4" xOffset="0" distUnits="MM" priority="5" centroidWhole="0" overrunDistance="0" rotationUnit="AngleDegrees" rotationAngle="0" geometryGeneratorEnabled="0" offsetUnits="MM" yOffset="0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" layerType="UnknownGeometry"/>
        <rendering obstacle="1" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2000" fontMinPixelSize="0" zIndex="0" drawLabels="1" mergeLines="0" limitNumLabels="0" obstacleFactor="1" displayAll="0" scaleVisibility="0" scaleMin="0" minFeatureSize="0" fontMaxPixelSize="10000" labelPerPart="0" unplacedVisibility="0" obstacleType="1" scaleMax="0"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'r'" key="{fc9e0be7-717c-4636-95bd-b7586cc52f83}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontSize="1.0417000000000001" blendMode="0" fontFamily="Arial" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontSizeUnit="MapUnit" allowHtml="0" useSubstitutions="0" multilineHeight="1" fontKerning="1" fieldName="'rmp'" legendString="Aa" fontWeight="50" textColor="0,0,0,255" fontSizeMapUnitScale="3x:2500,0,0,0,0,0" fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="1" capitalization="0" fontWordSpacing="0" fontStrikeout="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferJoinStyle="128" bufferNoFill="1" bufferBlendMode="0"/>
            <text-mask maskedSymbolLayers="" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5"/>
            <background shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeSVGFile="" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBlendMode="0" shapeRadiiY="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeOffsetY="0" shapeSizeUnit="MM" shapeRotationType="0" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeRotation="0" shapeOpacity="1" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeJoinStyle="64">
          ...
          <text-format useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" decimals="3" rightDirectionSymbol=">" addDirectionSymbol="0" formatNumbers="0" plussign="0" placeDirectionSymbol="0" multilineAlign="3" autoWrapLength="0" leftDirectionSymbol="&lt;" wrapChar=""/>
          <placement dist="0" preserveRotation="1" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" placement="1" centroidInside="0" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" maxCurvedCharAngleOut="-25" lineAnchorType="0" quadOffset="4" xOffset="0" distUnits="MM" priority="5" centroidWhole="0" overrunDistance="0" rotationUnit="AngleDegrees" rotationAngle="0" geometryGeneratorEnabled="0" offsetUnits="MM" yOffset="0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" layerType="PolygonGeometry"/>
      ...
      <rule filter="rodzajObiektuZwiazanegoZBudynkiem  = 'd'" key="{00b57f7c-30ee-419f-8b3d-862966a61627}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontSize="1.0417000000000001" blendMode="0" fontFamily="Arial" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontSizeUnit="MapUnit" allowHtml="0" useSubstitutions="0" multilineHeight="1" fontKerning="1" fieldName="'n'" legendString="Aa" fontWeight="50" textColor="0,0,0,255" fontSizeMapUnitScale="3x:2500,0,0,0,0,0" fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="1" capitalization="0" fontWordSpacing="0" fontStrikeout="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferJoinStyle="128" bufferNoFill="1" bufferBlendMode="0"/>
            <text-mask maskedSymbolLayers="" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5"/>
            <background shapeType="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeSVGFile="" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeBlendMode="0" shapeRadiiY="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeOffsetY="0" shapeSizeUnit="MM" shapeRotationType="0" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeRotation="0" shapeOpacity="1" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeJoinStyle="64">
