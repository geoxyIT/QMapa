...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{f6719272-d422-49f9-a4fa-64e278b56905}">
      <rule symbol="0" label="urządzenie techniczne sieci niezidentyfikowanej" key="{9a6389a3-d6bf-4b7d-add8-501af3da0119}" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{ad09f768-f5e0-4239-9803-18341b550d3c}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'" key="{267a143e-78aa-45fe-826e-e5bf4e36e313}">
      ...
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is  'p'" key="{417223b8-d6fc-4c5f-aca8-2d740cdc827d}">
        <settings calloutType="simple">
