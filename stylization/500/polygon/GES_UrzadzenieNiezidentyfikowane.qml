...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{7678524f-e971-4406-a29c-56ed4c85adaf}">
      <rule label="urządzenie techniczne sieci niezidentyfikowanej" symbol="0" key="{425ee22f-41c4-4a50-b719-938ae57fa067}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{432d634b-5234-4d70-9baf-dca2861fb71c}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'" key="{36a9aefb-4523-4835-a059-9394975b9bb7}">
      ...
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is  'p'" key="{199c1b4d-aa3e-4d4d-b99c-ebc0ff1abda9}">
        <settings calloutType="simple">
