...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{b15dc10d-1ef6-4cd9-8a3d-174bb0a99bb0}">
      <rule description="właz do komory, kanału " filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'" key="{e91ab8b6-6f3e-4c61-b0a2-070125fa19e9}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{d8d54d37-235e-436c-a768-fb65fa45add7}">
        <settings calloutType="simple">
