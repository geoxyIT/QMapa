...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" readOnly="0" labelsEnabled="0" maxScale="0" minScale="100000000" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyDrawingHints="1">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{fa52eebb-7997-4077-af46-9e415d571107}">
      <rule label="skarpa umocniona" symbol="0" filter="rodzajSkarpy = 'u'" key="{3fa1983b-1cea-4354-b386-e7fe4450fd5f}"/>
      <rule label="skarpa nieumocniona" symbol="1" filter="rodzajSkarpy = 'k'" key="{fa8d07e8-341c-425b-9213-05b3d749965a}"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias index="9" field="rodzajSkarpy" name=""/>
    <alias index="10" field="dataPrzyjeciaDoZasobu" name=""/>
    <alias index="11" field="obliczona_geometria_500" name=""/>
    <alias index="12" field="obliczona_geometria_1000" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="rodzajSkarpy" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="rodzajSkarpy"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="rodzajSkarpy"/>
