...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{37df8551-b8b2-485a-a44a-786c3919eb83}">
      <rule label="basen odkryty" symbol="0" filter="rodzajObiektu = 'b'" key="{a0262446-7acd-4906-8231-6375189a82bc}"/>
      <rule label="plac sportowy" symbol="1" filter="rodzajObiektu = 'p'" key="{ba9e2354-c4d4-4bad-8e92-4766f73fedad}"/>
      <rule label="plac gier i zabaw" symbol="2" filter="rodzajObiektu = 'z'" key="{dddcced0-87af-4c26-9292-121c27ff3232}"/>
      <rule label="inny obiekt sportowy" symbol="3" filter="rodzajObiektu = 'i'" key="{d8c5984a-fdc5-4b77-9f0a-ff5202dff23d}"/>
    </rules>
    <symbols>
          ...
          <symbol force_rhr="0" alpha="1" name="@1@1" type="marker" clip_to_extent="1">
            ...
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option name="size" type="QString" value="5.39397"/>
  ...
  <labeling type="rule-based">
    <rules key="{3bb51b99-f200-4878-9067-c53ea77d6a8e}">
      <rule filter="rodzajObiektu = 'b'" key="{2d3e146e-13a8-45fa-9835-331ffb486183}" description="basen odkryty">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontItalic="0" allowHtml="0" fontLetterSpacing="0" multilineHeight="1" capitalization="0" fontWordSpacing="0" isExpression="1" useSubstitutions="0" fontStrikeout="0" fontKerning="1" fontSizeUnit="MapUnit" fontFamily="Arial" fontUnderline="0" fontWeight="50" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fieldName="'bas.'" legendString="Aa" fontSize="1.0417000000000001" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
            <families/>
