...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{37df8551-b8b2-485a-a44a-786c3919eb83}">
      <rule filter="rodzajObiektu = 'b'" symbol="0" key="{a0262446-7acd-4906-8231-6375189a82bc}" label="basen odkryty"/>
      <rule filter="rodzajObiektu = 'p'" symbol="1" key="{ba9e2354-c4d4-4bad-8e92-4766f73fedad}" label="plac sportowy"/>
      <rule filter="rodzajObiektu = 'z'" symbol="2" key="{dddcced0-87af-4c26-9292-121c27ff3232}" label="plac gier i zabaw"/>
      <rule filter="rodzajObiektu = 'i'" symbol="3" key="{d8c5984a-fdc5-4b77-9f0a-ff5202dff23d}" label="inny obiekt sportowy"/>
    </rules>
    <symbols>
