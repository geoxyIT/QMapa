...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule filter="rodzajObiektu = 'j'" symbol="0" key="{676c2901-c1b5-4812-be23-8a349a317223}" label="jezdnia"/>
      <rule filter="rodzajObiektu = 'c'" symbol="1" key="{b2abe3b4-6246-4ca6-ba2a-57716e8794eb}" label="chodnik"/>
      <rule filter="rodzajObiektu = 'g'" symbol="2" key="{bd775299-ca07-41d8-baa9-52d4e93663b3}" label="droga dla rowerów"/>
      <rule filter="rodzajObiektu = 'u'" symbol="3" key="{3621eae1-1c3f-45d0-b9ed-8e24f36d3cf1}" label="obszar utwardzony"/>
      <rule filter="rodzajObiektu = 'r'" symbol="4" key="{5321ae88-caf9-4ddc-ad8f-ca585154f399}" label="rów przydrożny"/>
      <rule filter="rodzajObiektu = 's' " symbol="5" key="{e2105813-6add-453a-ac45-bb6073bd1d41}" label="schody w ciągu komunikacyjnym"/>
      <rule filter="rodzajObiektu = 'm'" symbol="6" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" label="most"/>
      <rule filter="rodzajObiektu = 'z'" symbol="7" key="{df1ff72d-d703-4e30-ab59-b2695f6bc8e3}" label="przepust"/>
      <rule filter="rodzajObiektu = 'w'" symbol="8" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" label="wiadukt"/>
      <rule filter="rodzajObiektu = 'e'" symbol="9" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" label="estakada"/>
      <rule filter="rodzajObiektu = 'n'" symbol="10" key="{09388348-12c0-4f98-b7c4-e3f656ee3dc0}" label="peron"/>
      <rule filter="rodzajObiektu = 'a'" symbol="11" key="{81a3fe45-9d13-44f0-88b4-5adafcc4788d}" label="rampa"/>
      <rule filter="rodzajObiektu = 'i'" symbol="12" key="{224e0e5f-d3c3-4033-addd-072e911a0e77}" label="inny obiekt komunikacyjny"/>
    </rules>
    <symbols>
      ...
      <symbol name="5" type="fill" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer class="GeometryGenerator" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="geometryModifier" type="QString" value="kreskowanie( geometry(get_feature( 'OT_poliliniaKierunkowa',  'gml_id' ,    &quot;gml_id&quot;   )), $geometry, 0.5, 100, 90, 0,1)"/>
            <Option name="units" type="QString" value="MapUnit"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="kreskowanie( geometry(get_feature( 'OT_poliliniaKierunkowa',  'gml_id' ,    &quot;gml_id&quot;   )), $geometry, 0.5, 100, 90, 0,1)"/>
  ...
  <labeling type="rule-based">
    <rules key="{1b3dcce7-28b3-4601-9f8a-88a45ae9ba13}">
      ...
      <rule filter="rodzajObiektu = 'c'" key="{ae7a7ce3-85e5-4ea0-a95d-bd20824727d4}" description="chodnik">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="'ch.' + try(&quot;rodzajNawierzchni&quot;)" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule filter="rodzajObiektu = 'g'" key="{61e57b9d-59b9-4c7b-b295-e6f56109b16f}" description="droga dla rowerów">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="'r'" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule filter="rodzajObiektu = 'u'" key="{65e10f1a-d049-42fa-925a-df9350a3130e}" description="obszar utwardzony">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="try(&quot;rodzajNawierzchni&quot;)+'.'" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule filter="rodzajObiektu = 'r'" key="{c68bbffe-d42c-4c1d-b652-3664345f4e20}" description="rów przydrożny">
        <settings calloutType="simple">
      ...
      <rule filter="rodzajObiektu = 'n'" key="{67196795-0223-4ab9-8caf-06b478702e3b}" description="peron">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="'per'" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule filter="rodzajObiektu = 'a'" key="{bd17f871-3880-4003-9aa1-0162c32f6a14}" description="rampa">
        <settings calloutType="simple">
          <text-style fontWeight="50" fieldName="'rmp'" isExpression="1" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" namedStyle="Normal" fontKerning="1" fontFamily="Arial" legendString="Aa" multilineHeight="1" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontSizeUnit="MapUnit" textOpacity="1" previewBkgrdColor="255,255,255,255" fontSize="1.0417000000000001" fontUnderline="0" textOrientation="horizontal" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="0" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskEnabled="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="1.5"/>
            <background shapeRotationType="0" shapeSizeY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeType="0" shapeBorderWidth="0" shapeSizeX="0" shapeOffsetX="0" shapeDraw="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRotation="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule filter="rodzajObiektu = 'i'" key="{1b788d35-77c0-4926-a0d9-6b7a9bda0008}" description="inny obiekt komunikacyjny">
        <settings calloutType="simple">
