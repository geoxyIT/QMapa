...
<qgis minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1">
  ...
  <labeling type="rule-based">
    <rules key="{9481db0b-3941-4d04-9328-f3b552d7b9a9}">
      <rule key="{204a0193-7637-4070-98d1-50f83259c2db}" description="jezdnia" filter="rodzajObiektu = 'j'">
      ...
      <rule key="{736b4466-0ba9-4837-905d-0e44c19726f7}" description="chodnik" filter="rodzajObiektu = 'c'">
        <settings calloutType="simple">
      ...
      <rule key="{32882b69-77a1-4b2f-83d1-078debf4fbf2}" description="droga dla rowerów" filter="rodzajObiektu = 'g'">
        <settings calloutType="simple">
      ...
      <rule key="{755531ac-6e7d-4d53-b9a0-64d163fc83f2}" description="obszar utwardzony" filter="rodzajObiektu = 'u'">
        <settings calloutType="simple">
      ...
      <rule key="{43fe1508-5199-400c-998b-061f95a1c9e3}" description="rów przydrożny" filter="rodzajObiektu = 'r'">
        <settings calloutType="simple">
      ...
      <rule key="{0bd96d79-a158-4970-95a0-934b0ac68f1e}" description="peron" filter="rodzajObiektu = 'n'">
        <settings calloutType="simple">
      ...
      <rule key="{f449d055-396b-47ec-8723-bc44f66f572b}" description="rampa" filter="rodzajObiektu = 'a'">
        <settings calloutType="simple">
      ...
      <rule key="{be23cd07-d670-41d5-94f8-3d597cc359c5}" description="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
