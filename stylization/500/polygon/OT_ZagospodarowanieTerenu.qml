...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{bb778299-c56c-419a-ba33-8f5dd5a4b6ec}">
      <rule label="trawnik" symbol="0" filter="rodzajObiektu = 't'" key="{b8425c16-b80b-42bc-9b3c-deae8f687674}"/>
      <rule label="zadrzewienie, zakrzewienie" symbol="1" filter="rodzajObiektu = 'k'" key="{f02b3347-f7aa-4e33-948c-b060715b62db}"/>
      <rule label="teren zalesiony" symbol="2" filter="rodzajObiektu = 'z'" key="{c1ad4dbd-8979-419d-b2ae-8966d67a4540}"/>
  ...
  <labeling type="rule-based">
    <rules key="{8083e20d-0ac7-430a-8c12-cdeb75cfc904}">
      <rule filter="rodzajObiektu = 'i'" key="{01cfac67-ac39-434a-88e8-aec03dfc99ed}" description="inny obiekt zagospodarowania terenu">
