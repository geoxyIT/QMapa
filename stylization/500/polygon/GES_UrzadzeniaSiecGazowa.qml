...
<qgis hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" simplifyLocal="1" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{e6b13897-607d-44b5-a0e2-1c0fe05e277e}">
      <rule filter="rodzajUrzadzenia = 's'" label="szafa gazowa, kontener" key="{929fc2f8-f86f-4aa0-8a3e-960a308f2a8a}" symbol="0"/>
      <rule filter="rodzajUrzadzenia = 'n'" label="stacja gazowa" key="{f5e205a2-dc6e-43fe-bb53-64205cb99d84}" symbol="1"/>
      <rule filter="rodzajUrzadzenia = 'v'" label="zbiornik gazu" key="{9c145466-b881-4bb1-8728-4a6edb5b168f}" symbol="2"/>
      <rule filter="rodzajUrzadzenia = 'u'" label="gazowe urządzenie techniczne" key="{33574bc7-d437-4a8b-979a-0ebf7209c265}" symbol="3"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6197d8a0-de5e-42bf-a605-3481d2086a08}">
      <rule filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{2a404620-6e3d-4e38-9a88-a8beee3d73fc}" description="gazowe urządzenie techniczne">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'g'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.0417000000000001" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
      ...
      <rule filter="rodzajUrzadzenia = 's' and try(&quot;status&quot;) is not 'p'" key="{67d5ac99-e3be-45a8-abd4-317784bdd51e}" description="szafa gazowa, kontener">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'g'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.0417000000000001" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule filter="rodzajUrzadzenia = 'n' and try(&quot;status&quot;) is not 'p'" key="{4b924b7d-7fd7-4ed1-b4cf-aa37ecc97c7b}" description="stacja gazowa">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'G'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.0417000000000001" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule filter="rodzajUrzadzenia = 'v' and try(&quot;status&quot;) is not 'p'" key="{e2f48205-7ffd-4477-8df6-b2225610539a}" description="zbiornik gazu">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" allowHtml="0" fieldName="'zg'" legendString="Aa" fontItalic="0" multilineHeight="1" blendMode="0" fontWordSpacing="0" fontSize="1.0417000000000001" textColor="191,191,0,255" fontLetterSpacing="0" fontSizeUnit="MapUnit" fontUnderline="0" fontWeight="50" isExpression="1" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Normal" textOpacity="1" useSubstitutions="0" fontFamily="Arial" fontKerning="1">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <text-mask maskSize="1.5" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskEnabled="0" maskType="0" maskJoinStyle="128" maskSizeUnits="MM"/>
            <background shapeFillColor="255,255,255,255" shapeRotation="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeSVGFile="" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRotationType="0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeSizeUnit="MM" shapeRadiiY="0" shapeSizeType="0" shapeBlendMode="0" shapeDraw="0" shapeOffsetUnit="MM" shapeRadiiX="0" shapeSizeX="0" shapeSizeY="0" shapeOffsetY="0" shapeOpacity="1" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeType="0">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{110482fb-18f4-4ca3-8661-958cf9f2e8d9}" description="projektowane">
        <settings calloutType="simple">
