...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{4d221479-5127-410e-be74-346b08fcd8c9}">
      <rule label="urządzenie techniczne sieci specjalnej" symbol="0" key="{8eded192-67cd-4d45-8774-ecf2d23a0859}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d847c36b-4e58-4c35-a8a8-4517b9d3bfce}">
      <rule key="{233d3245-7c62-473a-8622-319bf90418d4}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="urządzenie techniczne sieci specjalnej">
      ...
      <rule key="{ff98adbe-d7f0-4ecd-a695-13afb8fdd14a}" filter="try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
