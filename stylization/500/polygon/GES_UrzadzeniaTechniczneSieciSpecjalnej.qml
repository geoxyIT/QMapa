...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{467ba7bd-89f0-49f0-b3bf-7b8b5e69ea46}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{65319bff-e9ec-488e-a117-148b6d751da5}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{3930c478-8d7d-4cf1-8d91-6384a65bbd9d}">
        <settings calloutType="simple">
