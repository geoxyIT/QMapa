...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{a93a813a-3a1b-49cb-b60f-042019b9735c}">
      <rule filter="rodzajUrzadzenia = 'u'" key="{c4965f81-67a4-42bf-83d0-4b4ea30493d7}" symbol="0" label="ciepłownicze urządzenie techniczne"/>
      <rule filter="ELSE" key="{9fc44e7b-5e6b-469b-92de-cb3c5de27acf}" symbol="1" label="nieoznaczone"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f488b66c-9f47-4bf1-b92d-b9ee95313bb1}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{69850813-d7b6-4417-a0c5-fa9b7b7a2027}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{a0430085-26ef-4a4d-ab53-2a642d3df5f8}">
        <settings calloutType="simple">
