...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{a93a813a-3a1b-49cb-b60f-042019b9735c}">
      <rule label="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{c4965f81-67a4-42bf-83d0-4b4ea30493d7}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f4961ceb-c342-4397-baa7-c00aa25a82d5}">
      <rule description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{76c4f9bc-cc08-45ec-aaa6-8e7e6ab47637}">
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{e7ace775-1f19-43e0-9bb4-023946ac48de}">
        <settings calloutType="simple">
