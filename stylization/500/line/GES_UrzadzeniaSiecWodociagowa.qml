...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{a684ae9f-a8ab-46f1-95b2-8b74f712e436}">
      <rule symbol="0" key="{c19df96b-1031-4878-b9da-272105d2f01b}" filter="rodzajUrzadzenia = 'u'" label="wodociągowe urządzenie techniczne"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8ed3306-34b4-4e59-ae25-e308d554bb48}">
      <rule key="{1e06ef88-abd2-4e6e-89a5-ab80181e8321}" description="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{38ac2f57-1b32-4270-915f-c3172ad990b4}" description="wodociągowe urządzenie techniczne" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
