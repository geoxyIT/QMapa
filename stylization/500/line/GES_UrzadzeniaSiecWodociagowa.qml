...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{a684ae9f-a8ab-46f1-95b2-8b74f712e436}">
      <rule label="wodociągowe urządzenie techniczne" symbol="0" key="{c19df96b-1031-4878-b9da-272105d2f01b}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8ed3306-34b4-4e59-ae25-e308d554bb48}">
      <rule key="{1e06ef88-abd2-4e6e-89a5-ab80181e8321}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="wodociągowe urządzenie techniczne">
        <settings calloutType="simple">
          ...
          <placement polygonPlacementFlags="2" xOffset="0" yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" quadOffset="4" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" centroidWhole="0" centroidInside="0" lineAnchorType="0" placementFlags="11" lineAnchorClipping="0" rotationAngle="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" offsetUnits="MM" repeatDistance="0" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placement="2" rotationUnit="AngleDegrees" preserveRotation="1" overrunDistance="0" geometryGenerator="" dist="0" overrunDistanceUnit="MM" layerType="LineGeometry" distUnits="MM"/>
      ...
      <rule key="{38ac2f57-1b32-4270-915f-c3172ad990b4}" filter="try(&quot;status&quot;) is  'p'" description="wodociągowe urządzenie techniczne">
        <settings calloutType="simple">
