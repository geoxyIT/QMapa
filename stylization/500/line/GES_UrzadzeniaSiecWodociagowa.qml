...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{a684ae9f-a8ab-46f1-95b2-8b74f712e436}">
      <rule label="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{c19df96b-1031-4878-b9da-272105d2f01b}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8ed3306-34b4-4e59-ae25-e308d554bb48}">
      <rule description="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{1e06ef88-abd2-4e6e-89a5-ab80181e8321}">
      ...
      <rule description="wodociągowe urządzenie techniczne" filter="try(&quot;status&quot;) is  'p'" key="{38ac2f57-1b32-4270-915f-c3172ad990b4}">
        <settings calloutType="simple">
