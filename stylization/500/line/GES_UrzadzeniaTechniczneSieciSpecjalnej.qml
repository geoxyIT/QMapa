...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="rule-based">
    <rules key="{de10264e-e3ec-44b9-8e78-fba8ca4549c5}">
      <rule description="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{8b2056eb-318d-467c-9a9b-04ee32c5f9cb}">
      ...
      <rule description="urządzenie techniczne sieci specjalnej" filter="try(&quot;status&quot;) is 'p'" key="{aa6cd97f-1967-49de-9c92-a9e887f61423}">
        <settings calloutType="simple">
