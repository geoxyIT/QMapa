...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{8b97a732-835a-4d2f-b9e8-15e477cb5382}">
      <rule label="urządzenie techniczne sieci specjalnej" symbol="0" filter="rodzajUrzadzenia = 'u'" key="{95683d64-875f-493b-8b49-bd8c03424abd}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{de10264e-e3ec-44b9-8e78-fba8ca4549c5}">
      <rule filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{8b2056eb-318d-467c-9a9b-04ee32c5f9cb}" description="urządzenie techniczne sieci specjalnej">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{aa6cd97f-1967-49de-9c92-a9e887f61423}" description="urządzenie techniczne sieci specjalnej">
        <settings calloutType="simple">
