...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule symbol="0" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}" filter="rodzajUrzadzenia = 'u'" label="gazowe urządzenie techniczne"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{dfd4aa65-e6a3-402d-a479-5260dd775ca6}">
      <rule key="{fd59ea3e-c707-4bf3-9a7e-d37a9a57e841}" description="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{b7f0cb8c-03b5-4217-bcf5-fa2d00bd7bd0}" description="projektowane" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
