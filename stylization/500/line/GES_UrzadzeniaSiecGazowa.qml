...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule label="gazowe urządzenie techniczne" symbol="0" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{dfd4aa65-e6a3-402d-a479-5260dd775ca6}">
      <rule key="{fd59ea3e-c707-4bf3-9a7e-d37a9a57e841}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" description="gazowe urządzenie techniczne">
      ...
      <rule key="{b7f0cb8c-03b5-4217-bcf5-fa2d00bd7bd0}" filter="try(&quot;status&quot;) is 'p'" description="projektowane">
        <settings calloutType="simple">
