...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule filter="rodzajUrzadzenia = 'u'" symbol="0" label="gazowe urządzenie techniczne" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}" />
      <rule filter="ELSE" symbol="1" label="nieoznaczone" key="{96763c2d-faac-479a-a462-b30f9dcc22dd}" />
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="Show" type="Map">
                  <Option name="active" type="bool" value="true" />
                  <Option name="expression" type="QString" value="@QmapaAuto" />
                  <Option name="type" type="int" value="3" />
                </Option>
              </Option>
              <Option name="type" type="QString" value="collection" />
