...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule filter="rodzajUrzadzenia = 'u'" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}" symbol="0" label="gazowe urządzenie techniczne"/>
  ...
  <labeling type="rule-based">
    <rules key="{0d4707f5-d1a5-476d-ba89-0ecd148b2737}">
      <rule description="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{015b780c-4897-42ac-9930-13d1617fc42d}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{33bdfbd3-afd5-4d4f-b05c-5dd6073b4b60}">
        <settings calloutType="simple">
