...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" readOnly="0" labelsEnabled="1" maxScale="0" minScale="100000000" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyDrawingHints="1">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule label="kanał technologiczny" symbol="0" filter="rodzajUrzadzenia = 'l'" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}"/>
      <rule label="obudowa ochronna przewodu" symbol="1" filter="rodzajUrzadzenia = 'o'" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  ...
                  <Option type="QString" value="(try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) is not 1" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="(try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) is 1" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
                <Option type="Map" name="offset">
                  <Option type="bool" value="true" name="active"/>
  ...
  <labeling type="rule-based">
    <rules key="{94e4d099-1161-47e5-9d8a-efe4c74658b2}">
      <rule description="kanał technologiczny" filter=" &quot;rodzajUrzadzenia&quot;  = 'l' and try(&quot;status&quot;) is not 'p'" key="{e7a444a7-ae0c-4390-81fb-eed4c84983ce}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" capitalization="0" fontStrikeout="0" fontSizeUnit="MapUnit" legendString="Aa" textColor="0,0,0,255" fieldName="'KT'" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="1.0417000000000001" blendMode="0" isExpression="1" namedStyle="Normalny" textOpacity="1" fontWordSpacing="0" fontWeight="50" allowHtml="0" useSubstitutions="0" textOrientation="horizontal" multilineHeight="1" fontFamily="Arial" fontItalic="0" fontKerning="1" previewBkgrdColor="255,255,255,255" fontUnderline="0">
            <families/>
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{32f48990-4ce8-4b14-a7b0-476defdc4a5e}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" capitalization="0" fontStrikeout="0" fontSizeUnit="MapUnit" legendString="Aa" textColor="0,0,0,255" fieldName="'proj.' + regexp_substr(  &quot;rodzajSieci&quot; , '([a-zA-Z,]+)')&#xa;" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="1.0417000000000001" blendMode="0" isExpression="1" namedStyle="Normalny" textOpacity="1" fontWordSpacing="0" fontWeight="50" allowHtml="0" useSubstitutions="0" textOrientation="horizontal" multilineHeight="1" fontFamily="Arial" fontItalic="0" fontKerning="1" previewBkgrdColor="255,255,255,255" fontUnderline="0">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferSize="1" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="0"/>
            <text-mask maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskType="0" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskSizeUnits="MM"/>
            <background shapeOffsetY="0" shapeRadiiUnit="MM" shapeJoinStyle="64" shapeRadiiX="0" shapeOpacity="1" shapeOffsetUnit="MM" shapeSizeY="0" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeBorderWidth="0" shapeRotation="0" shapeSVGFile="" shapeSizeUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeDraw="0" shapeFillColor="255,255,255,255" shapeType="0" shapeRadiiY="0" shapeSizeX="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
  ...
  <aliases>
    ...
    <alias index="11" field="rodzajUrzadzenia" name=""/>
    <alias index="12" field="rodzajSieci" name=""/>
    <alias index="13" field="srednica" name=""/>
    <alias index="14" field="wladajacy" name=""/>
    <alias index="15" field="informacjaDodatkowa" name=""/>
    <alias index="16" field="wymiarPoziomy" name=""/>
    <alias index="17" field="koniecWersjaObiekt" name=""/>
    <alias index="18" field="koniecObiekt" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="rodzajUrzadzenia"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="rodzajSieci"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="rodzajUrzadzenia"/>
      <column hidden="0" type="field" width="-1" name="rodzajSieci"/>
