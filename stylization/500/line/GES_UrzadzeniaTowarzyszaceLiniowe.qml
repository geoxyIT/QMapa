...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule label="kanał technologiczny oś" filter="rodzajUrzadzenia = 'l' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 750))" symbol="0" key="{59c376fa-9e29-4149-9068-3fbc8580017a}"/>
      <rule label="kanał technologiczny" filter="rodzajUrzadzenia = 'l' and (try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) " symbol="1" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}"/>
      <rule label="obudowa ochronna przewodu oś" filter="rodzajUrzadzenia = 'o' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 750))" symbol="2" key="{f21e5fd8-576b-4a18-a2bb-653af00a8352}"/>
      <rule label="obudowa ochronna przewodu" filter="rodzajUrzadzenia = 'o' and (try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) " symbol="3" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f34e7e74-1a9e-4232-9cf1-cb2782582ee0}">
      <rule description="kanał technologiczny" filter=" &quot;rodzajUrzadzenia&quot;  = 'l' and try(&quot;status&quot;) is not 'p'" key="{db22312d-4459-43dd-ae9e-35cb326c4ee8}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontKerning="1" fontSizeUnit="MapUnit" fontSize="1.0417000000000001" allowHtml="0" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontWeight="50" textColor="0,0,0,255" fontLetterSpacing="0" fontFamily="Arial" textOpacity="1" previewBkgrdColor="255,255,255,255" legendString="Aa" capitalization="0" fieldName="'KT'" blendMode="0" isExpression="1">
            <families/>
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{1e36e987-5fa2-42bf-a6aa-c700ab7b05b7}">
        <settings calloutType="simple">
