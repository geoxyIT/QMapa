...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule symbol="0" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}" label="ściana oporowa" filter="rodzajBudowli = 'n'"/>
      <rule symbol="1" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}" label="inna budowla" filter="rodzajBudowli = 'i'"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="0.7" name="hash_length" type="QString"/>
            ...
            <Option value="5.5" name="interval" type="QString"/>
            ...
            <Option value="0.8" name="offset_along_line" type="QString"/>
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="MapUnit" name="interval_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
            <Option value="0.3" name="offset_along_line" type="QString"/>
            <Option value="3x:2500,0,0,0,0,0" name="offset_along_line_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_along_line_unit" type="QString"/>
            <Option value="3x:2500,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_unit" type="QString"/>
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@0@3" type="line" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{5668cc36-1b38-4cbd-96f1-fb4bffd53988}">
      <rule description="inna budowla" key="{15341c33-78e8-45ab-9b3d-f953f7223262}" filter="rodzajBudowli = 'i'">
