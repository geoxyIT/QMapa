...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule filter="rodzajBudowli = 'n'" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}" symbol="0" label="ściana oporowa"/>
      <rule filter="rodzajBudowli = 'i'" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}" symbol="1" label="inna budowla"/>
    </rules>
    <symbols>
      <symbol name="0" force_rhr="0" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="HashLine">
          ...
          <prop v="0" k="offset"/>
          <prop v="0.8" k="offset_along_line"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="HashLine">
          ...
          <prop v="MapUnit" k="interval_unit"/>
          <prop v="0" k="offset"/>
          <prop v="0.3" k="offset_along_line"/>
          <prop v="3x:2500,0,0,0,0,0" k="offset_along_line_map_unit_scale"/>
          <prop v="MapUnit" k="offset_along_line_unit"/>
          <prop v="3x:2500,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MapUnit" k="offset_unit"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="HashLine">
          ...
          <symbol name="@0@2" force_rhr="0" type="line" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="HashLine">
          ...
          <symbol name="@0@3" force_rhr="0" type="line" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{5668cc36-1b38-4cbd-96f1-fb4bffd53988}">
      <rule description="inna budowla" filter="rodzajBudowli = 'i'" key="{15341c33-78e8-45ab-9b3d-f953f7223262}">
