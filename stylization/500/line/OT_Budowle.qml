...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule label="ściana oporowa" symbol="0" filter="rodzajBudowli = 'n'" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}"/>
      <rule label="inna budowla" symbol="1" filter="rodzajBudowli = 'i'" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" name="0" type="line" clip_to_extent="1">
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="interval" type="QString" value="5.5"/>
            ...
            <Option name="offset_along_line" type="QString" value="0.8"/>
          ...
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="0.8"/>
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="interval_unit" type="QString" value="MapUnit"/>
            <Option name="offset" type="QString" value="0"/>
            <Option name="offset_along_line" type="QString" value="0.3"/>
            <Option name="offset_along_line_map_unit_scale" type="QString" value="3x:2500,0,0,0,0,0"/>
            <Option name="offset_along_line_unit" type="QString" value="MapUnit"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:2500,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
          ...
          <prop k="interval_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="0.3"/>
          <prop k="offset_along_line_map_unit_scale" v="3x:2500,0,0,0,0,0"/>
          <prop k="offset_along_line_unit" v="MapUnit"/>
          <prop k="offset_map_unit_scale" v="3x:2500,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          ...
          <symbol force_rhr="0" alpha="1" name="@0@3" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{5668cc36-1b38-4cbd-96f1-fb4bffd53988}">
      <rule filter="rodzajBudowli = 'i'" key="{15341c33-78e8-45ab-9b3d-f953f7223262}" description="inna budowla">
