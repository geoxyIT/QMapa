...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule filter="rodzajBudowli = 'n'" symbol="0" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}" label="ściana oporowa"/>
      <rule filter="rodzajBudowli = 'i'" symbol="1" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}" label="inna budowla"/>
    </rules>
    <symbols>
      <symbol name="0" type="line" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer class="HashLine" pass="0" enabled="1" locked="0">
          ...
          <symbol name="@0@0" type="line" force_rhr="0" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer class="HashLine" pass="0" enabled="1" locked="0">
          ...
          <symbol name="@0@2" type="line" force_rhr="0" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer class="HashLine" pass="0" enabled="1" locked="0">
          ...
          <symbol name="@0@3" type="line" force_rhr="0" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
