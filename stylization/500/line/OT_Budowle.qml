...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{9e89f8e3-ab43-4e56-bbbb-4cb5636a049f}">
      <rule filter="rodzajBudowli = 'n'" symbol="0" label="ściana oporowa" key="{70275c91-aeaf-4adf-aa2c-eed67863b745}" />
      <rule filter="rodzajBudowli = 'i'" symbol="1" label="inna budowla" key="{0e15ba0e-8aae-4fbf-bb66-4087de0db893}" />
      <rule filter="ELSE" symbol="2" label="nieoznaczone" key="{77650216-4fa4-4386-b285-8b7cf4b76821}" />
    </rules>
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
        ...
        <layer locked="0" class="HashLine" pass="0" enabled="1">
          ...
          <symbol name="@0@3" alpha="1" force_rhr="0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value="" />
                <Option name="properties" />
  ...
  <labeling type="rule-based">
    <rules key="{6ae1de4d-28e5-421d-8aed-9e46de79fdb2}">
      <rule description="inna budowla" filter="rodzajBudowli = 'i'" key="{eb653510-dc15-4a14-8695-c1bd5be2e63e}">
