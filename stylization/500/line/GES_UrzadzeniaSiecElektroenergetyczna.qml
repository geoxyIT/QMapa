...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule label="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" symbol="0" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{8d21b494-ccb4-4a61-be34-7eba683ade00}">
      <rule description="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{ce3913b1-4243-471e-93fb-e4df6a5f6544}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{dad548a9-0147-4680-ad22-f99ac6b245b0}">
        <settings calloutType="simple">
