...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{8d21b494-ccb4-4a61-be34-7eba683ade00}">
      <rule description="elektroenergetyczne urządzenie techniczne" key="{ce3913b1-4243-471e-93fb-e4df6a5f6544}" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{dad548a9-0147-4680-ad22-f99ac6b245b0}" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
