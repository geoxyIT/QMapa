...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule filter="rodzajUrzadzenia = 'u'" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}" symbol="0" label="elektroenergetyczne urządzenie techniczne"/>
      <rule filter="ELSE" key="{96763c2d-faac-479a-a462-b30f9dcc22dd}" symbol="1" label="nieoznaczone"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{71632d8b-8dc1-48e3-995f-aaed8879508f}">
      <rule description="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'" key="{b57ba993-9b51-478a-bc0b-0ee72facb853}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is  'p'" key="{95d98168-9454-4c65-a339-e86d0d2bb0c4}">
        <settings calloutType="simple">
