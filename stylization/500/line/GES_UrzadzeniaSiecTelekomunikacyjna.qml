...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingHints="1" version="3.24.0-Tisler" readOnly="0" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{8cdde566-27b9-486b-a534-d42334ce59b7}">
      <rule label="telekomunikacyjne urządzenie techniczne" symbol="0" filter="rodzajUrzadzenia = 'u'" key="{1f6b5bf6-44c2-4409-8529-7fed19503ff8}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3021324c-3844-4441-9179-2231048261b2}">
      <rule filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'" key="{3a9ca1e5-d4c8-484a-8a49-027b990e6193}" description="telekomunikacyjne urządzenie techniczne">
      ...
      <rule filter="try(&quot;status&quot;) is 'p'" key="{e46908f4-fac3-45c5-b26d-12603d110fd5}" description="projektowane">
        <settings calloutType="simple">
