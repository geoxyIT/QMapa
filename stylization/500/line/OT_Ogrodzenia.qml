...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" labelsEnabled="0" simplifyMaxScale="1" readOnly="0" minScale="100000000" version="3.24.0-Tisler" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{3cf0fdb2-eccf-4faa-9b7a-be17691c6338}">
      <rule filter="rodzajOgrodzenia = 'b'" symbol="0" label="brama" key="{d48fc24f-4e66-41c5-9f03-96183e05cfb3}"/>
      <rule filter="rodzajOgrodzenia = 'f'" symbol="1" label="furtka" key="{4cb71ce4-fe57-4097-b7b1-e944bdb4b33f}"/>
      <rule filter="rodzajOgrodzenia = 'o'" symbol="2" label="ogrodzenie trwałe" key="{c613268c-dc18-476a-a7e1-5e8f32a6109b}"/>
      <rule filter="ELSE" symbol="3" label="nieoznaczone" key="{77650216-4fa4-4386-b285-8b7cf4b76821}"/>
    </rules>
    <symbols>
