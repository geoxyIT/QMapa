...
<qgis version="3.24.2-Tisler" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{3cf0fdb2-eccf-4faa-9b7a-be17691c6338}">
      <rule symbol="0" filter="rodzajOgrodzenia = 'b'" key="{d48fc24f-4e66-41c5-9f03-96183e05cfb3}" label="brama"/>
      <rule symbol="1" filter="rodzajOgrodzenia = 'f'" key="{4cb71ce4-fe57-4097-b7b1-e944bdb4b33f}" label="furtka"/>
      <rule symbol="2" filter="rodzajOgrodzenia = 'o'" key="{c613268c-dc18-476a-a7e1-5e8f32a6109b}" label="ogrodzenie trwałe"/>
    </rules>
    <symbols>
