...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" version="3.24.0-Tisler" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" minScale="100000000" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule symbol="0" label="kanalizacyjne urządzenie techniczne" key="{85a48275-aa05-4a9c-93f7-ddf9203de79a}" filter="rodzajUrzadzenia = 'u'"/>
      <rule symbol="1" label="odwodnienie liniowe" key="{fceca47a-9b91-448e-9822-82ba81d8cb97}" filter="rodzajUrzadzenia = 'l'"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" name="1" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="HashLine" locked="0" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="interval" value="0.525"/>
          ...
          <symbol type="line" name="@1@0" alpha="1" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
