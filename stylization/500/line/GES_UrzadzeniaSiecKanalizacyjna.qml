...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule filter="rodzajUrzadzenia = 'l'" symbol="0" label="odwodnienie liniowe" key="{fceca47a-9b91-448e-9822-82ba81d8cb97}" />
      <rule filter="rodzajUrzadzenia = 'u'" symbol="1" label="kanalizacyjne urządzenie techniczne" key="{a94aa5c5-380d-4d96-8f51-150d6ca134b7}" />
      <rule filter="ELSE" symbol="2" label="nieoznaczone" key="{96763c2d-faac-479a-a462-b30f9dcc22dd}" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d416907e-41d4-41d3-9fe5-19c5a30204b3}">
      <rule description="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'" key="{5ec0921c-cf8c-4868-9736-a1f6846dfe2a}">
