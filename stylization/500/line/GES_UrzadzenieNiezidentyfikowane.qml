...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="1"><renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{83384eb8-40d8-4921-9d2e-029fa1da2e28}">
      <rule symbol="0" label="urządzenie techniczne sieci niezidentyfikowanej" key="{6af0d558-53ca-49fb-9c5f-418fdb94c545}" />
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6880e4e2-e25b-42d1-82de-6e703bf492a0}">
      <rule description="urządzenie techniczne sieci niezidentyfikowanej" filter="try(&quot;status&quot;) is not 'p'" key="{24fd9886-132a-42c3-ad89-24bf77bc16ec}">
      ...
      <rule description="projektowane" filter="try(&quot;status&quot;) is 'p'" key="{265618a3-f812-4ec5-b954-d3e0c7a734a0}">
        <settings calloutType="simple">
