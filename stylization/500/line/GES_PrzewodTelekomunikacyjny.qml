...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" version="3.24.0-Tisler" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" minScale="100000000" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
    <rules key="{bb713a4a-de07-42ab-af3a-db3c75e01785}">
      <rule symbol="0" label="przewód telekomunikacyjny podziemny" key="{e326e669-f506-4cd1-96d3-34443dc59fda}" filter="try(&quot;przebieg&quot;) = 'p' or try(&quot;przebieg&quot;) = 'z'"/>
      <rule symbol="1" label="przewód telekomunikacyjny napowietrzny" key="{30a16acd-5998-4a3a-b025-814702434acb}" filter="try(&quot;przebieg&quot;) = 'n' &#xd;&#xa; "/>
      <rule symbol="2" label="inny nie spełniający reguły" key="{ba8c405c-82ed-47f8-b050-e086c4fbb2de}" filter="ELSE"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="wiazka" name="" index="13"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="wiazka" unique_strength="0" constraints="0" exp_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" name="wiazka" width="-1"/>
