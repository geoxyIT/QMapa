...
<qgis simplifyDrawingHints="1" maxScale="0" minScale="100000000" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingTol="1" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" readOnly="0">
  <flags>
  ...
  <temporal startField="" endField="" startExpression="" limitMode="0" durationUnit="min" fixedDuration="0" durationField="" mode="0" enabled="0" endExpression="" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <aliases>
    ...
    <alias index="13" field="wladajacy" name=""/>
    <alias index="14" field="ksztaltUrzadzenia" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="eksploatacja" applyOnUpdate="0" expression=""/>
    <default field="rodzajUrzadzenia" applyOnUpdate="0" expression=""/>
    <default field="rodzajSieci" applyOnUpdate="0" expression=""/>
    <default field="wladajacy" applyOnUpdate="0" expression=""/>
    <default field="ksztaltUrzadzenia" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    <constraint exp_strength="0" constraints="3" field="fid" unique_strength="1" notnull_strength="1"/>
    <constraint exp_strength="0" constraints="0" field="gml_id" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="lokalnyId" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="przestrzenNazw" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="wersjaId" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="startObiekt" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="startWersjaObiekt" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="zrodlo" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="numerOperatu" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="status" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="eksploatacja" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="rodzajUrzadzenia" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="rodzajSieci" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="wladajacy" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="ksztaltUrzadzenia" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="ksztaltUrzadzenia" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
