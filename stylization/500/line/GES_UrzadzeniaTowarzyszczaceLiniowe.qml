...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule filter="rodzajUrzadzenia = 'l'" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}" symbol="0" label="kanał technologiczny"/>
      <rule filter="rodzajUrzadzenia = 'o'" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}" symbol="1" label="obudowa ochronna przewodu"/>
      <rule filter="ELSE" key="{a4d19410-f018-4931-a9ef-768c38aa7e2d}" symbol="2" label="nieoznaczone"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  ...
                  <Option name="expression" type="QString" value="(try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) is not 1 or not (num_geometries($geometry) is 1 or num_geometries($geometry) is null)"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="(try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) is 1 and (num_geometries($geometry) is 1 or num_geometries($geometry) is null)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="offset" type="Map">
                  <Option name="active" type="bool" value="true"/>
  ...
  <labeling type="rule-based">
    <rules key="{84603c77-c1f3-46f5-91c0-6de1091d602a}">
      <rule description="kanał technologiczny" filter=" &quot;rodzajUrzadzenia&quot;  = 'l' and try(&quot;status&quot;) is not 'p'" key="{b463d447-7242-45e3-838e-b087e1ca1791}">
        <settings calloutType="simple">
          <text-style textOpacity="1" namedStyle="Normal" fontSize="1.0417000000000001" blendMode="0" fontFamily="Arial" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontSizeUnit="MapUnit" allowHtml="0" useSubstitutions="0" multilineHeight="1" fontKerning="1" fieldName="'KT'" legendString="Aa" fontWeight="50" textColor="0,0,0,255" fontSizeMapUnitScale="3x:2500,0,0,0,0,0" fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="1" capitalization="0" fontWordSpacing="0" fontStrikeout="0">
            <families/>
          ...
          <placement dist="0" preserveRotation="1" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" placement="2" centroidInside="0" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" maxCurvedCharAngleOut="-25" lineAnchorType="0" quadOffset="4" xOffset="0" distUnits="MM" priority="5" centroidWhole="0" overrunDistance="0" rotationUnit="AngleDegrees" rotationAngle="0" geometryGeneratorEnabled="0" offsetUnits="MM" yOffset="0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" layerType="LineGeometry"/>
      ...
      <rule description="projektowane" filter=" try(&quot;status&quot;) is  'p'" key="{49522774-8ac4-49dc-b494-e24a5c4e4ac7}">
        <settings calloutType="simple">
