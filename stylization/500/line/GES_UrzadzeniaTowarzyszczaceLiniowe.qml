...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule symbol="0" key="{59c376fa-9e29-4149-9068-3fbc8580017a}" filter="rodzajUrzadzenia = 'l' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 750))" label="kanał technologiczny oś"/>
      <rule symbol="1" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}" filter="rodzajUrzadzenia = 'l' and (try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) " label="kanał technologiczny"/>
      <rule symbol="2" key="{f21e5fd8-576b-4a18-a2bb-653af00a8352}" filter="rodzajUrzadzenia = 'o' and ((try(&quot;srednica&quot;) is NULL or try(&quot;srednica&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPoziomy&quot;) is NULL or try(&quot;wymiarPoziomy&quot;) &lt;= 750) &#xa;and (try(&quot;wymiarPionowy&quot;) is NULL or try(&quot;wymiarPionowy&quot;) &lt;= 750))" label="obudowa ochronna przewodu oś"/>
      <rule symbol="3" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}" filter="rodzajUrzadzenia = 'o' and (try(&quot;srednica&quot;) > 750 or try(&quot;wymiarPoziomy&quot;) > 750 or try(&quot;wymiarPionowy&quot;) > 750) " label="obudowa ochronna przewodu"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3b74916a-9113-4391-95e3-3c825c1bb976}">
      <rule key="{982bcdb4-fc50-4ea3-afd9-7c80c35f34c8}" description="kanał technologiczny" filter=" &quot;rodzajUrzadzenia&quot;  = 'l' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
          <text-style blendMode="0" fontWordSpacing="0" fieldName="'KT'" fontStrikeout="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontKerning="1" namedStyle="Normalny" useSubstitutions="0" capitalization="0" isExpression="1" fontUnderline="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="1.0417000000000001" allowHtml="0" textColor="0,0,0,255">
            <families/>
      ...
      <rule key="{7c32936e-0326-4020-ae85-60907269b6d4}" description="projektowane" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
