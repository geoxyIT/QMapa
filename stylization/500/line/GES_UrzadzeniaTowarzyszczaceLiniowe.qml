...
<qgis simplifyDrawingTol="1" minScale="100000000" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{0b17cc51-2d13-448a-a274-48278afa1101}">
      <rule label="kanał technologiczny" symbol="0" key="{8d6d0981-a0e8-4a50-81ce-1737c5cd00e7}" filter="rodzajUrzadzenia = 'l'"/>
      <rule label="obudowa ochronna przewodu" symbol="1" key="{a467983f-fc2a-4923-bea6-07aeb4b09827}" filter="rodzajUrzadzenia = 'o'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0dd84a3c-ddde-458c-be9d-609178cd98b3}">
      ...
      <rule key="{a6a1805d-120d-4d14-b724-dfa2b88b3455}" filter=" try(&quot;status&quot;) is  'p'" description="projektowane">
        <settings calloutType="simple">
