...
<qgis version="3.24.0-Tisler" styleCategories="AllStyleCategories" labelsEnabled="0"><renderer-v2 referencescale="-1" enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer">
    <rules key="{f7bc68f2-f780-4b03-96e7-b17311f00d1f}">
      ...
      <rule label="nieoznaczone" symbol="1" filter="ELSE" key="{77650216-4fa4-4386-b285-8b7cf4b76821}" />
    </rules>
    <symbols>
