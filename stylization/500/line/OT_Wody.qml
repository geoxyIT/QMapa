...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.24.0-Tisler" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" simplifyDrawingHints="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{8cd897ec-5fa2-4698-8396-8beac0a50b02}">
      <rule filter="rodzajObiektu = 'i'" symbol="0" key="{4b91d97a-1dbd-4bf2-a89a-cc4671cd8385}" label="inny obiekt związany z wodą"/>
      <rule filter="rodzajObiektu = 'm'" symbol="1" key="{ea7eebd9-3856-4d1b-a4af-1b4a2f83f3ac}" label="rów melioracyjny"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c45dd0c1-054b-4400-9573-4b4725452d05}">
      <rule filter="rodzajObiektu = 'm'" key="{f67927eb-c3f6-47d3-bad0-7937c6e0eab9}" description="rów melioracyjny">
  ...
  <aliases>
    ...
    <alias name="" index="11" field="OT_PrezentacjaGraficzna_0_fid"/>
    <alias name="" index="12" field="OT_PrezentacjaGraficzna_0_gml_id"/>
    <alias name="" index="13" field="OT_PrezentacjaGraficzna_0_katObrotu"/>
  </aliases>
  <defaults>
