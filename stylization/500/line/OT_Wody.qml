...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.24.0-Tisler" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{8cd897ec-5fa2-4698-8396-8beac0a50b02}">
      <rule filter="rodzajObiektu = 'm'" key="{62c2d97b-4fbf-4e9c-938c-5a9e792ca526}" symbol="0" label="rów melioracyjny"/>
      <rule filter="rodzajObiektu = 'i'" key="{4b91d97a-1dbd-4bf2-a89a-cc4671cd8385}" symbol="1" label="inny obiekt związany z wodą"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{71539528-ba76-45ce-9dc6-904d057011c1}">
      <rule description="rów melioracyjny" filter="rodzajObiektu = 'm'" key="{fd811312-3f25-43a1-acbc-a2172c2b0eaa}">
