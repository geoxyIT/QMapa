...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" version="3.24.0-Tisler" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{32e41337-b1bb-4333-ace0-d104f58406a7}">
      <rule filter="ELSE" symbol="0" key="{7c2d282e-b529-492e-aa9b-048be1bf2413}" label="podziemny / naziemny"/>
    ...
    <symbols>
      ...
      <symbol name="1" clip_to_extent="1" type="line" force_rhr="0" alpha="0.91">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
          ...
          <symbol name="@1@4" clip_to_extent="1" type="line" force_rhr="0" alpha="1">
            ...
            <layer class="MarkerLine" locked="0" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="interval_unit" type="QString" value="MapUnit"/>
                <Option name="offset" type="QString" value="0"/>
                <Option name="offset_along_line" type="QString" value="6"/>
                <Option name="offset_along_line_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_along_line_unit" type="QString" value="MapUnit"/>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MM"/>
    ...
    <rules key="{a63d23cf-56c6-4a32-94ef-67dc76f0e2ae}">
      <rule filter="try(&quot;przebieg&quot;) is not 'n'" key="{d7a59949-37ca-4b65-b09c-c3d878178000}" description="przewód elektroenergetyczny podziemny">
        <settings calloutType="simple">
          ...
          <placement centroidInside="0" rotationUnit="AngleDegrees" xOffset="0" rotationAngle="0" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" lineAnchorType="1" distUnits="MM" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" layerType="LineGeometry" placementFlags="9" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" fitInPolygonOnly="0" overrunDistance="0" overrunDistanceUnit="MM" polygonPlacementFlags="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" quadOffset="4" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" preserveRotation="1" lineAnchorClipping="0" geometryGenerator="" offsetUnits="MM" placement="2" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering scaleVisibility="0" drawLabels="1" unplacedVisibility="0" minFeatureSize="0" upsidedownLabels="0" labelPerPart="0" limitNumLabels="0" zIndex="0" scaleMin="0" mergeLines="1" displayAll="1" fontMaxPixelSize="10000" scaleMax="0" fontMinPixelSize="3" obstacleType="1" fontLimitPixelSize="0" maxNumLabels="2000" obstacleFactor="1" obstacle="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
  ...
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;typPrzewodu&quot;">
    <columns>
