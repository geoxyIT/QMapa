...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{e3fcdfd7-f47b-4bae-adab-d6cafa303663}">
      <rule symbol="0" key="{c6338a8f-d43e-425c-8224-bc207f129fa9}" label="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{94857a8e-3905-4085-9849-4eebb346af8f}">
      <rule description="ciepłownicze urządzenie techniczne" key="{816fe932-8414-4d12-b141-b55dbb9e59b3}" filter="rodzajUrzadzenia = 'u' &#xa;and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{8a87b1ff-3b21-4d8b-beae-835926ac6aa2}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
