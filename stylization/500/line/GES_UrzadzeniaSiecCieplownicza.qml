...
<qgis simplifyMaxScale="1" version="3.24.2-Tisler" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="100000000" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{e3fcdfd7-f47b-4bae-adab-d6cafa303663}">
      <rule symbol="0" key="{c6338a8f-d43e-425c-8224-bc207f129fa9}" filter="rodzajUrzadzenia = 'u'" label="ciepłownicze urządzenie techniczne"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{94857a8e-3905-4085-9849-4eebb346af8f}">
      <rule key="{816fe932-8414-4d12-b141-b55dbb9e59b3}" description="ciepłownicze urządzenie techniczne" filter="rodzajUrzadzenia = 'u' &#xa;and try(&quot;status&quot;) is not 'p'">
      ...
      <rule key="{8a87b1ff-3b21-4d8b-beae-835926ac6aa2}" description="projektowane" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
