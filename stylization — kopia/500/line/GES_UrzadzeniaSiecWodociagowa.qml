...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{a684ae9f-a8ab-46f1-95b2-8b74f712e436}">
      <rule symbol="0" key="{c19df96b-1031-4878-b9da-272105d2f01b}" label="wodociągowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8ed3306-34b4-4e59-ae25-e308d554bb48}">
      <rule description="wodociągowe urządzenie techniczne" key="{1e06ef88-abd2-4e6e-89a5-ab80181e8321}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="wodociągowe urządzenie techniczne" key="{38ac2f57-1b32-4270-915f-c3172ad990b4}" filter="try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
