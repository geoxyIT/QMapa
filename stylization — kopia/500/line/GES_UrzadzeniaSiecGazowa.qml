...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{dfd4aa65-e6a3-402d-a479-5260dd775ca6}">
      <rule description="gazowe urządzenie techniczne" key="{fd59ea3e-c707-4bf3-9a7e-d37a9a57e841}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{b7f0cb8c-03b5-4217-bcf5-fa2d00bd7bd0}" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
