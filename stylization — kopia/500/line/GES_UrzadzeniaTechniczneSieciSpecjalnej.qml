...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{de10264e-e3ec-44b9-8e78-fba8ca4549c5}">
      <rule description="urządzenie techniczne sieci specjalnej" key="{8b2056eb-318d-467c-9a9b-04ee32c5f9cb}" filter="rodzajUrzadzenia = 'u'  and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="urządzenie techniczne sieci specjalnej" key="{aa6cd97f-1967-49de-9c92-a9e887f61423}" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
