...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      ...
      <rule symbol="1" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" label="most" filter="rodzajObiektu = 'm'"/>
      <rule symbol="2" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" label="wiadukt" filter="rodzajObiektu = 'w'"/>
      <rule symbol="3" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" label="estakada" filter="rodzajObiektu = 'e'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{bf94e2d6-984b-4a5d-94bf-f61a874bee53}">
      <rule description="jezdnia" key="{ea225dbd-3bc7-4d1a-8e06-54cd1b7f3029}" filter="rodzajObiektu = 'j'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'j.' + try(&quot;rodzajNawierzchni&quot;)" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="3.125" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
