...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="nullSymbol" referencescale="-1"/>
  <labeling type="rule-based">
    <rules key="{44cde8d3-38b7-479c-905c-372a24750e01}">
      <rule description="rzedna" key="{bef36002-959d-407f-a47e-6d5e883632db}" filter=" try(&quot;rzedna&quot;) is not null">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="format_number(&quot;rzedna&quot;,2,'en')" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1.5625" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
      ...
      <rule description="rzedna" key="{89e1a1a1-b477-4fc9-a684-a94002d2ff6f}" filter=" try(&quot;rzednaGory&quot;) is not null or  try(&quot;rzednaDolu&quot;) is not null">
        <settings calloutType="simple">
              ...
              <symbol force_rhr="0" clip_to_extent="1" name="fillSymbol" type="fill" alpha="1">
                ...
                <layer locked="0" pass="0" class="LinePatternFill" enabled="1">
                  <Option type="Map">
                    ...
                    <Option value="-0.18" name="offset" type="QString"/>
                    <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
          ...
          <text-format rightDirectionSymbol=">" decimals="3" multilineAlign="0" formatNumbers="0" autoWrapLength="0" placeDirectionSymbol="0" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" plussign="0" wrapChar="" leftDirectionSymbol="&lt;"/>
          <placement xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" rotationUnit="AngleDegrees" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" centroidInside="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" offsetUnits="MM" repeatDistance="0" distUnits="MM" priority="5" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" lineAnchorPercent="0.5" lineAnchorType="0" rotationAngle="0" preserveRotation="1" placementFlags="9" geometryGeneratorEnabled="0" centroidWhole="0" lineAnchorClipping="0" quadOffset="5" geometryGeneratorType="PointGeometry" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetType="0" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0"/>
          <rendering scaleVisibility="0" fontMaxPixelSize="10000" obstacle="1" obstacleType="1" labelPerPart="0" maxNumLabels="2000" upsidedownLabels="0" scaleMax="0" unplacedVisibility="0" minFeatureSize="0" zIndex="0" fontMinPixelSize="3" obstacleFactor="1" limitNumLabels="0" displayAll="1" fontLimitPixelSize="0" scaleMin="0" mergeLines="0" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
  ...
  <attributetableconfig sortExpression="&quot;rzedna&quot;" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="182" name="gml_id" type="field"/>
      <column hidden="0" width="129" name="lokalnyId" type="field"/>
      <column hidden="0" width="178" name="przestrzenNazw" type="field"/>
      <column hidden="0" width="-1" name="wersjaId" type="field"/>
      <column hidden="0" width="330" name="relacja" type="field"/>
      ...
      <column hidden="0" width="-1" name="rzednaGory" type="field"/>
      <column hidden="0" width="-1" name="rzednaDolu" type="field"/>
      <column hidden="0" width="-1" name="rzedna" type="field"/>
      <column hidden="0" width="341" name="GES_InneUrzadzeniaTowarzyszace_0_rodzajSieci" type="field"/>
      <column hidden="0" width="-1" name="GES_InneUrzadzeniaTowarzyszace_1_rodzajSieci" type="field"/>
      ...
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecElektroenergetyczna_1_zrodlo" type="field"/>
      ...
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecKanalizacyjna_2_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecWodociagowa_0_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecGazowa_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecGazowa_2_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_PrzewodCieplowniczy_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecCieplownicza_0_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecCieplownicza_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecCieplownicza_2_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecTelekomunikacyjna_0_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecTelekomunikacyjna_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaSiecTelekomunikacyjna_2_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_PrzewodSpecjalny_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzeniaTechniczneSieciSpecjalnej_2_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_PrzewodNiezidentyfikowany_1_zrodlo" type="field"/>
      <column hidden="0" width="-1" name="GES_UrzadzenieNiezidentyfikowane_0_zrodlo" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField name="fid" showLabel="1" index="-1"/>
    <attributeEditorField name="fid" showLabel="1" index="-1"/>
    <attributeEditorField name="relacja" showLabel="1" index="-1"/>
    <attributeEditorField name="lokalnyId" showLabel="1" index="-1"/>
    <attributeEditorField name="wersjaId" showLabel="1" index="-1"/>
    <attributeEditorField name="startObiekt" showLabel="1" index="-1"/>
    <attributeEditorField name="rzednaDolu" showLabel="1" index="-1"/>
    <attributeEditorField name="rzednaGory" showLabel="1" index="-1"/>
    <attributeEditorField name="numerOperatu" showLabel="1" index="-1"/>
    <attributeEditorField name="rzedna" showLabel="1" index="-1"/>
    <attributeEditorField name="startWersjaObiekt" showLabel="1" index="-1"/>
    <attributeEditorField name="zrodlo" showLabel="1" index="-1"/>
    <attributeEditorField name="przestrzenNazw" showLabel="1" index="-1"/>
    <attributeEditorField name="gml_id" showLabel="1" index="-1"/>
    <attributeEditorRelation forceSuppressFormPopup="0" name="" showLabel="1" nmRelationId="" label="" relationWidgetTypeId="relation_editor" relation="">
