...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{d0e83001-4ba6-4b77-a973-6599f0754e26}">
      <rule symbol="0" key="{c94f1edd-47e7-46c1-b1eb-5cdceaea3e88}" label="maszt oświetleniowy" filter="rodzajUrzadzenia = 'm' "/>
      <rule symbol="1" key="{7cf2196e-2781-47f6-8658-5ee0465910f0}" label="turbina wiatrowa" filter="rodzajUrzadzenia = 'a'"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="1" type="marker" alpha="1">
        ...
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option value="0.29999999999999999,-3.70000000000000018" name="offset" type="QString"/>
            <Option value="3x:10000,0,0,0.03,0,0" name="offset_map_unit_scale" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{9367d66c-5fce-41d4-a812-9c937e5b36fb}">
      <rule description="projektowane" key="{9f7f9f83-96f0-4fa2-b3ac-c58827f98b78}" filter="(rodzajUrzadzenia = 'a' or rodzajUrzadzenia = 'm') and try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:10000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName=" 'proj.'+'e' " blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="3.125" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
