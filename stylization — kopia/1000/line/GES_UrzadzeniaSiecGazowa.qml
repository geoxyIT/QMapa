...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{d196d851-e973-45ed-b5ec-4b74f5f94fb7}">
      <rule symbol="0" key="{63d578ba-2b45-4495-ae4f-20b038fdaa24}" label="gazowe urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7ba71089-ebb0-4413-9aa1-20fb7aae0aa1}">
      <rule description="gazowe urządzenie techniczne" key="{a2707b8e-7247-4e39-8ef8-c1e3d01d4fd0}" filter="rodzajUrzadzenia = 'u'">
      ...
      <rule description="projektowane" key="{f36d00f3-93b4-4f0a-842d-d20150e785b1}" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
