...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{7689a618-601a-488c-8cba-9bdc99b207ec}">
      <rule description="ciepłownicze urządzenie techniczne" key="{7a2c4023-05c6-4290-85b4-103c667c52ec}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{623e5c1b-4e91-4eb3-8962-8e2ce6ab5d42}" filter=" try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
