...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{c87c7111-3f19-4465-850a-18b01e6dc805}">
      <rule symbol="0" key="{9a770a83-6641-4694-8258-068d729f4a1f}" label="krawężnik" filter="rodzajObiektu = 'k'"/>
      <rule symbol="1" key="{97849d9e-1b38-4533-ba4f-51a39181082a}" label="rów przydrożny" filter="rodzajObiektu = 'r'"/>
      <rule symbol="2" key="{6977910c-9fd4-444b-b548-1bea8fde5ac1}" label="przepust" filter="rodzajObiektu = 'z'"/>
      <rule symbol="3" key="{77bb9f02-2d11-43b9-bd94-e5d988df5207}" label="bariera ochronna" filter="rodzajObiektu = 'b'"/>
      <rule symbol="4" key="{011262d7-b494-42d7-8457-2656a65ba28a}" label="ekran akustyczny" filter="rodzajObiektu = 'y'"/>
      <rule symbol="5" key="{94367d1f-22e9-4901-aca9-0ad4edc2b35e}" label="tor" filter="rodzajObiektu = 't'"/>
      <rule symbol="6" key="{2459b0a4-eed8-4322-95a4-5234315e8eb0}" label="kolej linowa" filter="rodzajObiektu = 'l'"/>
      <rule symbol="7" key="{8fe03f10-852f-4512-ab38-3646e1420e11}" label="inny obiekt komunikacyjny" filter="rodzajObiektu = 'i'"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="3" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@3@1" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@3@2" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="4" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@4@2" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@4@3" type="line" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="6" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@6@2" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{6f590e5e-3d1d-4ab1-8596-a6c82fa6ba35}">
      <rule description="rów przydrożny" key="{0a80bda6-d744-41fb-93d5-2ec61dbb9aa5}" filter="rodzajObiektu = 'r'">
      ...
      <rule description="inny obiekt komunikacyjny" key="{b9960194-098b-41a8-a7ab-b8d6598ce470}" filter="rodzajObiektu = 'i'">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" name="rodzajNawierzchni" type="field"/>
      <column hidden="0" width="-1" name="polozenie" type="field"/>
