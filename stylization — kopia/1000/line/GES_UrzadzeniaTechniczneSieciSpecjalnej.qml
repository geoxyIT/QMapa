...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{8b97a732-835a-4d2f-b9e8-15e477cb5382}">
      <rule symbol="0" key="{95683d64-875f-493b-8b49-bd8c03424abd}" label="urządzenie techniczne sieci specjalnej" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3c81e704-76e2-4152-b337-dd5d3d509c12}">
      <rule description="urządzenie techniczne sieci specjalnej" key="{64a93a5d-49e7-415e-8bab-c566e148366e}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{38df1658-8b0c-4dc3-9d87-c743f7781117}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
