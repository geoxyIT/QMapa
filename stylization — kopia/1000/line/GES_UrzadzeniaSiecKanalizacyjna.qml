...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{39441c2e-d0b9-4f93-b1ee-7ba9b3e041e3}">
      <rule symbol="0" key="{72f23876-434c-4c64-b35c-93cea5088203}" label="odwodnienie liniowe" filter="rodzajUrzadzenia = 'l'"/>
      <rule symbol="1" key="{92ffbe5c-fed2-40ca-99e8-ab9a506e249f}" label="kanalizacyjne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="line" alpha="1">
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          <Option type="Map">
            ...
            <Option value="0.525" name="interval" type="QString"/>
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@0@1" type="line" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="HashLine" enabled="1">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@0@2" type="line" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{7265c391-5fe4-4018-879f-460fff7de8c7}">
      <rule description="kanalizacyjne urządzenie techniczne" key="{a2123a8f-ff51-48a6-992b-ff4941d5b087}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{cf3ae3be-bb7f-41ab-a2ac-1e963867784f}" filter="try(&quot;status&quot;) is 'p'">
        <settings calloutType="simple">
