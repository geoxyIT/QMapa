...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9aeba5a9-5139-47bb-ba82-367ba3d5eb62}">
      <rule symbol="0" key="{62f29ba4-e60b-42c8-8105-243c55a560d9}" label="elektroenergetyczne urządzenie techniczne" filter="rodzajUrzadzenia = 'u'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4f20f799-94cc-463f-bfa5-6dff3de928ae}">
      <rule description="elektroenergetyczne urządzenie techniczne" key="{784b737b-2e3a-437c-a684-0ca7db5e0f8c}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{f04def91-e54e-40cf-856e-81ada29bdb02}" filter="rodzajUrzadzenia = 'u' and try(&quot;status&quot;) is not 'p'">
        <settings calloutType="simple">
