...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{e6a89679-538c-438e-8ac2-12f2ab26bc4c}">
      <rule symbol="0" key="{f8438921-ad6e-43be-984d-bbbee32158df}" label="kondygnacja nadziemna" filter="rodzajBloku = 'n'"/>
      <rule symbol="1" key="{a6be0aa1-4713-4565-b16c-f9d97fc8e798}" label="kondygnacja podziemna" filter="rodzajBloku = 'p'"/>
      <rule symbol="2" key="{06fee6e3-3b38-4b56-9bbb-9a5348402500}" label="łącznik" filter="rodzajBloku = 'l'"/>
      <rule symbol="3" key="{92b486d1-540a-4fbc-9c26-d6f1967b1cef}" label="nawis" filter="rodzajBloku = 'a'"/>
      <rule symbol="4" key="{d1b98d1c-f73e-4c79-b958-83af1b8159be}" label="przejazd przez budynek" filter="rodzajBloku = 'z'"/>
      <rule symbol="5" key="{7b70cfe8-94d8-4db6-b810-383859e701fe}" label="inny nadziemny" filter="rodzajBloku = 'y' and not try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1"/>
      <rule symbol="6" key="{d1b9990f-47c2-4a3e-b7a6-507a153a74c2}" label="inny podziemny" filter="rodzajBloku = 'y' and try(&quot;numerNajnizszejKondygnacji&quot; &lt; 0) is 1"/>
    </rules>
    <symbols>
