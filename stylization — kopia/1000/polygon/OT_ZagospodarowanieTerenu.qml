...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{bb778299-c56c-419a-ba33-8f5dd5a4b6ec}">
      <rule symbol="0" key="{f56436ed-5f7e-4ee5-9fa5-4e455bfdc64b}" label="trawnik" filter="rodzajObiektu = 't'"/>
      <rule symbol="1" key="{1bb3a272-7dfe-4a91-b3c0-a4ddf4cc9058}" label="zadrzewienie, zakrzewienie" filter="rodzajObiektu = 'k'"/>
      <rule symbol="2" key="{af0a366c-0486-4e9a-ac8b-93b5710c1e19}" label="teren zalesiony" filter="rodzajObiektu = 'z'"/>
  ...
  <labeling type="rule-based">
    <rules key="{3b4a6bd2-506b-4644-b31c-455767419aea}">
      <rule description="inny obiekt zagospodarowania terenu" key="{025f26d3-625d-48a9-ac49-613cb3cdbf64}" filter="rodzajObiektu = 'i'">
  ...
  <attributetableconfig sortExpression="&quot;rodzajObiektu&quot;" sortOrder="1" actionWidgetStyle="dropDown">
    <columns>
