...
<qgis styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="3.24.0-Tisler" simplifyAlgorithm="0" minScale="100000000" simplifyLocal="1" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="1" simplifyDrawingTol="1" simplifyDrawingHints="0" simplifyMaxScale="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style blendMode="0" legendString="Aa" textOpacity="1" capitalization="0" textOrientation="horizontal" fontSize="2.6000000000000001" fontWordSpacing="0" textColor="120,50,190,255" allowHtml="0" fontLetterSpacing="0" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontSizeUnit="MapUnit" namedStyle="Regular" isExpression="1" useSubstitutions="0" fontKerning="1" multilineHeight="1" fontFamily="Liberation Sans" previewBkgrdColor="255,255,255,255" fieldName="'K'" fontItalic="0" fontSizeMapUnitScale="3x:5000,0,0,0,0,0">
        <families/>
      ...
      <placement layerType="PointGeometry" yOffset="-0.10000000000000001" overrunDistance="0" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" offsetType="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.10000000000000001" maxCurvedCharAngleIn="25" quadOffset="2" priority="5" repeatDistanceUnits="MM" rotationAngle="0" placement="1" lineAnchorType="0" placementFlags="10" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" fitInPolygonOnly="0" dist="0" polygonPlacementFlags="2" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" preserveRotation="1" maxCurvedCharAngleOut="-25" repeatDistance="0" overrunDistanceUnit="MM" geometryGenerator="" offsetUnits="MapUnit" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
