...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{9f530e0e-244c-48ba-822a-3168ce469f49}">
      <rule symbol="0" key="{c28c6b4f-7d62-48b8-8613-7b7120a5882d}" label="komora podziemna" filter="rodzajUrzadzenia = 'k'"/>
      <rule symbol="1" key="{ae106302-3fe3-4e5e-82d4-4ff77b799b51}" label="właz do komory, kanału" filter="rodzajUrzadzenia = 'w'"/>
      <rule symbol="2" key="{91d61cb7-2c1b-450b-86d8-3695b5ab82b5}" label="słup przewodów napowietrznych" filter="rodzajUrzadzenia = 'p' "/>
      <rule symbol="3" key="{b495f3e0-92a8-4c3e-be8e-89761da99f47}" label="słup trakcyjny" filter="rodzajUrzadzenia = 'y'"/>
      <rule symbol="4" key="{245ad9eb-2c66-44bf-9695-2f89f03e6091}" label="podpora przewodów" filter="rodzajUrzadzenia = 'n'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{490f9f15-79b1-4d06-9958-a337c1820cd2}">
      <rule description="właz do komory, kanału" key="{18be936f-42be-4d54-903d-41fd853010ea}" filter="rodzajUrzadzenia = 'w' and try(&quot;status&quot;) is not 'p'">
      ...
      <rule description="projektowane" key="{17a3fa99-0d45-4fa6-81f9-c8e943ace48f}" filter=" try(&quot;status&quot;) is  'p'">
        <settings calloutType="simple">
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" name="ksztaltUrzadzenia" type="field"/>
