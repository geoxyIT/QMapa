...
<qgis simplifyLocal="1" version="3.24.0-Tisler" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" maxScale="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{6669a1a9-987c-4a77-b897-7d88a06239dd}">
      <rule symbol="0" key="{b73dc8b4-ff2c-452c-bc83-7109e6529ae0}" label="most" filter="rodzajObiektu = 'm'"/>
      <rule symbol="1" key="{05d617ae-73fa-4d4c-b5aa-ce3e63d8abd6}" label="wiadukt" filter="rodzajObiektu = 'w'"/>
      <rule symbol="2" key="{9ad9af7a-0a03-4ee6-8493-e8fd4a31d27d}" label="estakada" filter="rodzajObiektu = 'e'"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="fill" alpha="1">
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            ...
            <Option value="1.25" name="outline_width" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{7b038c83-c962-4e8a-9d01-46df61ed3261}">
      <rule description="jezdnia" key="{d9309545-72c5-4d36-b332-c71782222228}" filter="rodzajObiektu = 'j'">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontStrikeout="0" fontKerning="1" fontUnderline="0" fontWordSpacing="0" fontSizeUnit="MapUnit" fontSizeMapUnitScale="3x:25000,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" legendString="Aa" useSubstitutions="0" fieldName="'j.' + &quot;rodzajNawierzchni&quot;" blendMode="0" fontItalic="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="7.8124500000000001" isExpression="1" fontWeight="50" textOpacity="1" textColor="0,0,0,255" capitalization="0" textOrientation="horizontal" multilineHeight="1">
            <families/>
